...
try {
		Debug.PushSubsStack("CreateElement (xml2map) ","xml2map",114,__ref.getField(false, "ba"),__ref,68);
if (RapidSub.canDelegate("createelement")) { return __ref.runUserSub(false, "xml2map","createelement", __ref, _name);}
RemoteObject _xe = RemoteObject.declareNull("b4j.docU.xml2map._xmlelement");
...
Debug.JustUpdateDeviceLine();
_xe = RemoteObject.createNew ("b4j.docU.xml2map._xmlelement");Debug.locals.put("xe", _xe);
...
_xe.setField ("Name" /*RemoteObject*/ ,_name);
 BA.debugLineNum = 74;BA.debugLine="If mStripNamespaces Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_mstripnamespaces" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 75;BA.debugLine="xe.Name = StripNamespace(Name)";
Debug.JustUpdateDeviceLine();
_xe.setField ("Name" /*RemoteObject*/ ,__ref.runClassMethod (b4j.docU.xml2map.class, "_stripnamespace" /*RemoteObject*/ ,(Object)(_name)));
 };
...
try {
		Debug.PushSubsStack("ElementToObject (xml2map) ","xml2map",114,__ref.getField(false, "ba"),__ref,42);
...
RemoteObject _child = RemoteObject.declareNull("b4j.docU.xml2map._xmlelement");
...
Debug.JustUpdateDeviceLine();
_childobject = __ref.runClassMethod (b4j.docU.xml2map.class, "_elementtoobject" /*RemoteObject*/ ,(Object)(_child));Debug.locals.put("childObject", _childobject);Debug.locals.put("childObject", _childobject);
...
try {
		Debug.PushSubsStack("GetLastElement (xml2map) ","xml2map",114,__ref.getField(false, "ba"),__ref,127);
...
try {
		Debug.PushSubsStack("getStripNamespaces (xml2map) ","xml2map",114,__ref.getField(false, "ba"),__ref,19);
...
try {
		Debug.PushSubsStack("Initialize (xml2map) ","xml2map",114,__ref.getField(false, "ba"),__ref,10);
...
try {
		Debug.PushSubsStack("Parse (xml2map) ","xml2map",114,__ref.getField(false, "ba"),__ref,27);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4j.docU.xml2map.class, "_parse2" /*RemoteObject*/ ,(Object)(_in));
...
try {
		Debug.PushSubsStack("Parse2 (xml2map) ","xml2map",114,__ref.getField(false, "ba"),__ref,34);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_elements" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4j.docU.xml2map.class, "_createelement" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("stub"))))));
...
_m = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), __ref.runClassMethod (b4j.docU.xml2map.class, "_elementtoobject" /*RemoteObject*/ ,(Object)((__ref.getField(false,"_elements" /*RemoteObject*/ ).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0)))))));Debug.locals.put("m", _m);Debug.locals.put("m", _m);
...
try {
		Debug.PushSubsStack("Parser_EndElement (xml2map) ","xml2map",114,__ref.getField(false, "ba"),__ref,131);
if (RapidSub.canDelegate("parser_endelement")) { return __ref.runUserSub(false, "xml2map","parser_endelement", __ref, _uri, _name, _text);}
RemoteObject _element = RemoteObject.declareNull("b4j.docU.xml2map._xmlelement");
...
Debug.JustUpdateDeviceLine();
_element = __ref.runClassMethod (b4j.docU.xml2map.class, "_getlastelement" /*RemoteObject*/ );Debug.locals.put("Element", _element);Debug.locals.put("Element", _element);
...
try {
		Debug.PushSubsStack("Parser_StartElement (xml2map) ","xml2map",114,__ref.getField(false, "ba"),__ref,85);
...
Debug.JustUpdateDeviceLine();
_element = __ref.runClassMethod (b4j.docU.xml2map.class, "_createelement" /*RemoteObject*/ ,(Object)(_name));Debug.locals.put("Element", _element);Debug.locals.put("Element", _element);
...
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_mstripnamespaces" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
_key = __ref.runClassMethod (b4j.docU.xml2map.class, "_stripnamespace" /*RemoteObject*/ ,(Object)(_key));Debug.locals.put("key", _key);};
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.xml2map.class, "_getlastelement" /*RemoteObject*/ ).getField(false,"Children" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((_element)));
...
try {
		Debug.PushSubsStack("setStripNamespaces (xml2map) ","xml2map",114,__ref.getField(false, "ba"),__ref,23);
...
try {
		Debug.PushSubsStack("StripNamespace (xml2map) ","xml2map",114,__ref.getField(false, "ba"),__ref,114);
...
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 118;BA.debugLine="Dim i As Int = s.IndexOf(\":\")";
Debug.JustUpdateDeviceLine();
_i = _s.runMethod(true,"indexOf",(Object)(RemoteObject.createImmutable(":")));Debug.locals.put("i", _i);Debug.locals.put("i", _i);
 BA.debugLineNum = 119;BA.debugLine="If i > -1 Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_i,BA.numberCast(double.class, -(double) (0 + 1)))) { 
 BA.debugLineNum = 120;BA.debugLine="Return s.SubString(i + 1)";
Debug.JustUpdateDeviceLine();
if (true) return _s.runMethod(true,"substring",(Object)(RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "+",1, 1)));
 }else {
 BA.debugLineNum = 122;BA.debugLine="Return s";
Debug.JustUpdateDeviceLine();
if (true) return _s;
 };
