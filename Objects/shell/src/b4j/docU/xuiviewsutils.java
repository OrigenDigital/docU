...
public boolean isSingleton() {
    ...
    static {
		...
		remoteMe = RemoteObject.declareNull("b4j.docU.xuiviewsutils");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("xuiviewsutils"), "b4j.docU.xuiviewsutils");
	}
