...
try {
		Debug.PushSubsStack("AddNamedRange (xlworkbookwriter) ","xlworkbookwriter",112,__ref.getField(false, "ba"),__ref,149);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.xlworkbookwriter.class, "_removenamedrange" /*RemoteObject*/ ,(Object)(_name));
...
_cellrangeaddress = __ref.getField(false,"_xl" /*RemoteObject*/ ).runClassMethod (b4j.docU.xlutils.class, "_xlrangetocellrangeaddress" /*RemoteObject*/ ,(Object)(_range));Debug.locals.put("CellRangeAddress", _cellrangeaddress);Debug.locals.put("CellRangeAddress", _cellrangeaddress);
...
_jname = __ref.runClassMethod (b4j.docU.xlworkbookwriter.class, "_createname" /*RemoteObject*/ ,(Object)(_name),(Object)(BA.ObjectToString(_cellrangeaddress.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("formatAsString")),(Object)(RemoteObject.createNewArray("Object",new int[] {2},new Object[] {(_range.getField(false,"Sheet" /*RemoteObject*/ ).runMethod(true,"getName")),(xlworkbookwriter.__c.getField(true,"True"))}))))));Debug.locals.put("jname", _jname);Debug.locals.put("jname", _jname);
...
try {
		Debug.PushSubsStack("AddNamedRangeOffset (xlworkbookwriter) ","xlworkbookwriter",112,__ref.getField(false, "ba"),__ref,173);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.xlworkbookwriter.class, "_createname" /*RemoteObject*/ ,(Object)(_name),(Object)(_sb.runMethod(true,"ToString")));
...
try {
		Debug.PushSubsStack("AddNamedRangeScoped (xlworkbookwriter) ","xlworkbookwriter",112,__ref.getField(false, "ba"),__ref,167);
...
Debug.JustUpdateDeviceLine();
_jname = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");
_jname = __ref.runClassMethod (b4j.docU.xlworkbookwriter.class, "_addnamedrange" /*RemoteObject*/ ,(Object)(_name),(Object)(_range));Debug.locals.put("jName", _jname);Debug.locals.put("jName", _jname);
...
xlworkbookwriter._xl = RemoteObject.createNew ("b4j.docU.xlutils");__ref.setField("_xl",xlworkbookwriter._xl);
...
try {
		Debug.PushSubsStack("CloneSheet (xlworkbookwriter) ","xlworkbookwriter",112,__ref.getField(false, "ba"),__ref,96);
...
RemoteObject _writer = RemoteObject.declareNull("b4j.docU.xlsheetwriter");
...
Debug.JustUpdateDeviceLine();
_writer = RemoteObject.createNew ("b4j.docU.xlsheetwriter");Debug.locals.put("writer", _writer);
 BA.debugLineNum = 100;BA.debugLine="writer.Initialize(xl, Me, NewPoiSheet)";
Debug.JustUpdateDeviceLine();
_writer.runClassMethod (b4j.docU.xlsheetwriter.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref.getField(false,"_xl" /*RemoteObject*/ )),(Object)((__ref)),(Object)(_newpoisheet));
...
try {
		Debug.PushSubsStack("CreateName (xlworkbookwriter) ","xlworkbookwriter",112,__ref.getField(false, "ba"),__ref,159);
...
try {
		Debug.PushSubsStack("CreateSheetWriterByIndex (xlworkbookwriter) ","xlworkbookwriter",112,__ref.getField(false, "ba"),__ref,88);
...
Debug.JustUpdateDeviceLine();
_writer.runClassMethod (b4j.docU.xlsheetwriter.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref.getField(false,"_xl" /*RemoteObject*/ )),(Object)((__ref)),(Object)(_sheet));
...
try {
		Debug.PushSubsStack("CreateSheetWriterByName (xlworkbookwriter) ","xlworkbookwriter",112,__ref.getField(false, "ba"),__ref,77);
...
try {
		Debug.PushSubsStack("CreateStyle (xlworkbookwriter) ","xlworkbookwriter",112,__ref.getField(false, "ba"),__ref,123);
...
Debug.JustUpdateDeviceLine();
_style = RemoteObject.createNew ("b4j.docU.xlstyle");Debug.locals.put("style", _style);
 BA.debugLineNum = 125;BA.debugLine="style.Initialize (Me)";
Debug.JustUpdateDeviceLine();
_style.runClassMethod (b4j.docU.xlstyle.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)((__ref)));
...
try {
		Debug.PushSubsStack("EvaluateFormulas (xlworkbookwriter) ","xlworkbookwriter",112,__ref.getField(false, "ba"),__ref,130);
...
try {
		Debug.PushSubsStack("getActiveSheetIndex (xlworkbookwriter) ","xlworkbookwriter",112,__ref.getField(false, "ba"),__ref,135);
...
try {
		Debug.PushSubsStack("GetFont (xlworkbookwriter) ","xlworkbookwriter",112,__ref.getField(false, "ba"),__ref,105);
...
try {
		Debug.PushSubsStack("getForceFormulaRecalculation (xlworkbookwriter) ","xlworkbookwriter",112,__ref.getField(false, "ba"),__ref,199);
...
try {
		Debug.PushSubsStack("getVersionName (xlworkbookwriter) ","xlworkbookwriter",112,__ref.getField(false, "ba"),__ref,46);
...
try {
		Debug.PushSubsStack("Initialize (xlworkbookwriter) ","xlworkbookwriter",112,__ref.getField(false, "ba"),__ref,22);
...
try {
		Debug.PushSubsStack("RemoveNamedRange (xlworkbookwriter) ","xlworkbookwriter",112,__ref.getField(false, "ba"),__ref,184);
...
try {
		Debug.PushSubsStack("RemoveSheetAt (xlworkbookwriter) ","xlworkbookwriter",112,__ref.getField(false, "ba"),__ref,194);
...
try {
		Debug.PushSubsStack("SaveAs (xlworkbookwriter) ","xlworkbookwriter",112,__ref.getField(false, "ba"),__ref,52);
...
Debug.JustUpdateDeviceLine();
xlworkbookwriter.__c.runVoidMethod ("LogImpl","9227606544",RemoteObject.concat(RemoteObject.createImmutable("Failed: "),_f),0);
 };
 }
}Debug.locals.put("i", _i);
;
...
try {
		Debug.PushSubsStack("setActiveSheetIndex (xlworkbookwriter) ","xlworkbookwriter",112,__ref.getField(false, "ba"),__ref,139);
...
try {
		Debug.PushSubsStack("setForceFormulaRecalculation (xlworkbookwriter) ","xlworkbookwriter",112,__ref.getField(false, "ba"),__ref,203);
