...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"CSSUtils",_ref.getField(false, "_cssutils"),"DateUtils",_ref.getField(false, "_dateutils"),"link",_ref.getField(false, "_link"),"mTarget",_ref.getField(false, "_mtarget"),"VERSION",_ref.getField(false, "_version")};
}
}