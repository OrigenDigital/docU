...
public class cincidenciasproveedortareasabiertas {
    public static RemoteObject myClass;
	public cincidenciasproveedortareasabiertas() {
	}
    public static PCBA staticBA = new PCBA(null, cincidenciasproveedortareasabiertas.class);
...
public static RemoteObject _departamentoemisor = RemoteObject.createImmutable("");
public static RemoteObject _jamloadingindicator1 = RemoteObject.declareNull("b4j.docU.jamloadingindicator");
public static RemoteObject _textareadialog = RemoteObject.declareNull("anywheresoftware.b4j.objects.TextInputControlWrapper.TextAreaWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"btnSalir",_ref.getField(false, "_btnsalir"),"CSSUtils",_ref.getField(false, "_cssutils"),"DateUtils",_ref.getField(false, "_dateutils"),"DepartamentoEmisor",_ref.getField(false, "_departamentoemisor"),"Dialog",_ref.getField(false, "_dialog"),"frm",_ref.getField(false, "_frm"),"fx",_ref.getField(false, "_fx"),"jamLoadingIndicator1",_ref.getField(false, "_jamloadingindicator1"),"jamTableView1",_ref.getField(false, "_jamtableview1"),"mSQL",_ref.getField(false, "_msql"),"PermisoModuloUsuario",_ref.getField(false, "_permisomodulousuario"),"TextAreaDialog",_ref.getField(false, "_textareadialog"),"xui",_ref.getField(false, "_xui")};
}
}