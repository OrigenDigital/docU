...
try {
		Debug.PushSubsStack("AddLTRItems (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,341);
...
RemoteObject _lastun = RemoteObject.declareNull("b4j.docU.bctextengine._bcunbreakabletext");
RemoteObject _prev = RemoteObject.declareNull("b4j.docU.bctextengine._bcunbreakabletext");
int _i = 0;
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (b4j.docU.bctextengine.class, "_isunseparator" /*RemoteObject*/ ,(Object)((_ltrlist.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0)))))).<Boolean>get().booleanValue()) { 
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (b4j.docU.bctextengine.class, "_isunseparator" /*RemoteObject*/ ,(Object)((_ltrlist.runMethod(false,"Get",(Object)(_lastindex))))).<Boolean>get().booleanValue()) { 
...
try {
		Debug.PushSubsStack("AddParagraphViews (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,220);
...
Debug.JustUpdateDeviceLine();
_v.runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(RemoteObject.solve(new RemoteObject[] {_par.getField(false,"Style" /*RemoteObject*/ ).getField(false,"Padding" /*RemoteObject*/ ).runMethod(true,"getLeft"),_v.runMethod(true,"getLeft")}, "+",1, 0)),(Object)(RemoteObject.solve(new RemoteObject[] {_par.getField(false,"Style" /*RemoteObject*/ ).getField(false,"Padding" /*RemoteObject*/ ).runMethod(true,"getTop"),_v.runMethod(true,"getTop")}, "+",1, 0)),(Object)(_v.runMethod(true,"getWidth")),(Object)(_v.runMethod(true,"getHeight")));
 }
}Debug.locals.put("v", _v);
;
 };
...
try {
		Debug.PushSubsStack("BytesToInt (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,920);
...
bctextengine._charbc = RemoteObject.createNew ("b4j.example.bitmapcreator");__ref.setField("_charbc",bctextengine._charbc);
 //BA.debugLineNum = 30;BA.debugLine="Private cbccache As InternalCompressedBCCache";
bctextengine._cbccache = RemoteObject.createNew ("b4j.example.bitmapcreator._internalcompressedbccache");__ref.setField("_cbccache",bctextengine._cbccache);
 //BA.debugLineNum = 31;BA.debugLine="Public DefaultUnderlineStyle As BCStyledUnderline";
bctextengine._defaultunderlinestyle = RemoteObject.createNew ("b4j.docU.bctextengine._bcstyledunderline");__ref.setField("_defaultunderlinestyle",bctextengine._defaultunderlinestyle);
...
bctextengine._foregroundbc = RemoteObject.createNew ("b4j.example.bitmapcreator");__ref.setField("_foregroundbc",bctextengine._foregroundbc);
bctextengine._backgroundbc = RemoteObject.createNew ("b4j.example.bitmapcreator");__ref.setField("_backgroundbc",bctextengine._backgroundbc);
...
bctextengine._defaultstyle = RemoteObject.createNew ("b4j.docU.bctextengine._bcparagraphstyle");__ref.setField("_defaultstyle",bctextengine._defaultstyle);
...
bctextengine._mmingapbetweenlines = bctextengine.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 5)));__ref.setField("_mmingapbetweenlines",bctextengine._mmingapbetweenlines);
 //BA.debugLineNum = 47;BA.debugLine="Private WritableImage As JavaObject";
bctextengine._writableimage = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");__ref.setField("_writableimage",bctextengine._writableimage);
 //BA.debugLineNum = 48;BA.debugLine="Private sp As JavaObject";
bctextengine._sp = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");__ref.setField("_sp",bctextengine._sp);
...
bctextengine._tagparser = RemoteObject.createNew ("b4j.docU.bbcodeparser");__ref.setField("_tagparser",bctextengine._tagparser);
 //BA.debugLineNum = 52;BA.debugLine="Private EmptyTextChars As BCTextChars";
bctextengine._emptytextchars = RemoteObject.createNew ("b4j.docU.bctextengine._bctextchars");__ref.setField("_emptytextchars",bctextengine._emptytextchars);
 //BA.debugLineNum = 53;BA.debugLine="Private Emojis As B4XSet";
bctextengine._emojis = RemoteObject.createNew ("b4j.docU.b4xset");__ref.setField("_emojis",bctextengine._emojis);
...
bctextengine._vowelscodepoints = RemoteObject.createNew ("b4j.docU.b4xset");__ref.setField("_vowelscodepoints",bctextengine._vowelscodepoints);
 //BA.debugLineNum = 60;BA.debugLine="Private AsyncBCs As B4XOrderedMap";
bctextengine._asyncbcs = RemoteObject.createNew ("b4j.docU.b4xorderedmap");__ref.setField("_asyncbcs",bctextengine._asyncbcs);
 //BA.debugLineNum = 61;BA.debugLine="Private AsyncBC As BitmapCreator";
bctextengine._asyncbc = RemoteObject.createNew ("b4j.example.bitmapcreator");__ref.setField("_asyncbc",bctextengine._asyncbc);
...
bctextengine._rtlchars = RemoteObject.createNew ("b4j.docU.b4xset");__ref.setField("_rtlchars",bctextengine._rtlchars);
...
bctextengine._arabicnonlinkedletters = RemoteObject.createNew ("b4j.docU.b4xset");__ref.setField("_arabicnonlinkedletters",bctextengine._arabicnonlinkedletters);
 //BA.debugLineNum = 68;BA.debugLine="Private ArabicCharsConnectedPrev As B4XSet";
bctextengine._arabiccharsconnectedprev = RemoteObject.createNew ("b4j.docU.b4xset");__ref.setField("_arabiccharsconnectedprev",bctextengine._arabiccharsconnectedprev);
 //BA.debugLineNum = 69;BA.debugLine="Private PMDefaultColor As PremultipliedColor";
bctextengine._pmdefaultcolor = RemoteObject.createNew ("b4j.example.bitmapcreator._premultipliedcolor");__ref.setField("_pmdefaultcolor",bctextengine._pmdefaultcolor);
...
try {
		Debug.PushSubsStack("CreateBCTextChars (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,1105);
...
RemoteObject _t1 = RemoteObject.declareNull("b4j.docU.bctextengine._bctextchars");
...
Debug.JustUpdateDeviceLine();
_t1 = RemoteObject.createNew ("b4j.docU.bctextengine._bctextchars");Debug.locals.put("t1", _t1);
...
try {
		Debug.PushSubsStack("CreateBCTextCharsFromString (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,1052);
...
__ref.runClassMethod (b4j.docU.bctextengine.class, "_loadarabicdata" /*RemoteObject*/ );};
...
Debug.JustUpdateDeviceLine();
_therearevowels = BA.ObjectToBoolean(RemoteObject.solveBoolean(">",__ref.getField(false,"_vowelscodepoints" /*RemoteObject*/ ).runClassMethod (b4j.docU.b4xset.class, "_getsize" /*RemoteObject*/ ),BA.numberCast(double.class, 0)));Debug.locals.put("ThereAreVowels", _therearevowels);Debug.locals.put("ThereAreVowels", _therearevowels);
...
Debug.JustUpdateDeviceLine();
_cp = __ref.runClassMethod (b4j.docU.bctextengine.class, "_bytestoint" /*RemoteObject*/ ,(Object)(_b),(Object)(RemoteObject.solve(new RemoteObject[] {_bi,RemoteObject.createImmutable(4)}, "*",0, 1)));Debug.locals.put("cp", _cp);Debug.locals.put("cp", _cp);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_i,BA.numberCast(double.class, 0)) && RemoteObject.solveBoolean(".",BA.ObjectToBoolean((RemoteObject.solveBoolean(".",_therearevowels) && RemoteObject.solveBoolean(".",__ref.getField(false,"_vowelscodepoints" /*RemoteObject*/ ).runClassMethod (b4j.docU.b4xset.class, "_contains" /*RemoteObject*/ ,(Object)((_cp)))))))) { 
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_preprocessarabic" /*RemoteObject*/ ,(Object)(_chars),(Object)(_i));
 };
 BA.debugLineNum = 1102;BA.debugLine="Return CreateBCTextChars(chars, 0, i)";
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4j.docU.bctextengine.class, "_createbctextchars" /*RemoteObject*/ ,(Object)(_chars),(Object)(BA.numberCast(int.class, 0)),(Object)(_i));
...
try {
		Debug.PushSubsStack("CreateConnectedParent (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,159);
if (RapidSub.canDelegate("createconnectedparent")) { return __ref.runUserSub(false, "bctextengine","createconnectedparent", __ref);}
RemoteObject _connected = RemoteObject.declareNull("b4j.docU.bctextengine._bcconnectedruns");
RemoteObject _parent = RemoteObject.declareNull("b4j.docU.bctextengine._bctextrun");
...
Debug.JustUpdateDeviceLine();
_connected = RemoteObject.createNew ("b4j.docU.bctextengine._bcconnectedruns");Debug.locals.put("connected", _connected);
...
Debug.JustUpdateDeviceLine();
_parent = __ref.runClassMethod (b4j.docU.bctextengine.class, "_createrun" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("")));Debug.locals.put("parent", _parent);Debug.locals.put("parent", _parent);
...
try {
		Debug.PushSubsStack("CreateGlyph (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,828);
...
RemoteObject _g = RemoteObject.declareNull("b4j.docU.bctextengine._bcglyph");
...
RemoteObject _cbc = RemoteObject.declareNull("b4j.example.bitmapcreator._compressedbc");
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4j.docU.bctextengine.class, "_createglyphfromdefaultcolor" /*RemoteObject*/ ,(Object)(_c),(Object)(_fontmetrics.getField(false,"DefaultColorMetrics" /*RemoteObject*/ )),(Object)(_fontmetrics.getField(true,"Clr" /*RemoteObject*/ )));
 }else {
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawText",(Object)(_c),(Object)(BA.numberCast(double.class, _leftoffset)),(Object)(BA.numberCast(double.class, _baseline)),(Object)(_fontmetrics.getField(false,"Fnt" /*RemoteObject*/ )),(Object)(_fontmetrics.getField(true,"Clr" /*RemoteObject*/ )),(Object)(BA.getEnumFromString(BA.getDeviceClass("javafx.scene.text.TextAlignment"),RemoteObject.createImmutable("LEFT"))));
 BA.debugLineNum = 850;BA.debugLine="Dim jo As JavaObject = cvs";
Debug.JustUpdateDeviceLine();
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), __ref.getField(false,"_cvs" /*RemoteObject*/ ));Debug.locals.put("jo", _jo);Debug.locals.put("jo", _jo);
 BA.debugLineNum = 851;BA.debugLine="Dim bmp As B4XBitmap = jo.GetFieldJO(\"cvs\").RunM";
Debug.JustUpdateDeviceLine();
_bmp = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper");
_bmp = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper"), _jo.runMethod(false,"GetFieldJO",(Object)(RemoteObject.createImmutable("cvs"))).runMethod(false,"RunMethodJO",(Object)(BA.ObjectToString("getObject")),(Object)((bctextengine.__c.getField(false,"Null")))).runMethod(false,"RunMethod",(Object)(BA.ObjectToString("snapshot")),(Object)(RemoteObject.createNewArray("Object",new int[] {2},new Object[] {(__ref.getField(false,"_sp" /*RemoteObject*/ ).getObject()),(__ref.getField(false,"_writableimage" /*RemoteObject*/ ).getObject())}))));Debug.locals.put("bmp", _bmp);Debug.locals.put("bmp", _bmp);
...
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_rtlaware" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
__ref.runClassMethod (b4j.docU.bctextengine.class, "_recoloredgesofconnectedcharacters" /*RemoteObject*/ ,(Object)(_c),(Object)(_r2));};
...
Debug.JustUpdateDeviceLine();
_g.setField ("Width" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {__ref.runClassMethod (b4j.docU.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(BA.ObjectToString("x x")),(Object)(_fontmetrics),(Object)(bctextengine.__c.getField(true,"True"))).getField(true,"Width" /*RemoteObject*/ ),_fontmetrics.getField(true,"xWidth" /*RemoteObject*/ ),RemoteObject.createImmutable(2)}, "-*",1, 1));
 }else 
...
Debug.JustUpdateDeviceLine();
_g = __ref.runClassMethod (b4j.docU.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(BA.ObjectToString("X")),(Object)(_fontmetrics),(Object)(bctextengine.__c.getField(true,"True")));Debug.locals.put("g", _g);
 }else 
...
Debug.JustUpdateDeviceLine();
_g = __ref.runClassMethod (b4j.docU.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(BA.ObjectToString("X X")),(Object)(_fontmetrics),(Object)(bctextengine.__c.getField(true,"True")));Debug.locals.put("g", _g);
 }else {
 BA.debugLineNum = 888;BA.debugLine="g.Width = CreateGlyph(\" \", FontMetrics, False)";
Debug.JustUpdateDeviceLine();
_g.setField ("Width" /*RemoteObject*/ ,__ref.runClassMethod (b4j.docU.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(BA.ObjectToString(" ")),(Object)(_fontmetrics),(Object)(bctextengine.__c.getField(true,"False"))).getField(true,"Width" /*RemoteObject*/ ));
 }}}}
;
 };
 BA.debugLineNum = 891;BA.debugLine="If xui.IsB4J = False And MightBeAnEmoji(c) Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"getIsB4J"),bctextengine.__c.getField(true,"False")) && RemoteObject.solveBoolean(".",__ref.runClassMethod (b4j.docU.bctextengine.class, "_mightbeanemoji" /*RemoteObject*/ ,(Object)(_c)))) { 
...
__ref.runClassMethod (b4j.docU.bctextengine.class, "_loaddata" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_emojis" /*RemoteObject*/ )),(Object)(RemoteObject.createImmutable("emoji-data.txt")));};
 BA.debugLineNum = 893;BA.debugLine="g.Emoji = Emojis.Contains(BytesToInt(c.GetBytes";
Debug.JustUpdateDeviceLine();
_g.setField ("Emoji" /*RemoteObject*/ ,__ref.getField(false,"_emojis" /*RemoteObject*/ ).runClassMethod (b4j.docU.b4xset.class, "_contains" /*RemoteObject*/ ,(Object)((__ref.runClassMethod (b4j.docU.bctextengine.class, "_bytestoint" /*RemoteObject*/ ,(Object)(_c.runMethod(false,"getBytes",(Object)(__ref.getField(true,"_charset" /*RemoteObject*/ )))),(Object)(BA.numberCast(int.class, 0)))))));
 };
...
try {
		Debug.PushSubsStack("CreateGlyphFromDefaultColor (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,934);
...
RemoteObject _blackglyph = RemoteObject.declareNull("b4j.docU.bctextengine._bcglyph");
RemoteObject _g = RemoteObject.declareNull("b4j.docU.bctextengine._bcglyph");
...
Debug.JustUpdateDeviceLine();
_blackglyph = __ref.runClassMethod (b4j.docU.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(_c),(Object)(_defaultcolormetrics),(Object)(bctextengine.__c.getField(true,"False")));Debug.locals.put("BlackGlyph", _blackglyph);Debug.locals.put("BlackGlyph", _blackglyph);
...
_bi = RemoteObject.createImmutable(0);Debug.locals.put("bi", _bi);
 BA.debugLineNum = 957;BA.debugLine="ai = 3";
Debug.JustUpdateDeviceLine();
_ai = BA.numberCast(int.class, 3);Debug.locals.put("ai", _ai);
 BA.debugLineNum = 958;BA.debugLine="ri = 2";
Debug.JustUpdateDeviceLine();
_ri = BA.numberCast(int.class, 2);Debug.locals.put("ri", _ri);
 BA.debugLineNum = 959;BA.debugLine="gi = 1";
Debug.JustUpdateDeviceLine();
_gi = BA.numberCast(int.class, 1);Debug.locals.put("gi", _gi);
 BA.debugLineNum = 960;BA.debugLine="bi = 0";
Debug.JustUpdateDeviceLine();
_bi = BA.numberCast(int.class, 0);Debug.locals.put("bi", _bi);
...
try {
		Debug.PushSubsStack("CreateLine (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,399);
...
Debug.JustUpdateDeviceLine();
_line = RemoteObject.createNew ("b4j.docU.bctextengine._bctextline");Debug.locals.put("line", _line);
...
try {
		Debug.PushSubsStack("CreateRun (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,147);
...
Debug.JustUpdateDeviceLine();
_r = RemoteObject.createNew ("b4j.docU.bctextengine._bctextrun");Debug.locals.put("r", _r);
...
Debug.JustUpdateDeviceLine();
_r.setField ("TextChars" /*RemoteObject*/ ,__ref.runClassMethod (b4j.docU.bctextengine.class, "_createbctextcharsfromstring" /*RemoteObject*/ ,(Object)(_text)));
...
try {
		Debug.PushSubsStack("CreateSingleSection (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,569);
...
RemoteObject _prevgo = RemoteObject.declareNull("b4j.docU.bctextengine._bcglyphandoffset");
int _i = 0;
RemoteObject _s = RemoteObject.createImmutable("");
RemoteObject _go = RemoteObject.declareNull("b4j.docU.bctextengine._bcglyphandoffset");
RemoteObject _g = RemoteObject.declareNull("b4j.docU.bctextengine._bcglyph");
RemoteObject _u = RemoteObject.declareNull("b4j.docU.bctextengine._bcstyledunderline");
...
Debug.JustUpdateDeviceLine();
_single = RemoteObject.createNew ("b4j.docU.bctextengine._bcsinglestylesection");Debug.locals.put("single", _single);
...
Debug.JustUpdateDeviceLine();
_prevgo = RemoteObject.createNew ("b4j.docU.bctextengine._bcglyphandoffset");Debug.locals.put("PrevGO", _prevgo);
...
Debug.JustUpdateDeviceLine();
_go = RemoteObject.createNew ("b4j.docU.bctextengine._bcglyphandoffset");Debug.locals.put("go", _go);
 BA.debugLineNum = 580;BA.debugLine="Dim g As BCGlyph = CreateGlyph(s, FontMetrics, F";
Debug.JustUpdateDeviceLine();
_g = __ref.runClassMethod (b4j.docU.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(_s),(Object)(_fontmetrics),(Object)(bctextengine.__c.getField(true,"False")));Debug.locals.put("g", _g);Debug.locals.put("g", _g);
...
Debug.JustUpdateDeviceLine();
_prevgo.setField ("SpaceBetweenThisAndNext" /*RemoteObject*/ ,__ref.runClassMethod (b4j.docU.bctextengine.class, "_getkernspacebetweenchars" /*RemoteObject*/ ,(Object)(_fontmetrics),(Object)(_prevchar),(Object)(_s),(Object)(_prevgo.getField(false,"Glyph" /*RemoteObject*/ )),(Object)(_g)));
 }else {
...
Debug.JustUpdateDeviceLine();
_u = __ref.runClassMethod (b4j.docU.bctextengine.class, "_getunderlinestyle" /*RemoteObject*/ ,(Object)(_run));Debug.locals.put("u", _u);Debug.locals.put("u", _u);
...
Debug.JustUpdateDeviceLine();
_run.getField(false,"View" /*RemoteObject*/ ).runMethod(true,"setLeft",BA.numberCast(double.class, 0));
 BA.debugLineNum = 606;BA.debugLine="Run.View.Top = 0";
Debug.JustUpdateDeviceLine();
_run.getField(false,"View" /*RemoteObject*/ ).runMethod(true,"setTop",BA.numberCast(double.class, 0));
...
try {
		Debug.PushSubsStack("CreateStyle (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,136);
if (RapidSub.canDelegate("createstyle")) { return __ref.runUserSub(false, "bctextengine","createstyle", __ref);}
RemoteObject _s = RemoteObject.declareNull("b4j.docU.bctextengine._bcparagraphstyle");
...
Debug.JustUpdateDeviceLine();
_s = RemoteObject.createNew ("b4j.docU.bctextengine._bcparagraphstyle");Debug.locals.put("s", _s);
...
try {
		Debug.PushSubsStack("CreateUnbreakable (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,478);
...
RemoteObject _unbreakable = RemoteObject.declareNull("b4j.docU.bctextengine._bcunbreakabletext");
RemoteObject _single = RemoteObject.declareNull("b4j.docU.bctextengine._bcsinglestylesection");
Debug.locals.put("Run", _run);
Debug.locals.put("TextChars", _textchars);
Debug.locals.put("FontMetrics", _fontmetrics);
...
Debug.JustUpdateDeviceLine();
_unbreakable = RemoteObject.createNew ("b4j.docU.bctextengine._bcunbreakabletext");Debug.locals.put("unbreakable", _unbreakable);
...
Debug.JustUpdateDeviceLine();
_single = __ref.runClassMethod (b4j.docU.bctextengine.class, "_createsinglesection" /*RemoteObject*/ ,(Object)(_run),(Object)(_textchars),(Object)(_fontmetrics));Debug.locals.put("single", _single);Debug.locals.put("single", _single);
...
try {
		Debug.PushSubsStack("DetectRTL (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,495);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_loaddata" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_rtlchars" /*RemoteObject*/ )),(Object)(RemoteObject.createImmutable("rtl-data.txt")));
 };
...
Debug.JustUpdateDeviceLine();
_cp = __ref.runClassMethod (b4j.docU.bctextengine.class, "_bytestoint" /*RemoteObject*/ ,(Object)(_firstchar.runMethod(false,"getBytes",(Object)(__ref.getField(true,"_charset" /*RemoteObject*/ )))),(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("cp", _cp);Debug.locals.put("cp", _cp);
 BA.debugLineNum = 504;BA.debugLine="Return RTLChars.Contains(cp)";
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_rtlchars" /*RemoteObject*/ ).runClassMethod (b4j.docU.b4xset.class, "_contains" /*RemoteObject*/ ,(Object)((_cp)));
...
try {
		Debug.PushSubsStack("DrawLine (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,696);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_drawunbreakable" /*RemoteObject*/ ,(Object)(_un),(Object)(_offsety));
 }
}Debug.locals.put("un", _un);
;
...
try {
		Debug.PushSubsStack("DrawParagraph (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,630);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_drawline" /*RemoteObject*/ ,(Object)(_line),(Object)(_line.getField(true,"BaselineY" /*RemoteObject*/ )));
 }
}Debug.locals.put("line", _line);
;
...
try {
		Debug.PushSubsStack("DrawSingleLine (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,636);
...
Debug.JustUpdateDeviceLine();
_r = __ref.runClassMethod (b4j.docU.bctextengine.class, "_drawsinglelineshared" /*RemoteObject*/ ,(Object)(_line),(Object)(_iv),(Object)(_par));Debug.locals.put("r", _r);Debug.locals.put("r", _r);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_foregroundbc" /*RemoteObject*/ ).runVoidMethod ("_drawrect2",(Object)(_r),(Object)(__ref.runClassMethod (b4j.docU.bctextengine.class, "_getbrush" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Transparent")))),(Object)(bctextengine.__c.getField(true,"True")),(Object)(BA.numberCast(int.class, 0)));
 BA.debugLineNum = 640;BA.debugLine="DrawLine(line, line.MaxHeightAboveBaseLine)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_drawline" /*RemoteObject*/ ,(Object)(_line),(Object)(_line.getField(true,"MaxHeightAboveBaseLine" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("DrawSingleLineAsync (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,653);
...
__ref.getField(false,"_asyncbcs" /*RemoteObject*/ ).runClassMethod (b4j.docU.b4xorderedmap.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));};
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_asyncbc" /*RemoteObject*/ ,__ref.runClassMethod (b4j.docU.bctextengine.class, "_findasyncbc" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _r.runMethod(true,"getWidth"))),(Object)(BA.numberCast(int.class, _r.runMethod(true,"getHeight")))));
 BA.debugLineNum = 661;BA.debugLine="AsyncTasks.Add(AsyncBC.AsyncDrawRect(r, GetBrush";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_asynctasks" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((__ref.getField(false,"_asyncbc" /*RemoteObject*/ ).runMethod(false,"_asyncdrawrect",(Object)(_r),(Object)(__ref.runClassMethod (b4j.docU.bctextengine.class, "_getbrush" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Transparent")))),(Object)(bctextengine.__c.getField(true,"True")),(Object)(BA.numberCast(int.class, 0))))));
...
try {
		Debug.PushSubsStack("DrawSingleLineShared (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,645);
...
Debug.JustUpdateDeviceLine();
_iv.runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(double.class, _par.getField(false,"Style" /*RemoteObject*/ ).getField(false,"Padding" /*RemoteObject*/ ).runMethod(true,"getLeft"))),(Object)(RemoteObject.solve(new RemoteObject[] {_par.getField(false,"Style" /*RemoteObject*/ ).getField(false,"Padding" /*RemoteObject*/ ).runMethod(true,"getTop"),(RemoteObject.solve(new RemoteObject[] {_line.getField(true,"BaselineY" /*RemoteObject*/ ),_line.getField(true,"MaxHeightAboveBaseLine" /*RemoteObject*/ )}, "-",1, 1)),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "+/",1, 0)),(Object)(RemoteObject.solve(new RemoteObject[] {_r.runMethod(true,"getWidth"),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "/",0, 0)),(Object)(RemoteObject.solve(new RemoteObject[] {_r.runMethod(true,"getHeight"),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "/",0, 0)));
...
try {
		Debug.PushSubsStack("DrawSingleStyleSection (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,708);
...
RemoteObject _dt = RemoteObject.declareNull("b4j.example.bitmapcreator._drawtask");
RemoteObject _u = RemoteObject.declareNull("b4j.docU.bctextengine._bcstyledunderline");
...
Debug.JustUpdateDeviceLine();
_u = __ref.runClassMethod (b4j.docU.bctextengine.class, "_getunderlinestyle" /*RemoteObject*/ ,(Object)(_single.getField(false,"Run" /*RemoteObject*/ )));Debug.locals.put("u", _u);Debug.locals.put("u", _u);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_asynctasks" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((__ref.getField(false,"_asyncbc" /*RemoteObject*/ ).runMethod(false,"_asyncdrawrect",(Object)(_r),(Object)(__ref.runClassMethod (b4j.docU.bctextengine.class, "_getbrush" /*RemoteObject*/ ,(Object)(_clr))),(Object)(bctextengine.__c.getField(true,"True")),(Object)(BA.numberCast(int.class, 0))))));
 }else {
 BA.debugLineNum = 738;BA.debugLine="ForegroundBC.DrawRect2(r, GetBrush(clr), True,";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_foregroundbc" /*RemoteObject*/ ).runVoidMethod ("_drawrect2",(Object)(_r),(Object)(__ref.runClassMethod (b4j.docU.bctextengine.class, "_getbrush" /*RemoteObject*/ ,(Object)(_clr))),(Object)(bctextengine.__c.getField(true,"True")),(Object)(BA.numberCast(int.class, 0)));
 };
 };
...
try {
		Debug.PushSubsStack("DrawText (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,204);
...
RemoteObject _par = RemoteObject.declareNull("b4j.docU.bctextengine._bcparagraph");
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_resizeimageview" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_foregroundbc" /*RemoteObject*/ )),(Object)(_par),(Object)(_foregroundimageview),(Object)(_par.getField(false,"Style" /*RemoteObject*/ ).getField(true,"ResizeHeightAutomatically" /*RemoteObject*/ )));
 };
...
Debug.JustUpdateDeviceLine();
_sv.runMethod(true,"setScrollViewContentHeight",bctextengine.__c.runMethod(true,"Max",(Object)(RemoteObject.solve(new RemoteObject[] {_sv.runMethod(true,"getHeight"),bctextengine.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))}, "-",1, 0)),(Object)(RemoteObject.solve(new RemoteObject[] {_foregroundimageview.runMethod(true,"getHeight"),_par.getField(false,"Style" /*RemoteObject*/ ).getField(false,"Padding" /*RemoteObject*/ ).runMethod(true,"getTop"),_par.getField(false,"Style" /*RemoteObject*/ ).getField(false,"Padding" /*RemoteObject*/ ).runMethod(true,"getBottom")}, "++",2, 0))));
 };
 BA.debugLineNum = 216;BA.debugLine="AddParagraphViews(par)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_addparagraphviews" /*RemoteObject*/ ,(Object)(_par));
...
try {
		Debug.PushSubsStack("DrawUnbreakable (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,702);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_drawsinglestylesection" /*RemoteObject*/ ,(Object)(_single),(Object)(_offsety));
 }
}Debug.locals.put("single", _single);
;
...
try {
		Debug.PushSubsStack("FindAsyncBC (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,670);
...
Debug.JustUpdateDeviceLine();
{
final RemoteObject group1 = __ref.getField(false,"_asyncbcs" /*RemoteObject*/ ).runClassMethod (b4j.docU.b4xorderedmap.class, "_getkeys" /*RemoteObject*/ );
final int groupLen1 = group1.runMethod(true,"getSize").<Integer>get()
;int index1 = 0;
;
for (; index1 < groupLen1;index1++){
...
Debug.JustUpdateDeviceLine();
_used = BA.ObjectToBoolean(__ref.getField(false,"_asyncbcs" /*RemoteObject*/ ).runClassMethod (b4j.docU.b4xorderedmap.class, "_get" /*RemoteObject*/ ,(Object)((_bc))));Debug.locals.put("Used", _used);Debug.locals.put("Used", _used);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_asyncbcs" /*RemoteObject*/ ).runClassMethod (b4j.docU.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)((_bc)),(Object)((bctextengine.__c.getField(true,"True"))));
...
Debug.JustUpdateDeviceLine();
{
final RemoteObject group14 = __ref.getField(false,"_asyncbcs" /*RemoteObject*/ ).runClassMethod (b4j.docU.b4xorderedmap.class, "_getvalues" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("FindMinRect (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,984);
...
try {
		Debug.PushSubsStack("FindSingleStyleSection (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,776);
...
RemoteObject _line = RemoteObject.declareNull("b4j.docU.bctextengine._bctextline");
RemoteObject _un = RemoteObject.declareNull("b4j.docU.bctextengine._bcunbreakabletext");
RemoteObject _s = RemoteObject.declareNull("b4j.docU.bctextengine._bcsinglestylesection");
Debug.locals.put("Paragraph", _paragraph);
Debug.locals.put("X", _x);
Debug.locals.put("Y", _y);
...
try {
		Debug.PushSubsStack("FontToKey (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,1012);
...
try {
		Debug.PushSubsStack("GetBrush (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,799);
if (RapidSub.canDelegate("getbrush")) { return __ref.runUserSub(false, "bctextengine","getbrush", __ref, _clr);}
RemoteObject _b = RemoteObject.declareNull("b4j.example.bcpath._bcbrush");
Debug.locals.put("clr", _clr);
...
try {
		Debug.PushSubsStack("GetFirstSingleStyle (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,394);
if (RapidSub.canDelegate("getfirstsinglestyle")) { return __ref.runUserSub(false, "bctextengine","getfirstsinglestyle", __ref, _line);}
RemoteObject _firstun = RemoteObject.declareNull("b4j.docU.bctextengine._bcunbreakabletext");
Debug.locals.put("Line", _line);
...
try {
		Debug.PushSubsStack("GetFontMetrics (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,807);
...
RemoteObject _fm = RemoteObject.declareNull("b4j.docU.bctextengine._bcfontmetrics");
Debug.locals.put("Fnt", _fnt);
Debug.locals.put("clr", _clr);
...
Debug.JustUpdateDeviceLine();
_key = __ref.runClassMethod (b4j.docU.bctextengine.class, "_fonttokey" /*RemoteObject*/ ,(Object)(_fnt),(Object)(_clr));Debug.locals.put("key", _key);Debug.locals.put("key", _key);
...
Debug.JustUpdateDeviceLine();
_fm = RemoteObject.createNew ("b4j.docU.bctextengine._bcfontmetrics");Debug.locals.put("fm", _fm);
...
Debug.JustUpdateDeviceLine();
_fm.setField ("xWidth" /*RemoteObject*/ ,__ref.runClassMethod (b4j.docU.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(BA.ObjectToString("x")),(Object)(_fm),(Object)(bctextengine.__c.getField(true,"False"))).getField(true,"Width" /*RemoteObject*/ ));
 }else {
 BA.debugLineNum = 820;BA.debugLine="fm.DefaultColorMetrics = GetFontMetrics(Fnt, Def";
Debug.JustUpdateDeviceLine();
_fm.setField ("DefaultColorMetrics" /*RemoteObject*/ ,__ref.runClassMethod (b4j.docU.bctextengine.class, "_getfontmetrics" /*RemoteObject*/ ,(Object)(_fnt),(Object)(__ref.getField(true,"_defaultcolor" /*RemoteObject*/ ))));
...
try {
		Debug.PushSubsStack("GetKernSpaceBetweenChars (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,615);
...
Debug.JustUpdateDeviceLine();
_w = __ref.runClassMethod (b4j.docU.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(_together),(Object)(_fm),(Object)(bctextengine.__c.getField(true,"True"))).getField(true,"Width" /*RemoteObject*/ );Debug.locals.put("w", _w);Debug.locals.put("w", _w);
...
try {
		Debug.PushSubsStack("getMinGapBetweenLines (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,1046);
...
try {
		Debug.PushSubsStack("GetRunAnchorIfCurrentNotSet (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,561);
...
try {
		Debug.PushSubsStack("getSpaceBetweenCharacters (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,1024);
...
try {
		Debug.PushSubsStack("getSpaceBetweenLines (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,1033);
...
try {
		Debug.PushSubsStack("GetUnderlineStyle (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,749);
...
try {
		Debug.PushSubsStack("HandleConnectedTextRuns (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,409);
...
RemoteObject _cr = RemoteObject.declareNull("b4j.docU.bctextengine._bcconnectedruns");
RemoteObject _r = RemoteObject.declareNull("b4j.docU.bctextengine._bctextrun");
RemoteObject _width = RemoteObject.createImmutable(0);
RemoteObject _un = RemoteObject.declareNull("b4j.docU.bctextengine._bcunbreakabletext");
RemoteObject _fm = RemoteObject.declareNull("b4j.docU.bctextengine._bcfontmetrics");
RemoteObject _connectedwidth = RemoteObject.createImmutable(0);
RemoteObject _u = RemoteObject.declareNull("b4j.docU.bctextengine._bcunbreakabletext");
int _i = 0;
RemoteObject _leftoffset = RemoteObject.createImmutable(0);
RemoteObject _single = RemoteObject.declareNull("b4j.docU.bctextengine._bcsinglestylesection");
Debug.locals.put("Run", _run);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_handletextrun" /*RemoteObject*/ ,(Object)(_r),(Object)(_children),(Object)(_style));
 }
}Debug.locals.put("r", _r);
;
...
Debug.JustUpdateDeviceLine();
_fm = __ref.runClassMethod (b4j.docU.bctextengine.class, "_getfontmetrics" /*RemoteObject*/ ,(Object)(_run.getField(false,"TextFont" /*RemoteObject*/ )),(Object)(_run.getField(true,"TextColor" /*RemoteObject*/ )));Debug.locals.put("fm", _fm);Debug.locals.put("fm", _fm);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_mergeunbreakables" /*RemoteObject*/ ,(Object)(_u),(Object)((_children.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i))))));
 }
}Debug.locals.put("i", _i);
;
...
Debug.JustUpdateDeviceLine();
_single = __ref.runClassMethod (b4j.docU.bctextengine.class, "_createsinglesection" /*RemoteObject*/ ,(Object)(_run),(Object)(__ref.getField(false,"_emptytextchars" /*RemoteObject*/ )),(Object)(_fm));Debug.locals.put("single", _single);Debug.locals.put("single", _single);
...
try {
		Debug.PushSubsStack("HandleTextRun (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,447);
...
Debug.JustUpdateDeviceLine();
_unbreakables.runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4j.docU.bctextengine.class, "_createunbreakable" /*RemoteObject*/ ,(Object)(_run),(Object)(__ref.runClassMethod (b4j.docU.bctextengine.class, "_textcharssubstring" /*RemoteObject*/ ,(Object)(_run.getField(false,"TextChars" /*RemoteObject*/ )),(Object)(_i1),(Object)(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_i),_offset}, "+",1, 1)))),(Object)(_fm),(Object)(bctextengine.__c.getField(true,"True")),(Object)(_style)))));
 };
...
Debug.JustUpdateDeviceLine();
_unbreakables.runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4j.docU.bctextengine.class, "_createunbreakable" /*RemoteObject*/ ,(Object)(_run),(Object)(__ref.getField(false,"_emptytextchars" /*RemoteObject*/ )),(Object)(_fm),(Object)(bctextengine.__c.getField(true,"True")),(Object)(_style)))));
 };
...
Debug.JustUpdateDeviceLine();
_unbreakables.runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4j.docU.bctextengine.class, "_createunbreakable" /*RemoteObject*/ ,(Object)(_run),(Object)(__ref.getField(false,"_emptytextchars" /*RemoteObject*/ )),(Object)(_fm),(Object)(bctextengine.__c.getField(true,"False")),(Object)(_style)))));
 };
...
try {
		Debug.PushSubsStack("Initialize (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,74);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_vowelscodepoints" /*RemoteObject*/ ).runClassMethod (b4j.docU.b4xset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
 BA.debugLineNum = 77;BA.debugLine="EmptyTextChars = CreateBCTextCharsFromString(\"\")";
Debug.JustUpdateDeviceLine();
__ref.setField ("_emptytextchars" /*RemoteObject*/ ,__ref.runClassMethod (b4j.docU.bctextengine.class, "_createbctextcharsfromstring" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable(""))));
...
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(double.class, 0)),(Object)(BA.numberCast(double.class, 0)),(Object)(BA.numberCast(double.class, bctextengine.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2))))),(Object)(BA.numberCast(double.class, bctextengine.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2))))));
 BA.debugLineNum = 83;BA.debugLine="Try";
Debug.JustUpdateDeviceLine();
try { BA.debugLineNum = 84;BA.debugLine="Dim fx As JFX";
Debug.JustUpdateDeviceLine();
_fx = RemoteObject.createNew ("anywheresoftware.b4j.objects.JFX");Debug.locals.put("fx", _fx);
 BA.debugLineNum = 85;BA.debugLine="Dim jo As JavaObject = fx.PrimaryScreen";
Debug.JustUpdateDeviceLine();
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _fx.runMethod(false,"getPrimaryScreen").getObject());Debug.locals.put("jo", _jo);Debug.locals.put("jo", _jo);
 BA.debugLineNum = 86;BA.debugLine="mScale = Ceil(jo.RunMethod(\"getOutputScaleX\", Nu";
Debug.JustUpdateDeviceLine();
__ref.setField ("_mscale" /*RemoteObject*/ ,BA.numberCast(float.class, bctextengine.__c.runMethod(true,"Ceil",(Object)(BA.numberCast(double.class, _jo.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getOutputScaleX")),(Object)((bctextengine.__c.getField(false,"Null")))))))));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e11) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e11.toString()); BA.debugLineNum = 88;BA.debugLine="mScale = 1";
Debug.JustUpdateDeviceLine();
__ref.setField ("_mscale" /*RemoteObject*/ ,BA.numberCast(float.class, 1));
 };
 BA.debugLineNum = 92;BA.debugLine="setSpaceBetweenCharacters(100dip / 100)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_setspacebetweencharacters" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {bctextengine.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 100))),RemoteObject.createImmutable(100)}, "/",0, 0))));
 BA.debugLineNum = 93;BA.debugLine="setSpaceBetweenLines(20dip)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_setspacebetweenlines" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, bctextengine.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 20))))));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_resizelayers" /*RemoteObject*/ ,(Object)(bctextengine.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 200)))),(Object)(bctextengine.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 100)))));
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_defaultstyle" /*RemoteObject*/ ,__ref.runClassMethod (b4j.docU.bctextengine.class, "_createstyle" /*RemoteObject*/ ));
 BA.debugLineNum = 105;BA.debugLine="TagParser.Initialize (Me)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_tagparser" /*RemoteObject*/ ).runClassMethod (b4j.docU.bbcodeparser.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)((__ref)));
...
_v = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
{
final RemoteObject group31 = _parent.runMethod(false,"GetAllViewsRecursive");
final int groupLen31 = group31.runMethod(true,"getSize").<Integer>get()
;int index31 = 0;
;
for (; index31 < groupLen31;index31++){
_v = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), group31.runMethod(false,"Get",index31));Debug.locals.put("v", _v);
Debug.locals.put("v", _v);
 BA.debugLineNum = 111;BA.debugLine="If v.Tag Is BBCodeView Or v.Tag Is BBLabel Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("i",_v.runMethod(false,"getTag"), RemoteObject.createImmutable("b4j.docU.bbcodeview")) || RemoteObject.solveBoolean("i",_v.runMethod(false,"getTag"), RemoteObject.createImmutable("b4j.docU.bblabel"))) { 
...
try {
		Debug.PushSubsStack("IsSpace (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,795);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4j.docU.bctextengine.class, "_textcharequals" /*RemoteObject*/ ,(Object)(_tc),(Object)(RemoteObject.createImmutable(" ")));
...
try {
		Debug.PushSubsStack("IsUNSeparator (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,369);
...
try {
		Debug.PushSubsStack("LoadArabicData (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,1126);
if (RapidSub.canDelegate("loadarabicdata")) { return __ref.runUserSub(false, "bctextengine","loadarabicdata", __ref);}
RemoteObject _a = RemoteObject.declareNull("b4j.example.bitmapcreator._argbcolor");
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_arabicnonlinkedletters" /*RemoteObject*/ ).runClassMethod (b4j.docU.b4xset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
 BA.debugLineNum = 1130;BA.debugLine="ArabicCharsConnectedPrev.Initialize";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_arabiccharsconnectedprev" /*RemoteObject*/ ).runClassMethod (b4j.docU.b4xset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
 BA.debugLineNum = 1131;BA.debugLine="Dim a As ARGBColor";
Debug.JustUpdateDeviceLine();
_a = RemoteObject.createNew ("b4j.example.bitmapcreator._argbcolor");Debug.locals.put("a", _a);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_vowelscodepoints" /*RemoteObject*/ ).runClassMethod (b4j.docU.b4xset.class, "_add" /*RemoteObject*/ ,(Object)((bctextengine.__c.getField(false,"Bit").runMethod(true,"ParseInt",(Object)(_split.getArrayElement(true,BA.numberCast(int.class, 0))),(Object)(BA.numberCast(int.class, 16))))));
 }else {
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_arabicnonlinkedletters" /*RemoteObject*/ ).runClassMethod (b4j.docU.b4xset.class, "_add" /*RemoteObject*/ ,(Object)(((BA.ObjectToString(bctextengine.__c.runMethod(true,"Chr",(Object)(bctextengine.__c.getField(false,"Bit").runMethod(true,"ParseInt",(Object)(_split.getArrayElement(true,BA.numberCast(int.class, 0))),(Object)(BA.numberCast(int.class, 16))))))))));
 };
 };
 }
}Debug.locals.put("line", _line);
...
try {
		Debug.PushSubsStack("LoadData (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,1200);
...
Debug.JustUpdateDeviceLine();
_set.runClassMethod (b4j.docU.b4xset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
...
Debug.JustUpdateDeviceLine();
_set.runClassMethod (b4j.docU.b4xset.class, "_add" /*RemoteObject*/ ,(Object)((bctextengine.__c.getField(false,"Bit").runMethod(true,"ParseInt",(Object)(_line),(Object)(BA.numberCast(int.class, 16))))));
 }else {
...
Debug.JustUpdateDeviceLine();
_set.runClassMethod (b4j.docU.b4xset.class, "_add" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable((_a))));
 }
}Debug.locals.put("a", _a);
;
 };
...
try {
		Debug.PushSubsStack("MergeUnbreakables (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,551);
...
Debug.JustUpdateDeviceLine();
_un1.setField ("Anchor" /*RemoteObject*/ ,__ref.runClassMethod (b4j.docU.bctextengine.class, "_getrunanchorifcurrentnotset" /*RemoteObject*/ ,(Object)(_single.getField(false,"Run" /*RemoteObject*/ )),(Object)(_un1.getField(true,"Anchor" /*RemoteObject*/ ))));
 }
}Debug.locals.put("single", _single);
;
...
try {
		Debug.PushSubsStack("MightBeAnEmoji (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,928);
...
try {
		Debug.PushSubsStack("OrganizeLines (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,237);
...
RemoteObject _linestyle = RemoteObject.declareNull("b4j.docU.bctextengine._bcsinglestylesection");
RemoteObject _last = RemoteObject.declareNull("b4j.docU.bctextengine._bcunbreakabletext");
...
Debug.JustUpdateDeviceLine();
_linestyle = __ref.runClassMethod (b4j.docU.bctextengine.class, "_getfirstsinglestyle" /*RemoteObject*/ ,(Object)(_line));Debug.locals.put("linestyle", _linestyle);Debug.locals.put("linestyle", _linestyle);
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (b4j.docU.bctextengine.class, "_isspace" /*RemoteObject*/ ,(Object)(_last.getField(false,"NotFullTextChars" /*RemoteObject*/ ))).<Boolean>get().booleanValue()) { 
...
try {
		Debug.PushSubsStack("OrganizeRTLParagraph (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,301);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_addltritems" /*RemoteObject*/ ,(Object)(_ltrlist),(Object)(_newlist));
...
Debug.JustUpdateDeviceLine();
_v.runMethod(true,"setLeft",RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_x,__ref.getField(true,"_mspacebetweencharacters" /*RemoteObject*/ )}, "+",1, 0)),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "/",0, 0));
 };
 }
}Debug.locals.put("single", _single);
;
...
try {
		Debug.PushSubsStack("OrganizeSingleStyles (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,374);
...
Debug.JustUpdateDeviceLine();
_v.runMethod(true,"setTop",RemoteObject.solve(new RemoteObject[] {_line.getField(true,"BaselineY" /*RemoteObject*/ ),__ref.getField(true,"_mscale" /*RemoteObject*/ ),_v.runMethod(true,"getHeight"),_single.getField(false,"Run" /*RemoteObject*/ ).getField(true,"VerticalOffset" /*RemoteObject*/ )}, "/-+",2, 0));
...
try {
		Debug.PushSubsStack("OrganizeUnbreakables (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,507);
...
RemoteObject _un = RemoteObject.declareNull("b4j.docU.bctextengine._bcunbreakabletext");
RemoteObject _i = RemoteObject.createImmutable(0);
RemoteObject _nextun = RemoteObject.declareNull("b4j.docU.bctextengine._bcunbreakabletext");
RemoteObject _singlestyle = RemoteObject.declareNull("b4j.docU.bctextengine._bcsinglestylesection");
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_mergeunbreakables" /*RemoteObject*/ ,(Object)(_un),(Object)(_nextun));
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (b4j.docU.bctextengine.class, "_textcharequals" /*RemoteObject*/ ,(Object)(_un.getField(false,"NotFullTextChars" /*RemoteObject*/ )),(Object)(BA.ObjectToString(bctextengine.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 13)))))).<Boolean>get().booleanValue()) { 
if (true) continue;};
 BA.debugLineNum = 524;BA.debugLine="If TextCharEquals(un.NotFullTextChars, Chr(10))";
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (b4j.docU.bctextengine.class, "_textcharequals" /*RemoteObject*/ ,(Object)(_un.getField(false,"NotFullTextChars" /*RemoteObject*/ )),(Object)(BA.ObjectToString(bctextengine.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 10)))))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 525;BA.debugLine="CreateLine(p)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_createline" /*RemoteObject*/ ,(Object)(_p));
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(".",__ref.runClassMethod (b4j.docU.bctextengine.class, "_isspace" /*RemoteObject*/ ,(Object)(_un.getField(false,"NotFullTextChars" /*RemoteObject*/ )))) && RemoteObject.solveBoolean("=",_p.getField(false,"CurrentLine" /*RemoteObject*/ ).getField(false,"Unbreakables" /*RemoteObject*/ ).runMethod(true,"getSize"),BA.numberCast(double.class, 1))) { 
...
try {
		Debug.PushSubsStack("Prepare (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,169);
...
Debug.JustUpdateDeviceLine();
_par = RemoteObject.createNew ("b4j.docU.bctextengine._bcparagraph");Debug.locals.put("par", _par);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_indentwidth" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {__ref.runClassMethod (b4j.docU.bctextengine.class, "_getfontmetrics" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_defaultfont" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_defaultcolor" /*RemoteObject*/ ))).getField(true,"xWidth" /*RemoteObject*/ ),__ref.getField(true,"_tabwidthmeasuredinx" /*RemoteObject*/ )}, "*",0, 1));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_handleconnectedtextruns" /*RemoteObject*/ ,(Object)(_run),(Object)(_unbreakeables),(Object)(_style));
 }else {
 BA.debugLineNum = 181;BA.debugLine="HandleTextRun(run, unbreakeables, Style)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_handletextrun" /*RemoteObject*/ ,(Object)(_run),(Object)(_unbreakeables),(Object)(_style));
 };
 }
}Debug.locals.put("run", _run);
;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_createline" /*RemoteObject*/ ,(Object)(_par));
 BA.debugLineNum = 185;BA.debugLine="OrganizeUnbreakables(par, unbreakeables)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_organizeunbreakables" /*RemoteObject*/ ,(Object)(_par),(Object)(_unbreakeables));
 BA.debugLineNum = 186;BA.debugLine="OrganizeLines(par)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_organizelines" /*RemoteObject*/ ,(Object)(_par));
 BA.debugLineNum = 187;BA.debugLine="OrganizeSingleStyles(par)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bctextengine.class, "_organizesinglestyles" /*RemoteObject*/ ,(Object)(_par));
...
__ref.runClassMethod (b4j.docU.bctextengine.class, "_organizertlparagraph" /*RemoteObject*/ ,(Object)(_par));};
...
try {
		Debug.PushSubsStack("PrepareForLazyDrawing (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,192);
...
try {
		Debug.PushSubsStack("PreprocessArabic (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,1148);
...
RemoteObject _arabicchars = RemoteObject.declareNull("b4j.docU.b4xbitset");
RemoteObject _arabicnonlinked = RemoteObject.declareNull("b4j.docU.b4xbitset");
...
Debug.JustUpdateDeviceLine();
_arabicchars = RemoteObject.createNew ("b4j.docU.b4xbitset");Debug.locals.put("ArabicChars", _arabicchars);
_arabicnonlinked = RemoteObject.createNew ("b4j.docU.b4xbitset");Debug.locals.put("ArabicNonLinked", _arabicnonlinked);
...
Debug.JustUpdateDeviceLine();
_arabicchars.runClassMethod (b4j.docU.b4xbitset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(_length));
 BA.debugLineNum = 1162;BA.debugLine="ArabicNonLinked.Initialize(Length)";
Debug.JustUpdateDeviceLine();
_arabicnonlinked.runClassMethod (b4j.docU.b4xbitset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(_length));
 };
 BA.debugLineNum = 1164;BA.debugLine="ArabicChars.Set(i, True)";
Debug.JustUpdateDeviceLine();
_arabicchars.runClassMethod (b4j.docU.b4xbitset.class, "_set" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _i)),(Object)(bctextengine.__c.getField(true,"True")));
 BA.debugLineNum = 1165;BA.debugLine="If ArabicNonLinkedLetters.Contains(chars(i)) Th";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_arabicnonlinkedletters" /*RemoteObject*/ ).runClassMethod (b4j.docU.b4xset.class, "_contains" /*RemoteObject*/ ,(Object)((_chars.getArrayElement(true,BA.numberCast(int.class, _i))))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 1166;BA.debugLine="ArabicNonLinked.Set(i, True)";
Debug.JustUpdateDeviceLine();
_arabicnonlinked.runClassMethod (b4j.docU.b4xbitset.class, "_set" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _i)),(Object)(bctextengine.__c.getField(true,"True")));
 };
 };
 }
}Debug.locals.put("i", _i);
...
__ref.getField(false,"_arabiccharsconnectedprev" /*RemoteObject*/ ).runClassMethod (b4j.docU.b4xset.class, "_add" /*RemoteObject*/ ,(Object)((_chars.getArrayElement(true,BA.numberCast(int.class, _i)))));};
 };
 }
}Debug.locals.put("i", _i);
;
...
try {
		Debug.PushSubsStack("PrintTextChars (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,1191);
...
Debug.JustUpdateDeviceLine();
bctextengine.__c.runVoidMethod ("LogImpl","9156893190",_sb.runMethod(true,"ToString"),0);
...
try {
		Debug.PushSubsStack("RecolorEdgesOfConnectedCharacters (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,902);
...
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_arabiccharsconnectedprev" /*RemoteObject*/ ).runClassMethod (b4j.docU.b4xset.class, "_contains" /*RemoteObject*/ ,(Object)((_c))).<Boolean>get().booleanValue()) { 
...
try {
		Debug.PushSubsStack("ReleaseAsyncBC (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,690);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_asyncbcs" /*RemoteObject*/ ).runClassMethod (b4j.docU.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)((_bc)),(Object)((bctextengine.__c.getField(true,"False"))));
...
try {
		Debug.PushSubsStack("ResizeCharBC (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,754);
...
RemoteObject _fx = RemoteObject.declareNull("anywheresoftware.b4j.objects.JFX");
RemoteObject _transform = RemoteObject.declareNull("anywheresoftware.b4j.object.JavaObject");
RemoteObject _scale = RemoteObject.createImmutable(0);
Debug.locals.put("width", _width);
Debug.locals.put("height", _height);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("Resize",(Object)(BA.numberCast(double.class, _scaledwidth)),(Object)(BA.numberCast(double.class, _scaledheight)));
 BA.debugLineNum = 762;BA.debugLine="Dim w As Int = mScale * cvs.TargetRect.Width";
Debug.JustUpdateDeviceLine();
_w = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mscale" /*RemoteObject*/ ),__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"getTargetRect").runMethod(true,"getWidth")}, "*",0, 0));Debug.locals.put("w", _w);Debug.locals.put("w", _w);
 BA.debugLineNum = 763;BA.debugLine="Dim h As Int = mScale * cvs.TargetRect.Height";
Debug.JustUpdateDeviceLine();
_h = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mscale" /*RemoteObject*/ ),__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"getTargetRect").runMethod(true,"getHeight")}, "*",0, 0));Debug.locals.put("h", _h);Debug.locals.put("h", _h);
 BA.debugLineNum = 764;BA.debugLine="WritableImage.InitializeNewInstance(\"javafx.scene";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_writableimage" /*RemoteObject*/ ).runVoidMethod ("InitializeNewInstance",(Object)(BA.ObjectToString("javafx.scene.image.WritableImage")),(Object)(RemoteObject.createNewArray("Object",new int[] {2},new Object[] {(_w),(_h)})));
 BA.debugLineNum = 765;BA.debugLine="Dim sp As JavaObject";
Debug.JustUpdateDeviceLine();
bctextengine._sp = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");__ref.setField("_sp",bctextengine._sp);
 BA.debugLineNum = 766;BA.debugLine="sp.InitializeNewInstance(\"javafx.scene.SnapshotPa";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_sp" /*RemoteObject*/ ).runVoidMethod ("InitializeNewInstance",(Object)(BA.ObjectToString("javafx.scene.SnapshotParameters")),(Object)((bctextengine.__c.getField(false,"Null"))));
 BA.debugLineNum = 767;BA.debugLine="Dim fx As JFX";
Debug.JustUpdateDeviceLine();
_fx = RemoteObject.createNew ("anywheresoftware.b4j.objects.JFX");Debug.locals.put("fx", _fx);
 BA.debugLineNum = 768;BA.debugLine="sp.RunMethod(\"setFill\", Array(fx.Colors.Transpare";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_sp" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setFill")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(_fx.getField(false,"Colors").getField(false,"Transparent"))})));
 BA.debugLineNum = 769;BA.debugLine="Dim transform As JavaObject";
Debug.JustUpdateDeviceLine();
_transform = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");Debug.locals.put("transform", _transform);
 BA.debugLineNum = 770;BA.debugLine="transform.InitializeStatic(\"javafx.scene.transfor";
Debug.JustUpdateDeviceLine();
_transform.runVoidMethod ("InitializeStatic",(Object)(RemoteObject.createImmutable("javafx.scene.transform.Transform")));
 BA.debugLineNum = 771;BA.debugLine="Dim scale As Double = mScale";
Debug.JustUpdateDeviceLine();
_scale = BA.numberCast(double.class, __ref.getField(true,"_mscale" /*RemoteObject*/ ));Debug.locals.put("scale", _scale);Debug.locals.put("scale", _scale);
 BA.debugLineNum = 772;BA.debugLine="sp.RunMethod(\"setTransform\", Array(transform.RunM";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_sp" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setTransform")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {_transform.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("scale")),(Object)(RemoteObject.createNewArray("Object",new int[] {2},new Object[] {(_scale),(_scale)})))})));
...
try {
		Debug.PushSubsStack("ResizeImageView (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,228);
...
Debug.JustUpdateDeviceLine();
_iv.runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(double.class, _par.getField(false,"Style" /*RemoteObject*/ ).getField(false,"Padding" /*RemoteObject*/ ).runMethod(true,"getLeft"))),(Object)(BA.numberCast(double.class, _par.getField(false,"Style" /*RemoteObject*/ ).getField(false,"Padding" /*RemoteObject*/ ).runMethod(true,"getTop"))),(Object)(RemoteObject.solve(new RemoteObject[] {_par.getField(true,"Width" /*RemoteObject*/ ),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "/",0, 0)),(Object)(BA.numberCast(double.class, _ivheight)));
...
try {
		Debug.PushSubsStack("ResizeLayers (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,118);
...
try {
		Debug.PushSubsStack("setMinGapBetweenLines (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,1042);
...
try {
		Debug.PushSubsStack("setSpaceBetweenCharacters (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,1028);
...
try {
		Debug.PushSubsStack("setSpaceBetweenLines (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,1037);
...
try {
		Debug.PushSubsStack("TextCharEquals (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,1118);
...
try {
		Debug.PushSubsStack("TextCharsSubstring (bctextengine) ","bctextengine",86,__ref.getField(false, "ba"),__ref,1114);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4j.docU.bctextengine.class, "_createbctextchars" /*RemoteObject*/ ,(Object)(_tc.getField(false,"Buffer" /*RemoteObject*/ )),(Object)(RemoteObject.solve(new RemoteObject[] {_startindex,_tc.getField(true,"StartIndex" /*RemoteObject*/ )}, "+",1, 1)),(Object)(RemoteObject.solve(new RemoteObject[] {_endindex,_startindex}, "-",1, 1)));
