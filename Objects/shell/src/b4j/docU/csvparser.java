...
public class csvparser {
    ...
    public static PCBA staticBA = new PCBA(null, csvparser.class);
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"CSSUtils",_ref.getField(false, "_cssutils"),"CurrentIndex",_ref.getField(false, "_currentindex"),"DateUtils",_ref.getField(false, "_dateutils")};
}
}