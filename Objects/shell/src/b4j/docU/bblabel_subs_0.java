...
try {
		Debug.PushSubsStack("Base_Resize (bblabel) ","bblabel",85,__ref.getField(false, "ba"),__ref,51);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bblabel.class, "_parseanddraw" /*RemoteObject*/ );
 }else {
 BA.debugLineNum = 57;BA.debugLine="Redraw";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bblabel.class, "_redraw" /*RemoteObject*/ );
 };
 };
...
bblabel._style = RemoteObject.createNew ("b4j.docU.bctextengine._bcparagraphstyle");__ref.setField("_style",bblabel._style);
 //BA.debugLineNum = 8;BA.debugLine="Private mTextEngine As BCTextEngine";
bblabel._mtextengine = RemoteObject.createNew ("b4j.docU.bctextengine");__ref.setField("_mtextengine",bblabel._mtextengine);
...
bblabel._paragraph = RemoteObject.createNew ("b4j.docU.bctextengine._bcparagraph");__ref.setField("_paragraph",bblabel._paragraph);
...
bblabel._parsedata = RemoteObject.createNew ("b4j.docU.bbcodeparser._bbcodeparsedata");__ref.setField("_parsedata",bblabel._parsedata);
...
try {
		Debug.PushSubsStack("DesignerCreateView (bblabel) ","bblabel",85,__ref.getField(false, "ba"),__ref,30);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethod ("AddView",(Object)((__ref.getField(false,"_foregroundimageview" /*RemoteObject*/ ).getObject())),(Object)(BA.numberCast(double.class, 0)),(Object)(BA.numberCast(double.class, 0)),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth")),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight")));
...
__ref.setField ("_mtext" /*RemoteObject*/ ,_xlbl.runMethod(true,"getText"));
 BA.debugLineNum = 41;BA.debugLine="Dim fx As JFX";
Debug.JustUpdateDeviceLine();
_fx = RemoteObject.createNew ("anywheresoftware.b4j.objects.JFX");Debug.locals.put("fx", _fx);
 BA.debugLineNum = 42;BA.debugLine="ParseData.DefaultBoldFont = fx.CreateFont(Lbl.Fon";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_parsedata" /*RemoteObject*/ ).getField(false,"DefaultBoldFont" /*RemoteObject*/ ).setObject (_fx.runMethod(false,"CreateFont",(Object)(_lbl.runMethod(false,"getFont").runMethod(true,"getFamilyName")),(Object)(__ref.getField(false,"_parsedata" /*RemoteObject*/ ).getField(false,"DefaultFont" /*RemoteObject*/ ).runMethod(true,"getSize")),(Object)(bblabel.__c.getField(true,"True")),(Object)(bblabel.__c.getField(true,"False"))).getObject());
...
try {
		Debug.PushSubsStack("getText (bblabel) ","bblabel",85,__ref.getField(false, "ba"),__ref,81);
...
try {
		Debug.PushSubsStack("getTextEngine (bblabel) ","bblabel",85,__ref.getField(false, "ba"),__ref,72);
...
try {
		Debug.PushSubsStack("Initialize (bblabel) ","bblabel",85,__ref.getField(false, "ba"),__ref,20);
...
try {
		Debug.PushSubsStack("ParseAndDraw (bblabel) ","bblabel",85,__ref.getField(false, "ba"),__ref,85);
...
try {
		Debug.PushSubsStack("Redraw (bblabel) ","bblabel",85,__ref.getField(false, "ba"),__ref,98);
...
Debug.JustUpdateDeviceLine();
bblabel._style = __ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (b4j.docU.bctextengine.class, "_createstyle" /*RemoteObject*/ );__ref.setField("_style",bblabel._style);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_paragraph" /*RemoteObject*/ ,__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (b4j.docU.bctextengine.class, "_drawtext" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_runs" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_style" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_foregroundimageview" /*RemoteObject*/ )),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), bblabel.__c.getField(false,"Null"))));
...
Debug.JustUpdateDeviceLine();
_v.runMethod(true,"setLeft",RemoteObject.solve(new RemoteObject[] {_v.runMethod(true,"getLeft"),_dx}, "+",1, 0));
 BA.debugLineNum = 110;BA.debugLine="v.Top = v.Top + dy";
Debug.JustUpdateDeviceLine();
_v.runMethod(true,"setTop",RemoteObject.solve(new RemoteObject[] {_v.runMethod(true,"getTop"),_dy}, "+",1, 0));
 }
}Debug.locals.put("v", _v);
;
...
try {
		Debug.PushSubsStack("setText (bblabel) ","bblabel",85,__ref.getField(false, "ba"),__ref,76);
...
try {
		Debug.PushSubsStack("setTextEngine (bblabel) ","bblabel",85,__ref.getField(false, "ba"),__ref,62);
...
__ref.setField ("_mtextengine" /*RemoteObject*/ ,_b);
 BA.debugLineNum = 65;BA.debugLine="mTextEngine.TagParser.InternalSetMouseTransparent";
Debug.JustUpdateDeviceLine();
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bblabel.class, "_settext" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_mtext" /*RemoteObject*/ )));
 };
