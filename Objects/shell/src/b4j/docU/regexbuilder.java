...
public class regexbuilder {
    ...
    public static PCBA staticBA = new PCBA(null, regexbuilder.class);

public static RemoteObject __c = RemoteObject.declareNull("anywheresoftware.b4a.keywords.Common");
public static RemoteObject _pat = RemoteObject.declareNull("anywheresoftware.b4a.keywords.StringBuilderWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"CSSUtils",_ref.getField(false, "_cssutils"),"DateUtils",_ref.getField(false, "_dateutils"),"pat",_ref.getField(false, "_pat")};
}
}