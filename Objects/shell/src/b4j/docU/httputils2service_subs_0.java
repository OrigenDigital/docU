...
try {
		Debug.PushSubsStack("CompleteJob (httputils2service) ","httputils2service",98,httputils2service.ba,httputils2service.mostCurrent,152);
if (RapidSub.canDelegate("completejob")) { return b4j.docU.httputils2service.remoteMe.runUserSub(false, "httputils2service","completejob", _taskid, _success, _errormessage);}
...
Debug.JustUpdateDeviceLine();
httputils2service.__c.runVoidMethod ("LogImpl","9211156998",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service: job completed multiple times - "),_taskid),0);
...
Debug.JustUpdateDeviceLine();
_job.runClassMethod (b4j.docU.httpjob.class, "_complete" /*RemoteObject*/ ,(Object)(_taskid));
...
try {
		Debug.PushSubsStack("hc_ResponseError (httputils2service) ","httputils2service",98,httputils2service.ba,httputils2service.mostCurrent,115);
if (RapidSub.canDelegate("hc_responseerror")) { return b4j.docU.httputils2service.remoteMe.runUserSub(false, "httputils2service","hc_responseerror", _response, _reason, _statuscode, _taskid);}
RemoteObject _job = RemoteObject.declareNull("b4j.docU.httpjob");
...
Debug.JustUpdateDeviceLine();
httputils2service.__c.runVoidMethod ("LogImpl","9211091463",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service (hc_ResponseError): job completed multiple times - "),_taskid),0);
...
try {
		Debug.PushSubsStack("hc_ResponseSuccess (httputils2service) ","httputils2service",98,httputils2service.ba,httputils2service.mostCurrent,92);
if (RapidSub.canDelegate("hc_responsesuccess")) { return b4j.docU.httputils2service.remoteMe.runUserSub(false, "httputils2service","hc_responsesuccess", _response, _taskid);}
RemoteObject _job = RemoteObject.declareNull("b4j.docU.httpjob");
...
Debug.JustUpdateDeviceLine();
httputils2service.__c.runVoidMethod ("LogImpl","9210960387",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service (hc_ResponseSuccess): job completed multiple times - "),_taskid),0);
...
try {
		Debug.PushSubsStack("Response_StreamFinish (httputils2service) ","httputils2service",98,httputils2service.ba,httputils2service.mostCurrent,107);
if (RapidSub.canDelegate("response_streamfinish")) { return b4j.docU.httputils2service.remoteMe.runUserSub(false, "httputils2service","response_streamfinish", _success, _taskid);}
Debug.locals.put("Success", _success);
Debug.locals.put("TaskId", _taskid);
...
try {
		Debug.PushSubsStack("Service_Create (httputils2service) ","httputils2service",98,httputils2service.ba,httputils2service.mostCurrent,27);
if (RapidSub.canDelegate("service_create")) { return b4j.docU.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_create");}
...
try {
		Debug.PushSubsStack("SubmitJob (httputils2service) ","httputils2service",98,httputils2service.ba,httputils2service.mostCurrent,74);
if (RapidSub.canDelegate("submitjob")) { return b4j.docU.httputils2service.remoteMe.runUserSub(false, "httputils2service","submitjob", _job);}
...
Debug.JustUpdateDeviceLine();
httputils2service._hc.runVoidMethod ("ExecuteCredentials",httputils2service.ba,(Object)(_job.runClassMethod (b4j.docU.httpjob.class, "_getrequest" /*RemoteObject*/ )),(Object)(_taskid),(Object)(_job.getField(true,"_username" /*RemoteObject*/ )),(Object)(_job.getField(true,"_password" /*RemoteObject*/ )));
 }else {
 BA.debugLineNum = 86;BA.debugLine="hc.Execute(job.GetRequest, TaskId)";
Debug.JustUpdateDeviceLine();
httputils2service._hc.runVoidMethod ("Execute",httputils2service.ba,(Object)(_job.runClassMethod (b4j.docU.httpjob.class, "_getrequest" /*RemoteObject*/ )),(Object)(_taskid));
 };
