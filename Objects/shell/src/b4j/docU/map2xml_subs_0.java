...
try {
		Debug.PushSubsStack("HandleElement (map2xml) ","map2xml",113,__ref.getField(false, "ba"),__ref,44);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.map2xml.class, "_handlemapelement" /*RemoteObject*/ ,RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _value));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.map2xml.class, "_handlelistelement" /*RemoteObject*/ ,(Object)(_key),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _value));
 }else {
...
try {
		Debug.PushSubsStack("HandleListElement (map2xml) ","map2xml",113,__ref.getField(false, "ba"),__ref,58);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.map2xml.class, "_handleelement" /*RemoteObject*/ ,(Object)(_key),(Object)(_value));
 }
}Debug.locals.put("value", _value);
;
...
try {
		Debug.PushSubsStack("HandleMapElement (map2xml) ","map2xml",113,__ref.getField(false, "ba"),__ref,28);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.map2xml.class, "_handleelement" /*RemoteObject*/ ,(Object)(_k),(Object)(_value));
 }
}Debug.locals.put("k", _k);
;
...
try {
		Debug.PushSubsStack("Initialize (map2xml) ","map2xml",113,__ref.getField(false, "ba"),__ref,6);
...
try {
		Debug.PushSubsStack("MapToXml (map2xml) ","map2xml",113,__ref.getField(false, "ba"),__ref,10);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.map2xml.class, "_handleelement" /*RemoteObject*/ ,(Object)(BA.ObjectToString("")),(Object)(_m.runMethod(false,"Get",(Object)((_k)))));
