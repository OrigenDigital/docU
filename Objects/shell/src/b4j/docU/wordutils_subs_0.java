...
wordutils._xl = RemoteObject.createNew ("b4j.docU.xlutils");__ref.setField("_xl",wordutils._xl);
 //BA.debugLineNum = 3;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _createdocument(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("CreateDocument (wordutils) ","wordutils",104,__ref.getField(false, "ba"),__ref,10);
...
RemoteObject _wd = RemoteObject.declareNull("b4j.docU.worddocument");
...
Debug.JustUpdateDeviceLine();
_wd = RemoteObject.createNew ("b4j.docU.worddocument");Debug.locals.put("wd", _wd);
 BA.debugLineNum = 14;BA.debugLine="wd.Initialize(Me, doc)";
Debug.JustUpdateDeviceLine();
_wd.runClassMethod (b4j.docU.worddocument.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)((__ref)),(Object)(_doc));
...
try {
		Debug.PushSubsStack("Initialize (wordutils) ","wordutils",104,__ref.getField(false, "ba"),__ref,5);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xl" /*RemoteObject*/ ).runClassMethod (b4j.docU.xlutils.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
...
try {
		Debug.PushSubsStack("OpenWord (wordutils) ","wordutils",104,__ref.getField(false, "ba"),__ref,21);
...
public ResumableSub_OpenWord(b4j.docU.wordutils parent,RemoteObject __ref,RemoteObject _filepath) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("WaitFor","complete", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "wordutils", "openword"), __ref.getField(false,"_xl" /*RemoteObject*/ ).runClassMethod (b4j.docU.xlutils.class, "_openexcel" /*RemoteObject*/ ,(Object)(_filepath)));
this.state = 1;
return;
case 1:
//C
...
try {
		Debug.PushSubsStack("PowerShellConvertToPdf (wordutils) ","wordutils",104,__ref.getField(false, "ba"),__ref,28);
...
public ResumableSub_PowerShellConvertToPdf(b4j.docU.wordutils parent,RemoteObject __ref,RemoteObject _inputfile,RemoteObject _outputfile,RemoteObject _openpdf) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","9218234883",RemoteObject.createImmutable("Cannot delete output file"),0);
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("WaitFor","complete", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "wordutils", "powershellconverttopdf"), __ref.getField(false,"_xl" /*RemoteObject*/ ).runClassMethod (b4j.docU.xlutils.class, "_powershellscript" /*RemoteObject*/ ,(Object)(_s)));
this.state = 15;
return;
case 15:
//C
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("WaitFor","complete", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "wordutils", "powershellconverttopdf"), __ref.getField(false,"_xl" /*RemoteObject*/ ).runClassMethod (b4j.docU.xlutils.class, "_powershellscript" /*RemoteObject*/ ,(Object)((RemoteObject.concat(RemoteObject.createImmutable("& {Invoke-Item '"),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_outputfile))),RemoteObject.createImmutable("'}"))))));
this.state = 16;
return;
case 16:
//C
