...
try {
		Debug.PushSubsStack("CellToObject (xlreader) ","xlreader",106,__ref.getField(false, "ba"),__ref,168);
...
RemoteObject _h = RemoteObject.declareNull("b4j.docU.xlreaderresult._xlhyperlink");
...
Debug.JustUpdateDeviceLine();
_h = RemoteObject.createNew ("b4j.docU.xlreaderresult._xlhyperlink");Debug.locals.put("h", _h);
...
Debug.JustUpdateDeviceLine();
_h.setField ("Address" /*RemoteObject*/ ,__ref.runClassMethod (b4j.docU.xlreader.class, "_objecttostring" /*RemoteObject*/ ,(Object)(_hyperlink.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getAddress")),(Object)((xlreader.__c.getField(false,"Null")))))));
 BA.debugLineNum = 177;BA.debugLine="h.Label = ObjectToString(hyperlink.RunMethod(\"g";
Debug.JustUpdateDeviceLine();
_h.setField ("Label" /*RemoteObject*/ ,__ref.runClassMethod (b4j.docU.xlreader.class, "_objecttostring" /*RemoteObject*/ ,(Object)(_hyperlink.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getLabel")),(Object)((xlreader.__c.getField(false,"Null")))))));
...
xlreader._xl = RemoteObject.createNew ("b4j.docU.xlutils");__ref.setField("_xl",xlreader._xl);
...
try {
		Debug.PushSubsStack("CloseWBAfterSleep (xlreader) ","xlreader",106,__ref.getField(false, "ba"),__ref,33);
...
public ResumableSub_CloseWBAfterSleep(b4j.docU.xlreader parent,RemoteObject __ref,RemoteObject _wb) {
this.parent = parent;
this.__ref = __ref;
this._wb = _wb;
}
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","9218824709",BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 if (true) break;
if (true) break;
...
try {
		Debug.PushSubsStack("CreateXLReaderResult (xlreader) ","xlreader",106,__ref.getField(false, "ba"),__ref,191);
...
RemoteObject _t1 = RemoteObject.declareNull("b4j.docU.xlreaderresult");
...
Debug.JustUpdateDeviceLine();
_t1 = RemoteObject.createNew ("b4j.docU.xlreaderresult");Debug.locals.put("t1", _t1);
 BA.debugLineNum = 193;BA.debugLine="t1.Initialize(xl)";
Debug.JustUpdateDeviceLine();
_t1.runClassMethod (b4j.docU.xlreaderresult.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref.getField(false,"_xl" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("Initialize (xlreader) ","xlreader",106,__ref.getField(false, "ba"),__ref,11);
...
try {
		Debug.PushSubsStack("ObjectToString (xlreader) ","xlreader",106,__ref.getField(false, "ba"),__ref,186);
...
try {
		Debug.PushSubsStack("OpenWorkbook (xlreader) ","xlreader",106,__ref.getField(false, "ba"),__ref,21);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.xlreader.class, "_closewbaftersleep" /*void*/ ,(Object)(_wb));
...
try {
		Debug.PushSubsStack("RangeToResult (xlreader) ","xlreader",106,__ref.getField(false, "ba"),__ref,88);
...
RemoteObject _res = RemoteObject.declareNull("b4j.docU.xlreaderresult");
int _r = 0;
...
Debug.JustUpdateDeviceLine();
_res = __ref.runClassMethod (b4j.docU.xlreader.class, "_createxlreaderresult" /*RemoteObject*/ ,(Object)(_rows),(Object)(__ref.getField(false,"_xl" /*RemoteObject*/ ).runClassMethod (b4j.docU.xlutils.class, "_addresszero" /*RemoteObject*/ ,(Object)(_left),(Object)(_top))),(Object)(_range.getField(true,"Name" /*RemoteObject*/ )));Debug.locals.put("res", _res);Debug.locals.put("res", _res);
...
Debug.JustUpdateDeviceLine();
_row.setArrayElement (__ref.runClassMethod (b4j.docU.xlreader.class, "_celltoobject" /*RemoteObject*/ ,(Object)(_cell),(Object)(_res)),RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_c),_left}, "-",1, 1));
 }
}Debug.locals.put("c", _c);
;
 };
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4j.docU.xlreader.class, "_removeemptyrowsfromendandsetbottomright" /*RemoteObject*/ ,(Object)(_res));
...
try {
		Debug.PushSubsStack("ReadAll (xlreader) ","xlreader",106,__ref.getField(false, "ba"),__ref,17);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4j.docU.xlreader.class, "_readworkbook" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (b4j.docU.xlreader.class, "_openworkbook" /*RemoteObject*/ ,(Object)(_dir),(Object)(_filename))));
...
try {
		Debug.PushSubsStack("ReadRange (xlreader) ","xlreader",106,__ref.getField(false, "ba"),__ref,70);
...
_om = __ref.runClassMethod (b4j.docU.xlreader.class, "_readranges" /*RemoteObject*/ ,(Object)(_dir),(Object)(_filename),(Object)(xlreader.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(_range)})))));Debug.locals.put("om", _om);Debug.locals.put("om", _om);
...
try {
		Debug.PushSubsStack("ReadRanges (xlreader) ","xlreader",106,__ref.getField(false, "ba"),__ref,76);
...
_wb = __ref.runClassMethod (b4j.docU.xlreader.class, "_openworkbook" /*RemoteObject*/ ,(Object)(_dir),(Object)(_filename));Debug.locals.put("wb", _wb);Debug.locals.put("wb", _wb);
...
Debug.JustUpdateDeviceLine();
_result.runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4j.docU.xlreader.class, "_rangetoresult" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xl" /*RemoteObject*/ ).runClassMethod (b4j.docU.xlutils.class, "_rangestringornametorange" /*RemoteObject*/ ,(Object)(_wb),(Object)(_range)))))));
 }
}Debug.locals.put("Range", _range);
;
...
try {
		Debug.PushSubsStack("ReadSheetByIndex (xlreader) ","xlreader",106,__ref.getField(false, "ba"),__ref,54);
...
Debug.JustUpdateDeviceLine();
_res = __ref.runClassMethod (b4j.docU.xlreader.class, "_sheettoresult" /*RemoteObject*/ ,(Object)(_wb.runMethod(false,"GetSheet",(Object)(_sheetindex))));Debug.locals.put("res", _res);Debug.locals.put("res", _res);
...
try {
		Debug.PushSubsStack("ReadSheetByName (xlreader) ","xlreader",106,__ref.getField(false, "ba"),__ref,62);
...
Debug.JustUpdateDeviceLine();
_res = __ref.runClassMethod (b4j.docU.xlreader.class, "_sheettoresult" /*RemoteObject*/ ,(Object)(_wb.runMethod(false,"GetSheetByName",(Object)(_sheetname))));Debug.locals.put("res", _res);Debug.locals.put("res", _res);
...
try {
		Debug.PushSubsStack("ReadWorkbook (xlreader) ","xlreader",106,__ref.getField(false, "ba"),__ref,42);
...
Debug.JustUpdateDeviceLine();
_res.runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4j.docU.xlreader.class, "_sheettoresult" /*RemoteObject*/ ,(Object)(_sheet)))));
 }
}Debug.locals.put("i", _i);
;
...
try {
		Debug.PushSubsStack("RemoveEmptyRowsFromEndAndSetBottomRight (xlreader) ","xlreader",106,__ref.getField(false, "ba"),__ref,152);
...
try {
		Debug.PushSubsStack("SheetToResult (xlreader) ","xlreader",106,__ref.getField(false, "ba"),__ref,117);
...
Debug.JustUpdateDeviceLine();
_res = __ref.runClassMethod (b4j.docU.xlreader.class, "_createxlreaderresult" /*RemoteObject*/ ,(Object)(_rows),(Object)(__ref.getField(false,"_xl" /*RemoteObject*/ ).runClassMethod (b4j.docU.xlutils.class, "_addresszero" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)))),(Object)(_sheet.runMethod(true,"getName")));Debug.locals.put("res", _res);Debug.locals.put("res", _res);
...
Debug.JustUpdateDeviceLine();
_row.setArrayElement (__ref.runClassMethod (b4j.docU.xlreader.class, "_celltoobject" /*RemoteObject*/ ,(Object)(_currentcell),(Object)(_res)),BA.numberCast(int.class, _c));
