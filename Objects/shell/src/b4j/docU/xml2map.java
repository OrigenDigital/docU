...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"CSSUtils",_ref.getField(false, "_cssutils"),"DateUtils",_ref.getField(false, "_dateutils"),"elements",_ref.getField(false, "_elements"),"mStripNamespaces",_ref.getField(false, "_mstripnamespaces"),"parser",_ref.getField(false, "_parser")};
}
}