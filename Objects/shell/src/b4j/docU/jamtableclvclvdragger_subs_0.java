...
public class jamtableclvclvdragger_subs_0 {


public static RemoteObject  _adddragbuttons(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("AddDragButtons (jamtableclvclvdragger) ","jamtableclvclvdragger",93,__ref.getField(false, "ba"),__ref,44);
if (RapidSub.canDelegate("adddragbuttons")) { return __ref.runUserSub(false, "jamtableclvclvdragger","adddragbuttons", __ref);}
...
RemoteObject _xlbl = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
 BA.debugLineNum = 44;BA.debugLine="Public Sub AddDragButtons";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 45;BA.debugLine="list.PressedColor = xui.Color_Transparent";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_list" /*RemoteObject*/ ).setField ("_pressedcolor",__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Transparent"));
 BA.debugLineNum = 46;BA.debugLine="Dim fnt As B4XFont = xui.CreateMaterialIcons(30)";
Debug.JustUpdateDeviceLine();
...
_fnt = __ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreateMaterialIcons",(Object)(BA.numberCast(float.class, 30)));Debug.locals.put("fnt", _fnt);Debug.locals.put("fnt", _fnt);
 BA.debugLineNum = 47;BA.debugLine="For i = 0 To list.Size - 1";
Debug.JustUpdateDeviceLine();
{
final int step3 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 48;BA.debugLine="Dim p As B4XView = list.GetPanel(i)";
Debug.JustUpdateDeviceLine();
...
_p = __ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(false,"_getpanel",(Object)(BA.numberCast(int.class, _i)));Debug.locals.put("p", _p);Debug.locals.put("p", _p);
 BA.debugLineNum = 49;BA.debugLine="If IsLastViewADragLabel(p) = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.runClassMethod (b4j.docU.jamtableclvclvdragger.class, "_islastviewadraglabel" /*RemoteObject*/ ,(Object)(_p)),jamtableclvclvdragger.__c.getField(true,"False"))) { 
 BA.debugLineNum = 50;BA.debugLine="Dim lbl As Label";
Debug.JustUpdateDeviceLine();
_lbl = RemoteObject.createNew ("anywheresoftware.b4j.objects.LabelWrapper");Debug.locals.put("lbl", _lbl);
 BA.debugLineNum = 51;BA.debugLine="lbl.Initialize(\"drag\")";
Debug.JustUpdateDeviceLine();
_lbl.runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("drag")));
 BA.debugLineNum = 52;BA.debugLine="lbl.MouseCursor = fx.Cursors.HAND";
Debug.JustUpdateDeviceLine();
_lbl.runMethod(false,"setMouseCursor",__ref.getField(false,"_fx" /*RemoteObject*/ ).getField(false,"Cursors").getField(false,"HAND"));
 BA.debugLineNum = 53;BA.debugLine="Dim xlbl As B4XView = lbl";
Debug.JustUpdateDeviceLine();
...
_xlbl = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), _lbl.getObject());Debug.locals.put("xlbl", _xlbl);Debug.locals.put("xlbl", _xlbl);
 BA.debugLineNum = 54;BA.debugLine="xlbl.Font = fnt";
Debug.JustUpdateDeviceLine();
_xlbl.runMethod(false,"setFont",_fnt);
 BA.debugLineNum = 55;BA.debugLine="xlbl.Text = Chr(0xE25D)";
Debug.JustUpdateDeviceLine();
_xlbl.runMethod(true,"setText",BA.ObjectToString(jamtableclvclvdragger.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, ((int)0xe25d))))));
 BA.debugLineNum = 58;BA.debugLine="xlbl.TextColor = 0xFFFFA500";
Debug.JustUpdateDeviceLine();
_xlbl.runMethod(true,"setTextColor",BA.numberCast(int.class, ((int)0xffffa500)));
 BA.debugLineNum = 59;BA.debugLine="xlbl.Tag = list";
Debug.JustUpdateDeviceLine();
_xlbl.runMethod(false,"setTag",(__ref.getField(false,"_list" /*RemoteObject*/ )));
 BA.debugLineNum = 61;BA.debugLine="p.AddView(xlbl, 2dip, p.Height / 2 - 15dip, 30d";
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("AddView",(Object)((_xlbl.getObject())),(Object)(BA.numberCast(double.class, jamtableclvclvdragger.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2))))),(Object)(RemoteObject.solve(new RemoteObject[] {_p.runMethod(true,"getHeight"),RemoteObject.createImmutable(2),jamtableclvclvdragger.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 15)))}, "/-",1, 0)),(Object)(BA.numberCast(double.class, jamtableclvclvdragger.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 30))))),(Object)(BA.numberCast(double.class, jamtableclvclvdragger.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 30))))));
 };
 }
}Debug.locals.put("i", _i);
;
...
jamtableclvclvdragger._mcallback = RemoteObject.createNew ("Object");__ref.setField("_mcallback",jamtableclvclvdragger._mcallback);
 //BA.debugLineNum = 4;BA.debugLine="Private xui As XUI";
jamtableclvclvdragger._xui = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper.XUI");__ref.setField("_xui",jamtableclvclvdragger._xui);
 //BA.debugLineNum = 5;BA.debugLine="Private fx As JFX";
jamtableclvclvdragger._fx = RemoteObject.createNew ("anywheresoftware.b4j.objects.JFX");__ref.setField("_fx",jamtableclvclvdragger._fx);
 //BA.debugLineNum = 6;BA.debugLine="Private list As CustomListView";
jamtableclvclvdragger._list = RemoteObject.createNew ("b4j.example.customlistview");__ref.setField("_list",jamtableclvclvdragger._list);
 //BA.debugLineNum = 7;BA.debugLine="Private PressedColor As Int";
jamtableclvclvdragger._pressedcolor = RemoteObject.createImmutable(0);__ref.setField("_pressedcolor",jamtableclvclvdragger._pressedcolor);
 //BA.debugLineNum = 8;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static void  _drag_mousepressed(RemoteObject __ref,RemoteObject _eventdata) throws Exception{
try {
		Debug.PushSubsStack("Drag_MousePressed (jamtableclvclvdragger) ","jamtableclvclvdragger",93,__ref.getField(false, "ba"),__ref,66);
if (RapidSub.canDelegate("drag_mousepressed")) { __ref.runUserSub(false, "jamtableclvclvdragger","drag_mousepressed", __ref, _eventdata); return;}
...
public ResumableSub_Drag_MousePressed(b4j.docU.jamtableclvclvdragger parent,RemoteObject __ref,RemoteObject _eventdata) {
this.parent = parent;
this.__ref = __ref;
...
Debug.locals.put("EventData", _eventdata);
 BA.debugLineNum = 67;BA.debugLine="Dim lbl As B4XView = Sender";
Debug.JustUpdateDeviceLine();
...
_lbl = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), parent.__c.runMethod(false,"Sender",__ref.getField(false, "ba")));Debug.locals.put("lbl", _lbl);Debug.locals.put("lbl", _lbl);
 BA.debugLineNum = 68;BA.debugLine="Dim list As CustomListView = lbl.Tag";
Debug.JustUpdateDeviceLine();
parent._list = (_lbl.runMethod(false,"getTag"));__ref.setField("_list",parent._list);
 BA.debugLineNum = 69;BA.debugLine="Dim pnl As B4XView = list.GetPanel(list.GetItemFr";
Debug.JustUpdateDeviceLine();
...
_pnl = __ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(false,"_getpanel",(Object)(__ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(true,"_getitemfromview",(Object)(_lbl)))).runMethod(false,"getParent");Debug.locals.put("pnl", _pnl);Debug.locals.put("pnl", _pnl);
 BA.debugLineNum = 70;BA.debugLine="pnl.GetView(0).SetColorAndBorder(xui.Color_Transp";
Debug.JustUpdateDeviceLine();
_pnl.runMethod(false,"GetView",(Object)(BA.numberCast(int.class, 0))).runVoidMethod ("SetColorAndBorder",(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Transparent")),(Object)(BA.numberCast(double.class, parent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 3))))),(Object)(BA.numberCast(int.class, ((int)0xff503acd))),(Object)(BA.numberCast(double.class, 0)));
 BA.debugLineNum = 71;BA.debugLine="Dim ListStartY As Int = EventData.Y + lbl.Top + p";
Debug.JustUpdateDeviceLine();
_liststarty = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_eventdata.runMethod(true,"getY"),_lbl.runMethod(true,"getTop"),_pnl.runMethod(true,"getTop")}, "++",2, 0));Debug.locals.put("ListStartY", _liststarty);Debug.locals.put("ListStartY", _liststarty);
 BA.debugLineNum = 72;BA.debugLine="pnl.BringToFront";
Debug.JustUpdateDeviceLine();
_pnl.runVoidMethod ("BringToFront");
 BA.debugLineNum = 73;BA.debugLine="Dim Top As Int = pnl.Top";
Debug.JustUpdateDeviceLine();
_top = BA.numberCast(int.class, _pnl.runMethod(true,"getTop"));Debug.locals.put("Top", _top);Debug.locals.put("Top", _top);
 BA.debugLineNum = 74;BA.debugLine="Do While True";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 75;BA.debugLine="Wait For (lbl) Drag_MouseDragged (EventData As M";
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("WaitFor","drag_mousedragged", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "jamtableclvclvdragger", "drag_mousepressed"), (_lbl.getObject()));
this.state = 11;
return;
case 11:
//C
...
;
 BA.debugLineNum = 76;BA.debugLine="If pnl.Top < list.sv.ScrollViewOffsetY Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
{ BA.debugLineNum = 78;BA.debugLine="Else If list.sv.ScrollViewOffsetY + list.sv.Heig";
Debug.JustUpdateDeviceLine();
...
//C
this.state = 9;
 BA.debugLineNum = 77;BA.debugLine="list.sv.ScrollViewOffsetY = Max(0, list.sv.Scro";
Debug.JustUpdateDeviceLine();
...
//C
this.state = 9;
 BA.debugLineNum = 79;BA.debugLine="list.sv.ScrollViewOffsetY = list.sv.ScrollViewO";
Debug.JustUpdateDeviceLine();
...
this.state = 1;
;
 BA.debugLineNum = 81;BA.debugLine="Dim ListY As Int = EventData.Y + lbl.Top + pnl.T";
Debug.JustUpdateDeviceLine();
_listy = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_eventdata.runMethod(true,"getY"),_lbl.runMethod(true,"getTop"),_pnl.runMethod(true,"getTop")}, "++",2, 0));Debug.locals.put("ListY", _listy);Debug.locals.put("ListY", _listy);
 BA.debugLineNum = 82;BA.debugLine="Dim delta As Int = ListY - ListStartY";
Debug.JustUpdateDeviceLine();
_delta = RemoteObject.solve(new RemoteObject[] {_listy,_liststarty}, "-",1, 1);Debug.locals.put("delta", _delta);Debug.locals.put("delta", _delta);
 BA.debugLineNum = 83;BA.debugLine="pnl.Top = Top + delta";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("Drag_MouseReleased (jamtableclvclvdragger) ","jamtableclvclvdragger",93,__ref.getField(false, "ba"),__ref,87);
if (RapidSub.canDelegate("drag_mousereleased")) { return __ref.runUserSub(false, "jamtableclvclvdragger","drag_mousereleased", __ref, _eventdata);}
RemoteObject _lbl = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
...
Debug.locals.put("EventData", _eventdata);
 BA.debugLineNum = 87;BA.debugLine="Private Sub Drag_MouseReleased (EventData As Mouse";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 88;BA.debugLine="Dim lbl As B4XView = Sender";
Debug.JustUpdateDeviceLine();
_lbl = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_lbl = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), jamtableclvclvdragger.__c.runMethod(false,"Sender",__ref.getField(false, "ba")));Debug.locals.put("lbl", _lbl);Debug.locals.put("lbl", _lbl);
 BA.debugLineNum = 89;BA.debugLine="Dim list As CustomListView = lbl.Tag";
Debug.JustUpdateDeviceLine();
jamtableclvclvdragger._list = (_lbl.runMethod(false,"getTag"));__ref.setField("_list",jamtableclvclvdragger._list);
 BA.debugLineNum = 90;BA.debugLine="Dim index As Int = list.GetItemFromView(lbl)";
Debug.JustUpdateDeviceLine();
_index = __ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(true,"_getitemfromview",(Object)(_lbl));Debug.locals.put("index", _index);Debug.locals.put("index", _index);
 BA.debugLineNum = 91;BA.debugLine="Dim pnl As B4XView = list.GetPanel(index).Parent";
Debug.JustUpdateDeviceLine();
_pnl = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_pnl = __ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(false,"_getpanel",(Object)(_index)).runMethod(false,"getParent");Debug.locals.put("pnl", _pnl);Debug.locals.put("pnl", _pnl);
 BA.debugLineNum = 92;BA.debugLine="Dim Offset As Int = pnl.Top + pnl.Height / 2";
Debug.JustUpdateDeviceLine();
_offset = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_pnl.runMethod(true,"getTop"),_pnl.runMethod(true,"getHeight"),RemoteObject.createImmutable(2)}, "+/",1, 0));Debug.locals.put("Offset", _offset);Debug.locals.put("Offset", _offset);
 BA.debugLineNum = 93;BA.debugLine="Dim NewIndex As Int = list.FindIndexFromOffset(Of";
Debug.JustUpdateDeviceLine();
_newindex = __ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(true,"_findindexfromoffset",(Object)(_offset));Debug.locals.put("NewIndex", _newindex);Debug.locals.put("NewIndex", _newindex);
 BA.debugLineNum = 94;BA.debugLine="Dim UnderlyingItem As CLVItem = list.GetRawListIt";
Debug.JustUpdateDeviceLine();
_underlyingitem = __ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(false,"_getrawlistitem",(Object)(_newindex));Debug.locals.put("UnderlyingItem", _underlyingitem);Debug.locals.put("UnderlyingItem", _underlyingitem);
 BA.debugLineNum = 95;BA.debugLine="If Offset - UnderlyingItem.Offset > UnderlyingIte";
Debug.JustUpdateDeviceLine();
...
_newindex = RemoteObject.solve(new RemoteObject[] {_newindex,RemoteObject.createImmutable(1)}, "+",1, 1);Debug.locals.put("NewIndex", _newindex);};
 BA.debugLineNum = 96;BA.debugLine="Dim ActualItem As B4XView = pnl.GetView(0)";
Debug.JustUpdateDeviceLine();
...
_actualitem = _pnl.runMethod(false,"GetView",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("ActualItem", _actualitem);Debug.locals.put("ActualItem", _actualitem);
 BA.debugLineNum = 97;BA.debugLine="ActualItem.SetColorAndBorder(pnl.Color, 0dip, xui";
Debug.JustUpdateDeviceLine();
_actualitem.runVoidMethod ("SetColorAndBorder",(Object)(_pnl.runMethod(true,"getColor")),(Object)(BA.numberCast(double.class, jamtableclvclvdragger.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 0))))),(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Black")),(Object)(BA.numberCast(double.class, 0)));
 BA.debugLineNum = 98;BA.debugLine="Dim RawItem As CLVItem = list.GetRawListItem(inde";
Debug.JustUpdateDeviceLine();
_rawitem = __ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(false,"_getrawlistitem",(Object)(_index));Debug.locals.put("RawItem", _rawitem);Debug.locals.put("RawItem", _rawitem);
 BA.debugLineNum = 99;BA.debugLine="list.RemoveAt(index)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_list" /*RemoteObject*/ ).runVoidMethod ("_removeat",(Object)(_index));
 BA.debugLineNum = 100;BA.debugLine="If NewIndex > index Then NewIndex = NewIndex - 1";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_newindex,BA.numberCast(double.class, _index))) { 
_newindex = RemoteObject.solve(new RemoteObject[] {_newindex,RemoteObject.createImmutable(1)}, "-",1, 1);Debug.locals.put("NewIndex", _newindex);};
 BA.debugLineNum = 101;BA.debugLine="NewIndex = Max(0, Min(list.Size, NewIndex))";
Debug.JustUpdateDeviceLine();
_newindex = BA.numberCast(int.class, jamtableclvclvdragger.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 0)),(Object)(jamtableclvclvdragger.__c.runMethod(true,"Min",(Object)(BA.numberCast(double.class, __ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(true,"_getsize"))),(Object)(BA.numberCast(double.class, _newindex))))));Debug.locals.put("NewIndex", _newindex);
 BA.debugLineNum = 102;BA.debugLine="list.InsertAt(NewIndex, ActualItem, RawItem.Value";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_list" /*RemoteObject*/ ).runVoidMethod ("_insertat",(Object)(_newindex),(Object)(_actualitem),(Object)(_rawitem.getField(false,"Value")));
 BA.debugLineNum = 103;BA.debugLine="list.GetRawListItem(NewIndex).TextItem = RawItem.";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(false,"_getrawlistitem",(Object)(_newindex)).setField ("TextItem",_rawitem.getField(true,"TextItem"));
 BA.debugLineNum = 105;BA.debugLine="Log(\"Drag_MouseReleased\")";
Debug.JustUpdateDeviceLine();
jamtableclvclvdragger.__c.runVoidMethod ("LogImpl","9181796882",RemoteObject.createImmutable("Drag_MouseReleased"),0);
 BA.debugLineNum = 106;BA.debugLine="CallSubDelayed(mCallback,\"RecalcularIDOrdenColumn";
Debug.JustUpdateDeviceLine();
jamtableclvclvdragger.__c.runVoidMethod ("CallSubDelayed",__ref.getField(false, "ba"),(Object)(__ref.getField(false,"_mcallback" /*RemoteObject*/ )),(Object)(RemoteObject.createImmutable("RecalcularIDOrdenColumnas")));
...
public static RemoteObject  _initialize(RemoteObject __ref,RemoteObject _ba,RemoteObject _callback,RemoteObject _clv) throws Exception{
try {
		Debug.PushSubsStack("Initialize (jamtableclvclvdragger) ","jamtableclvclvdragger",93,__ref.getField(false, "ba"),__ref,10);
if (RapidSub.canDelegate("initialize")) { return __ref.runUserSub(false, "jamtableclvclvdragger","initialize", __ref, _ba, _callback, _clv);}
__ref.runVoidMethodAndSync("innerInitializeHelper", _ba);
Debug.locals.put("ba", _ba);
Debug.locals.put("Callback", _callback);
Debug.locals.put("clv", _clv);
 BA.debugLineNum = 10;BA.debugLine="Public Sub Initialize (Callback As Object, clv As";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 11;BA.debugLine="mCallback=Callback";
Debug.JustUpdateDeviceLine();
__ref.setField ("_mcallback" /*RemoteObject*/ ,_callback);
 BA.debugLineNum = 12;BA.debugLine="list = clv";
Debug.JustUpdateDeviceLine();
__ref.setField ("_list" /*RemoteObject*/ ,_clv);
 BA.debugLineNum = 13;BA.debugLine="PressedColor = list.PressedColor";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("IsLastViewADragLabel (jamtableclvclvdragger) ","jamtableclvclvdragger",93,__ref.getField(false, "ba"),__ref,36);
if (RapidSub.canDelegate("islastviewadraglabel")) { return __ref.runUserSub(false, "jamtableclvclvdragger","islastviewadraglabel", __ref, _p);}
RemoteObject _v = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
Debug.locals.put("p", _p);
 BA.debugLineNum = 36;BA.debugLine="Private Sub IsLastViewADragLabel (p As B4XView) As";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 37;BA.debugLine="If p.NumberOfViews > 0 Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_p.runMethod(true,"getNumberOfViews"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 38;BA.debugLine="Dim v As B4XView = p.GetView(p.NumberOfViews - 1";
Debug.JustUpdateDeviceLine();
...
_v = _p.runMethod(false,"GetView",(Object)(RemoteObject.solve(new RemoteObject[] {_p.runMethod(true,"getNumberOfViews"),RemoteObject.createImmutable(1)}, "-",1, 1)));Debug.locals.put("v", _v);Debug.locals.put("v", _v);
 BA.debugLineNum = 39;BA.debugLine="Return v Is Label And v.Tag = list";
Debug.JustUpdateDeviceLine();
...
Debug.JustUpdateDeviceLine();
if (true) return jamtableclvclvdragger.__c.getField(true,"False");
...
try {
		Debug.PushSubsStack("RemoveDragButtons (jamtableclvclvdragger) ","jamtableclvclvdragger",93,__ref.getField(false, "ba"),__ref,26);
if (RapidSub.canDelegate("removedragbuttons")) { return __ref.runUserSub(false, "jamtableclvclvdragger","removedragbuttons", __ref);}
int _i = 0;
RemoteObject _p = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
 BA.debugLineNum = 26;BA.debugLine="Public Sub RemoveDragButtons";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 27;BA.debugLine="For i = 0 To list.Size - 1";
Debug.JustUpdateDeviceLine();
{
final int step1 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 28;BA.debugLine="Dim p As B4XView = list.GetPanel(i)";
Debug.JustUpdateDeviceLine();
_p = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_p = __ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(false,"_getpanel",(Object)(BA.numberCast(int.class, _i)));Debug.locals.put("p", _p);Debug.locals.put("p", _p);
 BA.debugLineNum = 29;BA.debugLine="If IsLastViewADragLabel(p) Then";
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (b4j.docU.jamtableclvclvdragger.class, "_islastviewadraglabel" /*RemoteObject*/ ,(Object)(_p)).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 30;BA.debugLine="p.GetView(p.NumberOfViews - 1).RemoveViewFromPa";
Debug.JustUpdateDeviceLine();
...
;
 BA.debugLineNum = 33;BA.debugLine="list.PressedColor = PressedColor";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("Resize (jamtableclvclvdragger) ","jamtableclvclvdragger",93,__ref.getField(false, "ba"),__ref,16);
if (RapidSub.canDelegate("resize")) { return __ref.runUserSub(false, "jamtableclvclvdragger","resize", __ref);}
int _i = 0;
RemoteObject _p = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
RemoteObject _v = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
 BA.debugLineNum = 16;BA.debugLine="Public Sub Resize";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 17;BA.debugLine="For i = 0 To list.Size - 1";
Debug.JustUpdateDeviceLine();
{
final int step1 = 1;
final int limit1 = RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(true,"_getsize"),RemoteObject.createImmutable(1)}, "-",1, 1).<Integer>get().intValue();
...
for (;(step1 > 0 && _i <= limit1) || (step1 < 0 && _i >= limit1) ;_i = ((int)(0 + _i + step1))  ) {
Debug.locals.put("i", _i);
 BA.debugLineNum = 18;BA.debugLine="Dim p As B4XView = list.GetPanel(i)";
Debug.JustUpdateDeviceLine();
_p = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_p = __ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(false,"_getpanel",(Object)(BA.numberCast(int.class, _i)));Debug.locals.put("p", _p);Debug.locals.put("p", _p);
 BA.debugLineNum = 19;BA.debugLine="Dim v As B4XView = p.GetView(p.NumberOfViews - 1";
Debug.JustUpdateDeviceLine();
_v = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_v = _p.runMethod(false,"GetView",(Object)(RemoteObject.solve(new RemoteObject[] {_p.runMethod(true,"getNumberOfViews"),RemoteObject.createImmutable(1)}, "-",1, 1)));Debug.locals.put("v", _v);Debug.locals.put("v", _v);
 BA.debugLineNum = 20;BA.debugLine="If v Is Label And v.Tag = list Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("i",_v.getObjectOrNull(), RemoteObject.createImmutable("javafx.scene.control.Label")) && RemoteObject.solveBoolean("=",_v.runMethod(false,"getTag"),(__ref.getField(false,"_list" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 21;BA.debugLine="v.Left = p.Width - 32dip";
Debug.JustUpdateDeviceLine();
_v.runMethod(true,"setLeft",RemoteObject.solve(new RemoteObject[] {_p.runMethod(true,"getWidth"),jamtableclvclvdragger.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 32)))}, "-",1, 0));
 };
 }
}Debug.locals.put("i", _i);
;
