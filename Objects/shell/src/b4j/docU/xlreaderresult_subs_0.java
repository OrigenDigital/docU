...
xlreaderresult._topleft = RemoteObject.createNew ("b4j.docU.xlutils._xladdress");__ref.setField("_topleft",xlreaderresult._topleft);
 //BA.debugLineNum = 4;BA.debugLine="Public BottomRight As XLAddress";
xlreaderresult._bottomright = RemoteObject.createNew ("b4j.docU.xlutils._xladdress");__ref.setField("_bottomright",xlreaderresult._bottomright);
...
xlreaderresult._xl = RemoteObject.createNew ("b4j.docU.xlutils");__ref.setField("_xl",xlreaderresult._xl);
...
try {
		Debug.PushSubsStack("Get (xlreaderresult) ","xlreaderresult",107,__ref.getField(false, "ba"),__ref,62);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4j.docU.xlreaderresult.class, "_getdefault" /*RemoteObject*/ ,(Object)(_address),(Object)(__ref.getField(false,"_defaultemptycellvalue" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("GetDefault (xlreaderresult) ","xlreaderresult",107,__ref.getField(false, "ba"),__ref,78);
...
try {
		Debug.PushSubsStack("GetHyperlink (xlreaderresult) ","xlreaderresult",107,__ref.getField(false, "ba"),__ref,67);
...
RemoteObject _empty = RemoteObject.declareNull("b4j.docU.xlreaderresult._xlhyperlink");
Debug.locals.put("Address", _address);
...
Debug.JustUpdateDeviceLine();
_a = __ref.getField(false,"_xl" /*RemoteObject*/ ).runClassMethod (b4j.docU.xlutils.class, "_addresstostring" /*RemoteObject*/ ,(Object)(_address));Debug.locals.put("a", _a);Debug.locals.put("a", _a);
...
Debug.JustUpdateDeviceLine();
_empty = RemoteObject.createNew ("b4j.docU.xlreaderresult._xlhyperlink");Debug.locals.put("Empty", _empty);
...
try {
		Debug.PushSubsStack("Initialize (xlreaderresult) ","xlreaderresult",107,__ref.getField(false, "ba"),__ref,13);
...
try {
		Debug.PushSubsStack("LogResult (xlreaderresult) ","xlreaderresult",107,__ref.getField(false, "ba"),__ref,20);
...
Debug.JustUpdateDeviceLine();
xlreaderresult.__c.runVoidMethod ("LogImpl","9219742209",(RemoteObject.concat(RemoteObject.createImmutable("*** "),xlreaderresult.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(true,"_name" /*RemoteObject*/ )))),RemoteObject.createImmutable(" ***"))),0);
 BA.debugLineNum = 22;BA.debugLine="Log($\"Number of rows: ${Data.Size}\"$)";
Debug.JustUpdateDeviceLine();
xlreaderresult.__c.runVoidMethod ("LogImpl","9219742210",(RemoteObject.concat(RemoteObject.createImmutable("Number of rows: "),xlreaderresult.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(false,"_data" /*RemoteObject*/ ).runMethod(true,"getSize")))),RemoteObject.createImmutable(""))),0);
...
Debug.JustUpdateDeviceLine();
xlreaderresult.__c.runVoidMethod ("LogImpl","9219742222",(RemoteObject.concat(RemoteObject.createImmutable("Is rectangle region: "),xlreaderresult.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_isrectangle))),RemoteObject.createImmutable(""))),0);
 BA.debugLineNum = 35;BA.debugLine="Log($\"${xl.AddressToString(TopLeft)} -> ${xl.Add";
Debug.JustUpdateDeviceLine();
xlreaderresult.__c.runVoidMethod ("LogImpl","9219742223",(RemoteObject.concat(RemoteObject.createImmutable(""),xlreaderresult.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(false,"_xl" /*RemoteObject*/ ).runClassMethod (b4j.docU.xlutils.class, "_addresstostring" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_topleft" /*RemoteObject*/ )))))),RemoteObject.createImmutable(" -> "),xlreaderresult.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(false,"_xl" /*RemoteObject*/ ).runClassMethod (b4j.docU.xlutils.class, "_addresstostring" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_bottomright" /*RemoteObject*/ )))))),RemoteObject.createImmutable(""))),0);
...
Debug.JustUpdateDeviceLine();
xlreaderresult.__c.runVoidMethod ("LogImpl","9219742225",RemoteObject.createImmutable("Content:"),0);
...
Debug.JustUpdateDeviceLine();
xlreaderresult.__c.runVoidMethod ("LogImpl","9219742243",_sb.runMethod(true,"ToString"),0);
 }
}Debug.locals.put("row", _row);
;
 };
