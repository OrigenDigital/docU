...
public class cseguimientofechasprometidascompra {
    public static RemoteObject myClass;
	public cseguimientofechasprometidascompra() {
	}
    public static PCBA staticBA = new PCBA(null, cseguimientofechasprometidascompra.class);
...
public static RemoteObject _direccionseleccionadaremitenteemails = RemoteObject.createImmutable("");
public static RemoteObject _permisousuariomodulo = RemoteObject.createImmutable("");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"btnSalir",_ref.getField(false, "_btnsalir"),"CSSUtils",_ref.getField(false, "_cssutils"),"DateUtils",_ref.getField(false, "_dateutils"),"Dialog",_ref.getField(false, "_dialog"),"DireccionSeleccionadaRemitenteEmails",_ref.getField(false, "_direccionseleccionadaremitenteemails"),"frm",_ref.getField(false, "_frm"),"fx",_ref.getField(false, "_fx"),"jamTableView1",_ref.getField(false, "_jamtableview1"),"mSQL",_ref.getField(false, "_msql"),"PermisoUsuarioModulo",_ref.getField(false, "_permisousuariomodulo"),"xui",_ref.getField(false, "_xui")};
}
}