...
public static RemoteObject _lastaccessed = RemoteObject.declareNull("b4j.docU.xlutils._xladdress");
public static RemoteObject _jsheet = RemoteObject.declareNull("anywheresoftware.b4j.object.JavaObject");
public static RemoteObject _workbook = RemoteObject.declareNull("b4j.docU.xlworkbookwriter");
