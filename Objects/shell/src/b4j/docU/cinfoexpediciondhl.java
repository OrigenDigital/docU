...
public class cinfoexpediciondhl {
    public static RemoteObject myClass;
	public cinfoexpediciondhl() {
	}
    public static PCBA staticBA = new PCBA(null, cinfoexpediciondhl.class);
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"CSSUtils",_ref.getField(false, "_cssutils"),"DateUtils",_ref.getField(false, "_dateutils"),"fx",_ref.getField(false, "_fx"),"PasswordWs",_ref.getField(false, "_passwordws"),"UsuarioWS",_ref.getField(false, "_usuariows"),"xui",_ref.getField(false, "_xui")};
}
}