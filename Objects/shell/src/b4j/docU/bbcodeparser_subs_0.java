...
bbcodeparser._allowedtags = RemoteObject.createNew ("b4j.docU.b4xset");__ref.setField("_allowedtags",bbcodeparser._allowedtags);
...
bbcodeparser._mtextengine = RemoteObject.createNew ("b4j.docU.bctextengine");__ref.setField("_mtextengine",bbcodeparser._mtextengine);
...
try {
		Debug.PushSubsStack("CreateRuns (bbcodeparser) ","bbcodeparser",83,__ref.getField(false, "ba"),__ref,182);
...
RemoteObject _textnode = RemoteObject.declareNull("b4j.docU.bbcodeparser._bbcodetextnode");
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bbcodeparser.class, "_texttorun" /*RemoteObject*/ ,(Object)(_textnode),(Object)(_runs),(Object)(_data));
 }
}Debug.locals.put("TextNode", _textnode);
;
...
try {
		Debug.PushSubsStack("CreateTagNode (bbcodeparser) ","bbcodeparser",83,__ref.getField(false, "ba"),__ref,174);
if (RapidSub.canDelegate("createtagnode")) { return __ref.runUserSub(false, "bbcodeparser","createtagnode", __ref, _tag);}
RemoteObject _n = RemoteObject.declareNull("b4j.docU.bbcodeparser._bbcodetagnode");
...
Debug.JustUpdateDeviceLine();
_n = RemoteObject.createNew ("b4j.docU.bbcodeparser._bbcodetagnode");Debug.locals.put("n", _n);
...
try {
		Debug.PushSubsStack("CreateTextNode (bbcodeparser) ","bbcodeparser",83,__ref.getField(false, "ba"),__ref,164);
if (RapidSub.canDelegate("createtextnode")) { return __ref.runUserSub(false, "bbcodeparser","createtextnode", __ref, _text);}
RemoteObject _n = RemoteObject.declareNull("b4j.docU.bbcodeparser._bbcodetextnode");
...
Debug.JustUpdateDeviceLine();
_n = RemoteObject.createNew ("b4j.docU.bbcodeparser._bbcodetextnode");Debug.locals.put("n", _n);
...
try {
		Debug.PushSubsStack("Error (bbcodeparser) ","bbcodeparser",83,__ref.getField(false, "ba"),__ref,154);
...
_s = (RemoteObject.concat(RemoteObject.createImmutable("Error (position - "),bbcodeparser.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(true,"_start" /*RemoteObject*/ )))),RemoteObject.createImmutable("): "),bbcodeparser.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_msg))),RemoteObject.createImmutable("")));Debug.locals.put("s", _s);Debug.locals.put("s", _s);
 BA.debugLineNum = 159;BA.debugLine="LogError(s)";
Debug.JustUpdateDeviceLine();
bbcodeparser.__c.runVoidMethod ("LogError",(Object)(_s));
...
try {
		Debug.PushSubsStack("GetDimensionFromTag (bbcodeparser) ","bbcodeparser",83,__ref.getField(false, "ba"),__ref,374);
...
try {
		Debug.PushSubsStack("GetView (bbcodeparser) ","bbcodeparser",83,__ref.getField(false, "ba"),__ref,441);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bbcodeparser.class, "_error" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Missing view: "),_id)));
 };
...
try {
		Debug.PushSubsStack("HandleListElement (bbcodeparser) ","bbcodeparser",83,__ref.getField(false, "ba"),__ref,347);
if (RapidSub.canDelegate("handlelistelement")) { return __ref.runUserSub(false, "bbcodeparser","handlelistelement", __ref, _text, _run);}
int _i = 0;
RemoteObject _tag = RemoteObject.declareNull("b4j.docU.bbcodeparser._bbcodetagnode");
...
Debug.JustUpdateDeviceLine();
_run.setField ("TextChars" /*RemoteObject*/ ,__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (b4j.docU.bctextengine.class, "_createbctextcharsfromstring" /*RemoteObject*/ ,(Object)(RemoteObject.concat(bbcodeparser.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, ((int)0x2022)))),RemoteObject.createImmutable(" ")))));
 }else {
...
Debug.JustUpdateDeviceLine();
_parent = __ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (b4j.docU.bctextengine.class, "_createconnectedparent" /*RemoteObject*/ );Debug.locals.put("parent", _parent);Debug.locals.put("parent", _parent);
 BA.debugLineNum = 358;BA.debugLine="Run.TextChars = mTextEngine.CreateBCTextCharsF";
Debug.JustUpdateDeviceLine();
_run.setField ("TextChars" /*RemoteObject*/ ,__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (b4j.docU.bctextengine.class, "_createbctextcharsfromstring" /*RemoteObject*/ ,(Object)(RemoteObject.concat((_count),RemoteObject.createImmutable(". ")))));
...
try {
		Debug.PushSubsStack("Initialize (bbcodeparser) ","bbcodeparser",83,__ref.getField(false, "ba"),__ref,18);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_allowedtags" /*RemoteObject*/ ,bbcodeparser._b4xcollections.runMethod(false,"_createset2" /*RemoteObject*/ ,(Object)(bbcodeparser.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("Object",new int[] {20},new Object[] {RemoteObject.createImmutable(("b")),RemoteObject.createImmutable(("u")),RemoteObject.createImmutable(("url")),RemoteObject.createImmutable(("plain")),RemoteObject.createImmutable(("color")),RemoteObject.createImmutable(("img")),RemoteObject.createImmutable(("view")),RemoteObject.createImmutable(("vertical")),RemoteObject.createImmutable(("textsize")),RemoteObject.createImmutable(("alignment")),RemoteObject.createImmutable(("span")),RemoteObject.createImmutable(("indent")),RemoteObject.createImmutable(("list")),RemoteObject.createImmutable(("*")),RemoteObject.createImmutable(("fontawesome")),RemoteObject.createImmutable(("materialicons")),RemoteObject.createImmutable(("e")),RemoteObject.createImmutable(("font")),RemoteObject.createImmutable(("direction")),(RemoteObject.createImmutable("a"))}))))));
...
public static RemoteObject  _internalsetmousetransparent(RemoteObject __ref,RemoteObject _v) throws Exception{
try {
		Debug.PushSubsStack("InternalSetMouseTransparent (bbcodeparser) ","bbcodeparser",83,__ref.getField(false, "ba"),__ref,389);
if (RapidSub.canDelegate("internalsetmousetransparent")) { return __ref.runUserSub(false, "bbcodeparser","internalsetmousetransparent", __ref, _v);}
RemoteObject _jo = RemoteObject.declareNull("anywheresoftware.b4j.object.JavaObject");
Debug.locals.put("v", _v);
 BA.debugLineNum = 389;BA.debugLine="Public Sub InternalSetMouseTransparent(v As B4XVie";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 390;BA.debugLine="Dim jo As JavaObject = v";
Debug.JustUpdateDeviceLine();
...
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _v.getObject());Debug.locals.put("jo", _jo);Debug.locals.put("jo", _jo);
 BA.debugLineNum = 391;BA.debugLine="jo.RunMethod(\"setMouseTransparent\", Array(True))";
Debug.JustUpdateDeviceLine();
_jo.runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setMouseTransparent")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(bbcodeparser.__c.getField(true,"True"))})));
...
try {
		Debug.PushSubsStack("Parse (bbcodeparser) ","bbcodeparser",83,__ref.getField(false, "ba"),__ref,37);
...
RemoteObject _t = RemoteObject.declareNull("b4j.docU.bbcodeparser._bbcodetagnode");
RemoteObject _n = RemoteObject.declareNull("b4j.docU.bbcodeparser._bbcodetagnode");
Debug.locals.put("Data", _data);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_stack" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4j.docU.bbcodeparser.class, "_createtagnode" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("noop"))))));
...
Debug.JustUpdateDeviceLine();
_parsedelements.runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4j.docU.bbcodeparser.class, "_createtextnode" /*RemoteObject*/ ,(Object)(_data.getField(true,"Text" /*RemoteObject*/ ).runMethod(true,"substring",(Object)(_lastmatchend),(Object)(__ref.getField(true,"_start" /*RemoteObject*/ ))))))));
 };
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",__ref.runClassMethod (b4j.docU.bbcodeparser.class, "_stackpeek" /*RemoteObject*/ ).getField(true,"Tag" /*RemoteObject*/ ),_tag)) { 
 BA.debugLineNum = 55;BA.debugLine="If StackPeek.CanHaveNestedTags = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.runClassMethod (b4j.docU.bbcodeparser.class, "_stackpeek" /*RemoteObject*/ ).getField(true,"CanHaveNestedTags" /*RemoteObject*/ ),bbcodeparser.__c.getField(true,"False"))) { 
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bbcodeparser.class, "_error" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Closing tag does not match: "),_tag)));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bbcodeparser.class, "_stackpop" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
_t = __ref.runClassMethod (b4j.docU.bbcodeparser.class, "_parsetag" /*RemoteObject*/ ,(Object)(_tag));Debug.locals.put("t", _t);Debug.locals.put("t", _t);
 BA.debugLineNum = 79;BA.debugLine="If AllowedTags.Contains(t.Tag) = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_allowedtags" /*RemoteObject*/ ).runClassMethod (b4j.docU.b4xset.class, "_contains" /*RemoteObject*/ ,(Object)((_t.getField(true,"Tag" /*RemoteObject*/ )))),bbcodeparser.__c.getField(true,"False"))) { 
 BA.debugLineNum = 80;BA.debugLine="Error(\"Invalid tag: \" & tag)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bbcodeparser.class, "_error" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Invalid tag: "),_tag)));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bbcodeparser.class, "_stackpush" /*RemoteObject*/ ,(Object)(_t));
...
Debug.JustUpdateDeviceLine();
_n = __ref.runClassMethod (b4j.docU.bbcodeparser.class, "_stackpeek" /*RemoteObject*/ );Debug.locals.put("n", _n);Debug.locals.put("n", _n);
...
Debug.JustUpdateDeviceLine();
_parsedelements.runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4j.docU.bbcodeparser.class, "_createtextnode" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable(""))))));
...
Debug.JustUpdateDeviceLine();
_parsedelements.runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4j.docU.bbcodeparser.class, "_createtextnode" /*RemoteObject*/ ,(Object)(_data.getField(true,"Text" /*RemoteObject*/ ).runMethod(true,"substring",(Object)(_lastmatchend),(Object)(_data.getField(true,"Text" /*RemoteObject*/ ).runMethod(true,"length"))))))));
 };
...
try {
		Debug.PushSubsStack("ParseCodepoint (bbcodeparser) ","bbcodeparser",83,__ref.getField(false, "ba"),__ref,328);
...
try {
		Debug.PushSubsStack("ParseColorString (bbcodeparser) ","bbcodeparser",83,__ref.getField(false, "ba"),__ref,333);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bbcodeparser.class, "_error" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Invalid color value: "),_clr)));
...
try {
		Debug.PushSubsStack("ParseTag (bbcodeparser) ","bbcodeparser",83,__ref.getField(false, "ba"),__ref,102);
if (RapidSub.canDelegate("parsetag")) { return __ref.runUserSub(false, "bbcodeparser","parsetag", __ref, _tag);}
RemoteObject _res = RemoteObject.declareNull("b4j.docU.bbcodeparser._bbcodetagnode");
RemoteObject _i = RemoteObject.createImmutable(0);
...
if (true) return __ref.runClassMethod (b4j.docU.bbcodeparser.class, "_createtagnode" /*RemoteObject*/ ,(Object)(_tag.runMethod(true,"toLowerCase")));};
 BA.debugLineNum = 107;BA.debugLine="Dim res As BBCodeTagNode = CreateTagNode(\"\")";
Debug.JustUpdateDeviceLine();
_res = __ref.runClassMethod (b4j.docU.bbcodeparser.class, "_createtagnode" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("")));Debug.locals.put("res", _res);Debug.locals.put("res", _res);
...
try {
		Debug.PushSubsStack("SetImageView (bbcodeparser) ","bbcodeparser",83,__ref.getField(false, "ba"),__ref,395);
...
public ResumableSub_SetImageView(b4j.docU.bbcodeparser parent,RemoteObject __ref,RemoteObject _tag,RemoteObject _run,RemoteObject _data) {
this.parent = parent;
this.__ref = __ref;
this._tag = _tag;
this._run = _run;
...
Debug.JustUpdateDeviceLine();
_width = __ref.runClassMethod (b4j.docU.bbcodeparser.class, "_getdimensionfromtag" /*RemoteObject*/ ,(Object)(_tag),(Object)(BA.ObjectToString("width")),(Object)(_data));Debug.locals.put("width", _width);Debug.locals.put("width", _width);
 BA.debugLineNum = 400;BA.debugLine="Dim height As Int = GetDimensionFromTag(Tag, \"hei";
Debug.JustUpdateDeviceLine();
_height = __ref.runClassMethod (b4j.docU.bbcodeparser.class, "_getdimensionfromtag" /*RemoteObject*/ ,(Object)(_tag),(Object)(BA.ObjectToString("height")),(Object)(_data));Debug.locals.put("height", _height);Debug.locals.put("height", _height);
...
_iv.runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 404;BA.debugLine="InternalSetMouseTransparent(iv)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bbcodeparser.class, "_internalsetmousetransparent" /*RemoteObject*/ ,RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), _iv.getObject()));
...
Debug.JustUpdateDeviceLine();
_xiv.runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(double.class, 0)),(Object)(BA.numberCast(double.class, 0)),(Object)(BA.numberCast(double.class, _width)),(Object)(BA.numberCast(double.class, _height)));
...
Debug.JustUpdateDeviceLine();
_bmp = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper"), _j.runClassMethod (b4j.docU.httpjob.class, "_getbitmap" /*RemoteObject*/ ).getObject());Debug.locals.put("bmp", _bmp);
...
Debug.JustUpdateDeviceLine();
_xiv.runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(double.class, 0)),(Object)(BA.numberCast(double.class, 0)),(Object)(_bmp.runMethod(true,"getWidth")),(Object)(_bmp.runMethod(true,"getHeight")));
 if (true) break;
...
try {
		Debug.PushSubsStack("StackPeek (bbcodeparser) ","bbcodeparser",83,__ref.getField(false, "ba"),__ref,150);
...
try {
		Debug.PushSubsStack("StackPop (bbcodeparser) ","bbcodeparser",83,__ref.getField(false, "ba"),__ref,142);
...
try {
		Debug.PushSubsStack("StackPush (bbcodeparser) ","bbcodeparser",83,__ref.getField(false, "ba"),__ref,146);
...
try {
		Debug.PushSubsStack("TextToRun (bbcodeparser) ","bbcodeparser",83,__ref.getField(false, "ba"),__ref,191);
...
int _i = 0;
RemoteObject _tag = RemoteObject.declareNull("b4j.docU.bbcodeparser._bbcodetagnode");
RemoteObject _uu = RemoteObject.declareNull("b4j.docU.bctextengine._bcstyledunderline");
RemoteObject _url = RemoteObject.createImmutable("");
...
Debug.JustUpdateDeviceLine();
_run = __ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (b4j.docU.bctextengine.class, "_createrun" /*RemoteObject*/ ,(Object)(_text.getField(true,"Text" /*RemoteObject*/ )));Debug.locals.put("Run", _run);Debug.locals.put("Run", _run);
...
Debug.JustUpdateDeviceLine();
_currentfont = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont");
...
Debug.JustUpdateDeviceLine();
_uu = RemoteObject.createNew ("b4j.docU.bctextengine._bcstyledunderline");Debug.locals.put("uu", _uu);
...
_uu.setField ("Clr" /*RemoteObject*/ ,__ref.runClassMethod (b4j.docU.bbcodeparser.class, "_parsecolorstring" /*RemoteObject*/ ,(Object)(BA.ObjectToString(_tag.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((RemoteObject.createImmutable("color"))))))));}
else {
...
Debug.JustUpdateDeviceLine();
_run.setField ("TextColor" /*RemoteObject*/ ,__ref.runClassMethod (b4j.docU.bbcodeparser.class, "_parsecolorstring" /*RemoteObject*/ ,(Object)(_clr)));
 break; }
case 4: {
 BA.debugLineNum = 233;BA.debugLine="SetImageView(tag, Run, Data)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.bbcodeparser.class, "_setimageview" /*void*/ ,(Object)(_tag),(Object)(_run),(Object)(_data));
...
Debug.JustUpdateDeviceLine();
_run.setField ("VerticalOffset" /*RemoteObject*/ ,__ref.runClassMethod (b4j.docU.bbcodeparser.class, "_getdimensionfromtag" /*RemoteObject*/ ,(Object)(_tag),(Object)(BA.ObjectToString("vertical")),(Object)(_data)));
 };
 BA.debugLineNum = 237;BA.debugLine="Data.ViewsPanel.AddView(Run.View, 0, 0, Run.Vi";
Debug.JustUpdateDeviceLine();
_data.getField(false,"ViewsPanel" /*RemoteObject*/ ).runVoidMethod ("AddView",(Object)((_run.getField(false,"View" /*RemoteObject*/ ).getObject())),(Object)(BA.numberCast(double.class, 0)),(Object)(BA.numberCast(double.class, 0)),(Object)(_run.getField(false,"View" /*RemoteObject*/ ).runMethod(true,"getWidth")),(Object)(_run.getField(false,"View" /*RemoteObject*/ ).runMethod(true,"getHeight")));
 break; }
case 5: {
 BA.debugLineNum = 239;BA.debugLine="Run.View = GetView(tag, Data)";
Debug.JustUpdateDeviceLine();
_run.setField ("View" /*RemoteObject*/ ,__ref.runClassMethod (b4j.docU.bbcodeparser.class, "_getview" /*RemoteObject*/ ,(Object)(_tag),(Object)(_data)));
...
_run.getField(false,"View" /*RemoteObject*/ ).runMethod(true,"setWidth",BA.numberCast(double.class, __ref.runClassMethod (b4j.docU.bbcodeparser.class, "_getdimensionfromtag" /*RemoteObject*/ ,(Object)(_tag),(Object)(BA.ObjectToString("width")),(Object)(_data))));};
...
_run.getField(false,"View" /*RemoteObject*/ ).runMethod(true,"setHeight",BA.numberCast(double.class, __ref.runClassMethod (b4j.docU.bbcodeparser.class, "_getdimensionfromtag" /*RemoteObject*/ ,(Object)(_tag),(Object)(BA.ObjectToString("height")),(Object)(_data))));};
...
Debug.JustUpdateDeviceLine();
bbcodeparser.__c.runVoidMethod ("LogImpl","9150077501",RemoteObject.concat(RemoteObject.createImmutable("Font missing from TextEngine.CustomFonts: "),_name),0);
 }else {
 BA.debugLineNum = 254;BA.debugLine="Dim NewFont As B4XFont =  mTextEngine.CustomF";
Debug.JustUpdateDeviceLine();
_newfont = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont");
_newfont = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont"), __ref.getField(false,"_mtextengine" /*RemoteObject*/ ).getField(false,"_customfonts" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_name))));Debug.locals.put("NewFont", _newfont);Debug.locals.put("NewFont", _newfont);
...
Debug.JustUpdateDeviceLine();
_cr.setField ("ConnectedWidth" /*RemoteObject*/ ,__ref.runClassMethod (b4j.docU.bbcodeparser.class, "_getdimensionfromtag" /*RemoteObject*/ ,(Object)(_tag),(Object)(BA.ObjectToString("minwidth")),(Object)(_data)));
...
Debug.JustUpdateDeviceLine();
_run.setField ("TextChars" /*RemoteObject*/ ,__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (b4j.docU.bctextengine.class, "_createbctextchars" /*RemoteObject*/ ,(Object)(RemoteObject.createNewArray("String",new int[] {1},new Object[] {BA.ObjectToString(_tag.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_tag.getField(true,"Tag" /*RemoteObject*/ )))))})),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 1))));
...
Debug.JustUpdateDeviceLine();
_run.setField ("TextChars" /*RemoteObject*/ ,__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (b4j.docU.bctextengine.class, "_createbctextcharsfromstring" /*RemoteObject*/ ,(Object)(BA.ObjectToString(bbcodeparser.__c.runMethod(true,"Chr",(Object)(__ref.runClassMethod (b4j.docU.bbcodeparser.class, "_parsecodepoint" /*RemoteObject*/ ,(Object)(BA.ObjectToString(_tag.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_tag.getField(true,"Tag" /*RemoteObject*/ )))))))))))));
...
Debug.JustUpdateDeviceLine();
_run = __ref.runClassMethod (b4j.docU.bbcodeparser.class, "_handlelistelement" /*RemoteObject*/ ,(Object)(_text),(Object)(_run));Debug.locals.put("Run", _run);
 };
 BA.debugLineNum = 309;BA.debugLine="If customfont Or FontSize <> Data.DefaultFont.Siz";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(".",_customfont) || RemoteObject.solveBoolean("!",_fontsize,_data.getField(false,"DefaultFont" /*RemoteObject*/ ).runMethod(true,"getSize"))) { 
