...
public class jrdcquery implements IRemote{
	public static jrdcquery mostCurrent;
...
public boolean isSingleton() {
    ...
    static {
		mostCurrent = new jrdcquery();
		remoteMe = RemoteObject.declareNull("b4j.docU.jrdcquery");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("jrdcquery"), "b4j.docU.jrdcquery");
	}
    ...
    private static PCBA pcBA = new PCBA(null, jrdcquery.class);
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, jrdcquery.class);
...
public static b4j.docU.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"B4XCollections",Debug.moduleToString(b4j.docU.b4xcollections.class),"cmAuxCorreosExpress",Debug.moduleToString(b4j.docU.cmauxcorreosexpress.class),"cmAuxTxT",Debug.moduleToString(b4j.docU.cmauxtxt.class),"cmPermisos",Debug.moduleToString(b4j.docU.cmpermisos.class),"CSSUtils",jrdcquery._cssutils,"DateUtils",jrdcquery._dateutils,"DBUtils",Debug.moduleToString(b4j.docU.dbutils.class),"HttpUtils2Service",Debug.moduleToString(b4j.docU.httputils2service.class),"jamLinkNavision",Debug.moduleToString(b4j.docU.jamlinknavision.class),"jamRecordFormBuilder",Debug.moduleToString(b4j.docU.jamrecordformbuilder.class),"jamTableViewCamposBuilder",Debug.moduleToString(b4j.docU.jamtableviewcamposbuilder.class),"Main",Debug.moduleToString(b4j.docU.main.class),"MainMenu2",Debug.moduleToString(b4j.docU.mainmenu2.class),"TransferMode",Debug.moduleToString(b4j.docU.transfermode.class),"Utilidades",Debug.moduleToString(b4j.docU.utilidades.class),"XUIViewsUtils",Debug.moduleToString(b4j.docU.xuiviewsutils.class)};
}
}