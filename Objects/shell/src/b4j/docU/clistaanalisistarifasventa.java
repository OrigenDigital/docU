...
public class clistaanalisistarifasventa {
    public static RemoteObject myClass;
	public clistaanalisistarifasventa() {
	}
    public static PCBA staticBA = new PCBA(null, clistaanalisistarifasventa.class);
...
public static RemoteObject _jformreg = RemoteObject.declareNull("b4j.docU.jamformregistro");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"btnSalir",_ref.getField(false, "_btnsalir"),"CSSUtils",_ref.getField(false, "_cssutils"),"DateUtils",_ref.getField(false, "_dateutils"),"Dialog",_ref.getField(false, "_dialog"),"frm",_ref.getField(false, "_frm"),"fx",_ref.getField(false, "_fx"),"jamLoadingIndicator1",_ref.getField(false, "_jamloadingindicator1"),"jamTableView1",_ref.getField(false, "_jamtableview1"),"jFormReg",_ref.getField(false, "_jformreg"),"mSQL",_ref.getField(false, "_msql"),"PermisoModuloUsuario",_ref.getField(false, "_permisomodulousuario"),"xui",_ref.getField(false, "_xui")};
}
}