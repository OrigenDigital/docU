...
public class jamtableviewclvdragger {
    public static RemoteObject myClass;
	public jamtableviewclvdragger() {
	}
    public static PCBA staticBA = new PCBA(null, jamtableviewclvdragger.class);
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"CSSUtils",_ref.getField(false, "_cssutils"),"DateUtils",_ref.getField(false, "_dateutils"),"fx",_ref.getField(false, "_fx"),"list",_ref.getField(false, "_list"),"PressedColor",_ref.getField(false, "_pressedcolor"),"xui",_ref.getField(false, "_xui")};
}
}