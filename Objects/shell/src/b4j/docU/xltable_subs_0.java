...
try {
		Debug.PushSubsStack("AddAutoFilter (xltable) ","xltable",110,__ref.getField(false, "ba"),__ref,77);
...
xltable._msheet = RemoteObject.createNew ("b4j.docU.xlsheetwriter");__ref.setField("_msheet",xltable._msheet);
...
try {
		Debug.PushSubsStack("getCellReferences (xltable) ","xltable",110,__ref.getField(false, "ba"),__ref,47);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_msheet" /*RemoteObject*/ ).getField(false,"_xl" /*RemoteObject*/ ).runClassMethod (b4j.docU.xlutils.class, "_areareferencetoxlrange" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_msheet" /*RemoteObject*/ ).getField(false,"_workbook" /*RemoteObject*/ ).getField(false,"_poiworkbook" /*RemoteObject*/ )),(Object)(_area));
...
try {
		Debug.PushSubsStack("getDisplayName (xltable) ","xltable",110,__ref.getField(false, "ba"),__ref,24);
...
try {
		Debug.PushSubsStack("getName (xltable) ","xltable",110,__ref.getField(false, "ba"),__ref,15);
...
try {
		Debug.PushSubsStack("getShowColumnStripes (xltable) ","xltable",110,__ref.getField(false, "ba"),__ref,59);
...
Debug.JustUpdateDeviceLine();
if (true) return BA.ObjectToBoolean(__ref.runClassMethod (b4j.docU.xltable.class, "_getstyle" /*RemoteObject*/ ).runMethod(false,"RunMethod",(Object)(BA.ObjectToString("isShowColumnStripes")),(Object)((xltable.__c.getField(false,"Null")))));
...
try {
		Debug.PushSubsStack("getShowRowStripes (xltable) ","xltable",110,__ref.getField(false, "ba"),__ref,68);
...
Debug.JustUpdateDeviceLine();
if (true) return BA.ObjectToBoolean(__ref.runClassMethod (b4j.docU.xltable.class, "_getstyle" /*RemoteObject*/ ).runMethod(false,"RunMethod",(Object)(BA.ObjectToString("isShowRowStripes")),(Object)((xltable.__c.getField(false,"Null")))));
...
try {
		Debug.PushSubsStack("GetStyle (xltable) ","xltable",110,__ref.getField(false, "ba"),__ref,42);
...
try {
		Debug.PushSubsStack("getStyleName (xltable) ","xltable",110,__ref.getField(false, "ba"),__ref,34);
...
try {
		Debug.PushSubsStack("Initialize (xltable) ","xltable",110,__ref.getField(false, "ba"),__ref,8);
...
try {
		Debug.PushSubsStack("setCellReferences (xltable) ","xltable",110,__ref.getField(false, "ba"),__ref,52);
...
Debug.JustUpdateDeviceLine();
_area = (__ref.getField(false,"_msheet" /*RemoteObject*/ ).getField(false,"_xl" /*RemoteObject*/ ).runClassMethod (b4j.docU.xlutils.class, "_xlrangetoareareference" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_msheet" /*RemoteObject*/ ).getField(false,"_workbook" /*RemoteObject*/ )),(Object)(_range)).getObject());Debug.locals.put("area", _area);Debug.locals.put("area", _area);
...
try {
		Debug.PushSubsStack("setDisplayName (xltable) ","xltable",110,__ref.getField(false, "ba"),__ref,28);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_msheet" /*RemoteObject*/ ).runClassMethod (b4j.docU.xlsheetwriter.class, "_validatetablename" /*RemoteObject*/ ,(Object)(_n)),xltable.__c.getField(true,"False"))) { 
...
try {
		Debug.PushSubsStack("setName (xltable) ","xltable",110,__ref.getField(false, "ba"),__ref,19);
...
try {
		Debug.PushSubsStack("setShowColumnStripes (xltable) ","xltable",110,__ref.getField(false, "ba"),__ref,63);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.xltable.class, "_getstyle" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setShowColumnStripes")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(_b)})));
...
try {
		Debug.PushSubsStack("setShowRowStripes (xltable) ","xltable",110,__ref.getField(false, "ba"),__ref,72);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.xltable.class, "_getstyle" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setShowRowStripes")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(_b)})));
...
try {
		Debug.PushSubsStack("setStyleName (xltable) ","xltable",110,__ref.getField(false, "ba"),__ref,38);
