...
try {
		Debug.PushSubsStack("AddressName (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,81);
if (RapidSub.canDelegate("addressname")) { return __ref.runUserSub(false, "xlutils","addressname", __ref, _address);}
RemoteObject _xa = RemoteObject.declareNull("b4j.docU.xlutils._xladdress");
int _i = 0;
...
Debug.JustUpdateDeviceLine();
_xa = RemoteObject.createNew ("b4j.docU.xlutils._xladdress");Debug.locals.put("xa", _xa);
...
try {
		Debug.PushSubsStack("AddressOne (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,101);
...
try {
		Debug.PushSubsStack("AddressOneToString (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,115);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4j.docU.xlutils.class, "_addresstostring" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (b4j.docU.xlutils.class, "_addressone" /*RemoteObject*/ ,(Object)(_columnname),(Object)(_row1based))));
...
try {
		Debug.PushSubsStack("AddressToString (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,120);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4j.docU.xlutils.class, "_addresstostringabs" /*RemoteObject*/ ,(Object)(_address),(Object)(xlutils.__c.getField(true,"False")),(Object)(xlutils.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("AddressToStringAbs (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,125);
...
try {
		Debug.PushSubsStack("AddressZero (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,65);
...
try {
		Debug.PushSubsStack("AddressZeroToString (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,74);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4j.docU.xlutils.class, "_addresstostring" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (b4j.docU.xlutils.class, "_addresszero" /*RemoteObject*/ ,(Object)(_col0based),(Object)(_row0based))));
...
try {
		Debug.PushSubsStack("AreaReferenceToXLRange (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,186);
...
Debug.JustUpdateDeviceLine();
_res.setField ("FirstAddress" /*RemoteObject*/ ,__ref.runClassMethod (b4j.docU.xlutils.class, "_addresszero" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _firstcell.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getCol")),(Object)((xlutils.__c.getField(false,"Null")))))),(Object)(BA.numberCast(int.class, _firstcell.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getRow")),(Object)((xlutils.__c.getField(false,"Null"))))))));
 BA.debugLineNum = 191;BA.debugLine="res.SecondAddress = AddressZero(LastCell.RunMetho";
Debug.JustUpdateDeviceLine();
_res.setField ("SecondAddress" /*RemoteObject*/ ,__ref.runClassMethod (b4j.docU.xlutils.class, "_addresszero" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _lastcell.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getCol")),(Object)((xlutils.__c.getField(false,"Null")))))),(Object)(BA.numberCast(int.class, _lastcell.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getRow")),(Object)((xlutils.__c.getField(false,"Null"))))))));
...
xlutils._reader = RemoteObject.createNew ("b4j.docU.xlreader");__ref.setField("_reader",xlutils._reader);
...
try {
		Debug.PushSubsStack("CreateWriterBlank (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,142);
...
RemoteObject _writer = RemoteObject.declareNull("b4j.docU.xlworkbookwriter");
...
Debug.JustUpdateDeviceLine();
_writer = RemoteObject.createNew ("b4j.docU.xlworkbookwriter");Debug.locals.put("writer", _writer);
 BA.debugLineNum = 146;BA.debugLine="writer.Initialize(Me, wb, False)";
Debug.JustUpdateDeviceLine();
_writer.runClassMethod (b4j.docU.xlworkbookwriter.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)((__ref)),(Object)(_wb),(Object)(xlutils.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("CreateWriterFromTemplate (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,151);
...
Debug.JustUpdateDeviceLine();
_writer.runClassMethod (b4j.docU.xlworkbookwriter.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)((__ref)),(Object)(_wb),(Object)(xlutils.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("CreateXLRange (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,235);
...
RemoteObject _t1 = RemoteObject.declareNull("b4j.docU.xlutils._xlrange");
...
Debug.JustUpdateDeviceLine();
_t1 = RemoteObject.createNew ("b4j.docU.xlutils._xlrange");Debug.locals.put("t1", _t1);
...
try {
		Debug.PushSubsStack("CreateXLRangeWithSheet (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,244);
...
try {
		Debug.PushSubsStack("FormulaToRange (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,177);
...
Debug.JustUpdateDeviceLine();
_res = __ref.runClassMethod (b4j.docU.xlutils.class, "_areareferencetoxlrange" /*RemoteObject*/ ,(Object)(_poiworkbook),(Object)(_areareference));Debug.locals.put("res", _res);Debug.locals.put("res", _res);
...
try {
		Debug.PushSubsStack("GetWorkbookRangeNames (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,160);
...
Debug.JustUpdateDeviceLine();
_res.runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4j.docU.xlutils.class, "_formulatorange" /*RemoteObject*/ ,(Object)(_poiworkbook),(Object)(_formula),(Object)(_namename)))));
...
Debug.JustUpdateDeviceLine();
xlutils.__c.runVoidMethod ("LogImpl","9226623499",(RemoteObject.concat(RemoteObject.createImmutable("info: cannot get range of: "),xlutils.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_namename))),RemoteObject.createImmutable(" - "),xlutils.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_formula))),RemoteObject.createImmutable(" "))),0);
 };
 }
}Debug.locals.put("name", _name);
;
...
try {
		Debug.PushSubsStack("Initialize (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,58);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_reader" /*RemoteObject*/ ).runClassMethod (b4j.docU.xlreader.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)((__ref)));
...
try {
		Debug.PushSubsStack("OpenExcel (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,256);
...
public ResumableSub_OpenExcel(b4j.docU.xlutils parent,RemoteObject __ref,RemoteObject _filepath) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","9227213319",_stdout,0);
 BA.debugLineNum = 264;BA.debugLine="Log(StdErr)";
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","9227213320",_stderr,0);
...
try {
		Debug.PushSubsStack("PowerShellConvertToPdf (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,273);
...
public ResumableSub_PowerShellConvertToPdf(b4j.docU.xlutils parent,RemoteObject __ref,RemoteObject _inputfile,RemoteObject _outputfile,RemoteObject _sheetindex,RemoteObject _openpdf) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","9227278851",RemoteObject.createImmutable("Cannot delete output file"),0);
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("WaitFor","complete", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "xlutils", "powershellconverttopdf"), __ref.runClassMethod (b4j.docU.xlutils.class, "_powershellscript" /*RemoteObject*/ ,(Object)(_s)));
this.state = 21;
return;
case 21:
//C
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("WaitFor","complete", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "xlutils", "powershellconverttopdf"), __ref.runClassMethod (b4j.docU.xlutils.class, "_powershellscript" /*RemoteObject*/ ,(Object)((RemoteObject.concat(RemoteObject.createImmutable("& {Invoke-Item '"),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_outputfile))),RemoteObject.createImmutable("'}"))))));
this.state = 22;
return;
case 22:
//C
...
try {
		Debug.PushSubsStack("PowerShellScript (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,300);
...
public ResumableSub_PowerShellScript(b4j.docU.xlutils parent,RemoteObject __ref,RemoteObject _s) {
this.parent = parent;
this.__ref = __ref;
this._s = _s;
}
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","9227344396",_stderr,0);
...
try {
		Debug.PushSubsStack("RangeStringOrNameToRange (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,197);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4j.docU.xlutils.class, "_formulatorange" /*RemoteObject*/ ,(Object)(_poiworkbook),(Object)(_referstoformula),(Object)(_rangeorname));
...
try {
		Debug.PushSubsStack("XLAddressToCellReference (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,226);
...
try {
		Debug.PushSubsStack("XLRangeToAreaReference (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,217);
...
_cellreference1 = __ref.runClassMethod (b4j.docU.xlutils.class, "_xladdresstocellreference" /*RemoteObject*/ ,(Object)(_range.getField(false,"Sheet" /*RemoteObject*/ ).runMethod(true,"getName")),(Object)(_range.getField(false,"FirstAddress" /*RemoteObject*/ )));Debug.locals.put("CellReference1", _cellreference1);Debug.locals.put("CellReference1", _cellreference1);
...
_cellreference2 = __ref.runClassMethod (b4j.docU.xlutils.class, "_xladdresstocellreference" /*RemoteObject*/ ,(Object)(_range.getField(false,"Sheet" /*RemoteObject*/ ).runMethod(true,"getName")),(Object)(_range.getField(false,"SecondAddress" /*RemoteObject*/ )));Debug.locals.put("CellReference2", _cellreference2);Debug.locals.put("CellReference2", _cellreference2);
...
try {
		Debug.PushSubsStack("XLRangeToCellRangeAddress (xlutils) ","xlutils",111,__ref.getField(false, "ba"),__ref,210);
