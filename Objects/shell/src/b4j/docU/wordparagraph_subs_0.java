...
wordparagraph._mdocument = RemoteObject.createNew ("b4j.docU.worddocument");__ref.setField("_mdocument",wordparagraph._mdocument);
...
try {
		Debug.PushSubsStack("Initialize (wordparagraph) ","wordparagraph",103,__ref.getField(false, "ba"),__ref,9);
