...
try {
		Debug.PushSubsStack("AddConditionalFormatting (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,230);
...
int _i = 0;
RemoteObject _r = RemoteObject.declareNull("b4j.docU.xlconditionalformattingrule");
...
Debug.JustUpdateDeviceLine();
_regions.runVoidMethod ("InitializeArray",(Object)(BA.ObjectToString("org.apache.poi.ss.util.CellRangeAddress")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(__ref.getField(false,"_xl" /*RemoteObject*/ ).runClassMethod (b4j.docU.xlutils.class, "_xlrangetocellrangeaddress" /*RemoteObject*/ ,(Object)(_range)).getObject())})));
 BA.debugLineNum = 240;BA.debugLine="GetSheetConditionalFormatting.RunMethod(\"addCondi";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_getsheetconditionalformatting" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("addConditionalFormatting")),(Object)(RemoteObject.createNewArray("Object",new int[] {2},new Object[] {(_regions.getObject()),(_cfrules.getObject())})));
...
try {
		Debug.PushSubsStack("AddMergedRegion (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,101);
...
Debug.JustUpdateDeviceLine();
_jo.runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("addMergedRegion")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(__ref.getField(false,"_xl" /*RemoteObject*/ ).runClassMethod (b4j.docU.xlutils.class, "_xlrangetocellrangeaddress" /*RemoteObject*/ ,(Object)(_range)).getObject())})));
...
try {
		Debug.PushSubsStack("AddStyle (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,48);
...
_cell = __ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_getcell" /*RemoteObject*/ ,(Object)(_address));Debug.locals.put("cell", _cell);Debug.locals.put("cell", _cell);
 BA.debugLineNum = 50;BA.debugLine="ApplyStyle(cell, True, Style.StyleMap)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_applystyle" /*RemoteObject*/ ,(Object)(_cell),(Object)(xlsheetwriter.__c.getField(true,"True")),(Object)(_style.getField(false,"_stylemap" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("AddStyles (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,62);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_applystyle" /*RemoteObject*/ ,(Object)(_cell),(Object)(xlsheetwriter.__c.getField(true,"True")),(Object)(__ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_mergestyles" /*RemoteObject*/ ,(Object)(_styles))));
...
try {
		Debug.PushSubsStack("AddStylesToRange (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,85);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_internalsetstylestorange" /*RemoteObject*/ ,(Object)(_range),(Object)(_styles),(Object)(xlsheetwriter.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("ApplyStyle (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,290);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_fillstylefromcell" /*RemoteObject*/ ,(Object)(_props),(Object)(_cell.runMethod(false,"getCellStyle")));
...
Debug.JustUpdateDeviceLine();
_cell.runMethod(false,"setCellStyle",__ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_createstyle" /*RemoteObject*/ ,(Object)(_props)));
...
try {
		Debug.PushSubsStack("AutoSizeColumn (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,140);
...
try {
		Debug.PushSubsStack("CheckIfStyleExists (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,334);
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_ismapthesameasprops" /*RemoteObject*/ ,(Object)(_m),(Object)(_props)).<Boolean>get().booleanValue()) { 
...
xlsheetwriter._xl = RemoteObject.createNew ("b4j.docU.xlutils");__ref.setField("_xl",xlsheetwriter._xl);
 //BA.debugLineNum = 5;BA.debugLine="Public LastAccessed As XLAddress";
xlsheetwriter._lastaccessed = RemoteObject.createNew ("b4j.docU.xlutils._xladdress");__ref.setField("_lastaccessed",xlsheetwriter._lastaccessed);
...
xlsheetwriter._workbook = RemoteObject.createNew ("b4j.docU.xlworkbookwriter");__ref.setField("_workbook",xlsheetwriter._workbook);
...
try {
		Debug.PushSubsStack("CreateConditionalFormattingRule (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,210);
...
RemoteObject _x = RemoteObject.declareNull("b4j.docU.xlconditionalformattingrule");
...
Debug.JustUpdateDeviceLine();
_x = RemoteObject.createNew ("b4j.docU.xlconditionalformattingrule");Debug.locals.put("x", _x);
...
Debug.JustUpdateDeviceLine();
_x.runClassMethod (b4j.docU.xlconditionalformattingrule.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _m.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("createConditionalFormattingRule")),(Object)(RemoteObject.createNewArray("Object",new int[] {2},new Object[] {(__ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_getsheetconditionalformatting" /*RemoteObject*/ ).getObject()),(_formula)})))));
...
try {
		Debug.PushSubsStack("CreateFreezePane (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,147);
...
try {
		Debug.PushSubsStack("CreateHyperlink (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,176);
...
_jcell = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), __ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_getcell" /*RemoteObject*/ ,(Object)(_address)).getObject());Debug.locals.put("jcell", _jcell);Debug.locals.put("jcell", _jcell);
...
try {
		Debug.PushSubsStack("CreateStyle (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,317);
...
_style = __ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_checkifstyleexists" /*RemoteObject*/ ,(Object)(_props));Debug.locals.put("style", _style);Debug.locals.put("style", _style);
...
try {
		Debug.PushSubsStack("CreateTable (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,248);
...
RemoteObject _t = RemoteObject.declareNull("b4j.docU.xltable");
Debug.locals.put("Range", _range);
...
Debug.JustUpdateDeviceLine();
xlsheetwriter.__c.runVoidMethod ("LogImpl","9222101506",RemoteObject.createImmutable("Tables are supported in XLSX only."),0);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_validatetablename" /*RemoteObject*/ ,(Object)(_tablename)),xlsheetwriter.__c.getField(true,"False"))) { 
if (true) return (xlsheetwriter.__c.getField(false,"Null"));};
...
_areareference = __ref.getField(false,"_xl" /*RemoteObject*/ ).runClassMethod (b4j.docU.xlutils.class, "_xlrangetoareareference" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_workbook" /*RemoteObject*/ )),(Object)(_range));Debug.locals.put("AreaReference", _areareference);Debug.locals.put("AreaReference", _areareference);
...
Debug.JustUpdateDeviceLine();
_t = RemoteObject.createNew ("b4j.docU.xltable");Debug.locals.put("t", _t);
 BA.debugLineNum = 260;BA.debugLine="t.Initialize(Table, Me)";
Debug.JustUpdateDeviceLine();
_t.runClassMethod (b4j.docU.xltable.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(_table),(Object)((__ref)));
...
try {
		Debug.PushSubsStack("FillStyleFromCell (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,304);
...
try {
		Debug.PushSubsStack("getActiveCell (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,153);
if (RapidSub.canDelegate("getactivecell")) { return __ref.runUserSub(false, "xlsheetwriter","getactivecell", __ref);}
RemoteObject _res = RemoteObject.declareNull("b4j.docU.xlutils._xladdress");
...
Debug.JustUpdateDeviceLine();
_res = RemoteObject.createNew ("b4j.docU.xlutils._xladdress");Debug.locals.put("res", _res);
...
try {
		Debug.PushSubsStack("GetCell (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,108);
...
_row = __ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_getrow" /*RemoteObject*/ ,(Object)(_address));Debug.locals.put("row", _row);Debug.locals.put("row", _row);
...
try {
		Debug.PushSubsStack("getPrintArea (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,392);
...
RemoteObject _res = RemoteObject.declareNull("b4j.docU.xlutils._xlrange");
...
Debug.JustUpdateDeviceLine();
_res = RemoteObject.createNew ("b4j.docU.xlutils._xlrange");Debug.locals.put("res", _res);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_xl" /*RemoteObject*/ ).runClassMethod (b4j.docU.xlutils.class, "_rangestringornametorange" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_workbook" /*RemoteObject*/ ).getField(false,"_poiworkbook" /*RemoteObject*/ )),(Object)(BA.ObjectToString(_ref)));
...
try {
		Debug.PushSubsStack("getPrintSetup (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,413);
...
try {
		Debug.PushSubsStack("GetRow (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,118);
...
try {
		Debug.PushSubsStack("GetSheetConditionalFormatting (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,225);
...
try {
		Debug.PushSubsStack("GetTables (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,265);
...
RemoteObject _table = RemoteObject.declareNull("b4j.docU.xltable");
...
Debug.JustUpdateDeviceLine();
_table = RemoteObject.createNew ("b4j.docU.xltable");Debug.locals.put("table", _table);
 BA.debugLineNum = 271;BA.debugLine="table.Initialize(j, Me)";
Debug.JustUpdateDeviceLine();
_table.runClassMethod (b4j.docU.xltable.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _j),(Object)((__ref)));
...
try {
		Debug.PushSubsStack("GroupColumns (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,185);
...
try {
		Debug.PushSubsStack("GroupRows (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,191);
...
try {
		Debug.PushSubsStack("Initialize (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,11);
...
try {
		Debug.PushSubsStack("InternalSetStylesToRange (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,89);
...
_props = __ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_mergestyles" /*RemoteObject*/ ,(Object)(_styles));Debug.locals.put("props", _props);Debug.locals.put("props", _props);
...
Debug.JustUpdateDeviceLine();
_cell = RemoteObject.createNew ("anywheresoftware.b4j.objects.PoiCellWrapper");
_cell = __ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_getcell" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xl" /*RemoteObject*/ ).runClassMethod (b4j.docU.xlutils.class, "_addresszero" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _col)),(Object)(BA.numberCast(int.class, _row)))));Debug.locals.put("cell", _cell);Debug.locals.put("cell", _cell);
 BA.debugLineNum = 94;BA.debugLine="ApplyStyle(cell, Add, props)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_applystyle" /*RemoteObject*/ ,(Object)(_cell),(Object)(_add),(Object)(_props));
 }
}Debug.locals.put("row", _row);
;
 }
...
try {
		Debug.PushSubsStack("IsMapTheSameAsProps (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,344);
...
try {
		Debug.PushSubsStack("MergeStyles (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,68);
...
RemoteObject _style = RemoteObject.declareNull("b4j.docU.xlstyle");
RemoteObject _key = RemoteObject.createImmutable("");
Debug.locals.put("Styles", _styles);
...
try {
		Debug.PushSubsStack("PutDate (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,29);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_getcell" /*RemoteObject*/ ,(Object)(_address)).runMethod(true,"setValueDate",_value);
...
try {
		Debug.PushSubsStack("PutFormula (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,34);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_getcell" /*RemoteObject*/ ,(Object)(_address)).runMethod(true,"setValueFormula",_value);
...
try {
		Debug.PushSubsStack("PutNumber (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,19);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_getcell" /*RemoteObject*/ ,(Object)(_address)).runMethod(true,"setValueNumeric",_value);
...
try {
		Debug.PushSubsStack("PutString (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,24);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_getcell" /*RemoteObject*/ ,(Object)(_address)).runMethod(true,"setValueString",_value);
...
try {
		Debug.PushSubsStack("RemoveTable (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,278);
...
try {
		Debug.PushSubsStack("setActiveCell (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,160);
...
try {
		Debug.PushSubsStack("SetAutoFilter (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,167);
...
Debug.JustUpdateDeviceLine();
_c = (__ref.getField(false,"_xl" /*RemoteObject*/ ).runClassMethod (b4j.docU.xlutils.class, "_xlrangetocellrangeaddress" /*RemoteObject*/ ,(Object)(_range)).getObject());Debug.locals.put("c", _c);Debug.locals.put("c", _c);
...
try {
		Debug.PushSubsStack("SetFitToPage (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,404);
...
_ps = __ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_getprintsetup" /*RemoteObject*/ );Debug.locals.put("ps", _ps);Debug.locals.put("ps", _ps);
...
try {
		Debug.PushSubsStack("setPrintArea (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,387);
...
try {
		Debug.PushSubsStack("SetStyle (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,41);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_applystyle" /*RemoteObject*/ ,(Object)(_cell),(Object)(xlsheetwriter.__c.getField(true,"False")),(Object)(_style.getField(false,"_stylemap" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("SetStyles (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,55);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_applystyle" /*RemoteObject*/ ,(Object)(_cell),(Object)(xlsheetwriter.__c.getField(true,"False")),(Object)(__ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_mergestyles" /*RemoteObject*/ ,(Object)(_styles))));
...
try {
		Debug.PushSubsStack("SetStylesToRange (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,80);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4j.docU.xlsheetwriter.class, "_internalsetstylestorange" /*RemoteObject*/ ,(Object)(_range),(Object)(_styles),(Object)(xlsheetwriter.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("ShiftColumns (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,133);
...
try {
		Debug.PushSubsStack("ShiftRows (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,127);
...
try {
		Debug.PushSubsStack("UngroupColumns (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,198);
...
try {
		Debug.PushSubsStack("UngroupRows (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,203);
...
try {
		Debug.PushSubsStack("ValidateTableName (xlsheetwriter) ","xlsheetwriter",108,__ref.getField(false, "ba"),__ref,282);
