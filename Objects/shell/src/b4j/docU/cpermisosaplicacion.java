...
public class cpermisosaplicacion {
    public static RemoteObject myClass;
	public cpermisosaplicacion() {
	}
    public static PCBA staticBA = new PCBA(null, cpermisosaplicacion.class);
...
public static RemoteObject _jfreg = RemoteObject.declareNull("b4j.docU.jamformregistro");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"CSSUtils",_ref.getField(false, "_cssutils"),"DateUtils",_ref.getField(false, "_dateutils"),"Dialog",_ref.getField(false, "_dialog"),"frm",_ref.getField(false, "_frm"),"fx",_ref.getField(false, "_fx"),"jamTableView1",_ref.getField(false, "_jamtableview1"),"jFReg",_ref.getField(false, "_jfreg"),"mSQL",_ref.getField(false, "_msql"),"xui",_ref.getField(false, "_xui")};
}
}