...
public class clvselectionsjamtableview {
    public static RemoteObject myClass;
	public clvselectionsjamtableview() {
	}
    public static PCBA staticBA = new PCBA(null, clvselectionsjamtableview.class);
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"CSSUtils",_ref.getField(false, "_cssutils"),"DateUtils",_ref.getField(false, "_dateutils"),"mCLV",_ref.getField(false, "_mclv"),"mCurrentMode",_ref.getField(false, "_mcurrentmode"),"MODE_MULTIPLE_ITEMS",_ref.getField(false, "_mode_multiple_items"),"MODE_SINGLE_ITEM_PERMANENT",_ref.getField(false, "_mode_single_item_permanent"),"MODE_SINGLE_ITEM_TEMP",_ref.getField(false, "_mode_single_item_temp"),"SelectedItems",_ref.getField(false, "_selecteditems"),"SelectionColor",_ref.getField(false, "_selectioncolor"),"SingleMode",_ref.getField(false, "_singlemode"),"UnselectedColor",_ref.getField(false, "_unselectedcolor"),"xui",_ref.getField(false, "_xui")};
}
}