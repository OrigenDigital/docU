...
public boolean isSingleton() {
    ...
    static {
		...
		remoteMe = RemoteObject.declareNull("b4j.docU.dbutils");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("dbutils"), "b4j.docU.dbutils");
	}
