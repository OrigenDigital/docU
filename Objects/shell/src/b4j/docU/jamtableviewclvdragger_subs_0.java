...
public class jamtableviewclvdragger_subs_0 {


public static RemoteObject  _adddragbuttons(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("AddDragButtons (jamtableviewclvdragger) ","jamtableviewclvdragger",97,__ref.getField(false, "ba"),__ref,42);
if (RapidSub.canDelegate("adddragbuttons")) { return __ref.runUserSub(false, "jamtableviewclvdragger","adddragbuttons", __ref);}
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.runClassMethod (b4j.docU.jamtableviewclvdragger.class, "_islastviewadraglabel" /*RemoteObject*/ ,(Object)(_p)),jamtableviewclvdragger.__c.getField(true,"False"))) { 
...
Debug.JustUpdateDeviceLine();
_xlbl.runMethod(true,"setText",BA.ObjectToString(jamtableviewclvdragger.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, ((int)0xe25d))))));
...
_xlbl.runMethod(false,"setTag",(__ref.getField(false,"_list" /*RemoteObject*/ )));
 BA.debugLineNum = 58;BA.debugLine="xlbl.Height=30dip";
Debug.JustUpdateDeviceLine();
_xlbl.runMethod(true,"setHeight",BA.numberCast(double.class, jamtableviewclvdragger.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 30)))));
 BA.debugLineNum = 59;BA.debugLine="xlbl.width=30dip";
Debug.JustUpdateDeviceLine();
_xlbl.runMethod(true,"setWidth",BA.numberCast(double.class, jamtableviewclvdragger.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 30)))));
 BA.debugLineNum = 63;BA.debugLine="p.AddView(xlbl, 2dip, (70dip-xlbl.Height) / 2 ,";
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("AddView",(Object)((_xlbl.getObject())),(Object)(BA.numberCast(double.class, jamtableviewclvdragger.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2))))),(Object)(RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {jamtableviewclvdragger.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 70))),_xlbl.runMethod(true,"getHeight")}, "-",1, 0)),RemoteObject.createImmutable(2)}, "/",0, 0)),(Object)(_xlbl.runMethod(true,"getWidth")),(Object)(_xlbl.runMethod(true,"getHeight")));
 };
 }
}Debug.locals.put("i", _i);
;
...
jamtableviewclvdragger._xui = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper.XUI");__ref.setField("_xui",jamtableviewclvdragger._xui);
 //BA.debugLineNum = 4;BA.debugLine="Private fx As JFX";
jamtableviewclvdragger._fx = RemoteObject.createNew ("anywheresoftware.b4j.objects.JFX");__ref.setField("_fx",jamtableviewclvdragger._fx);
 //BA.debugLineNum = 5;BA.debugLine="Private list As CustomListView";
jamtableviewclvdragger._list = RemoteObject.createNew ("b4j.example.customlistview");__ref.setField("_list",jamtableviewclvdragger._list);
 //BA.debugLineNum = 6;BA.debugLine="Private PressedColor As Int";
jamtableviewclvdragger._pressedcolor = RemoteObject.createImmutable(0);__ref.setField("_pressedcolor",jamtableviewclvdragger._pressedcolor);
 //BA.debugLineNum = 7;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static void  _drag_mousepressed(RemoteObject __ref,RemoteObject _eventdata) throws Exception{
try {
		Debug.PushSubsStack("Drag_MousePressed (jamtableviewclvdragger) ","jamtableviewclvdragger",97,__ref.getField(false, "ba"),__ref,68);
if (RapidSub.canDelegate("drag_mousepressed")) { __ref.runUserSub(false, "jamtableviewclvdragger","drag_mousepressed", __ref, _eventdata); return;}
...
public ResumableSub_Drag_MousePressed(b4j.docU.jamtableviewclvdragger parent,RemoteObject __ref,RemoteObject _eventdata) {
this.parent = parent;
this.__ref = __ref;
...
Debug.locals.put("EventData", _eventdata);
 BA.debugLineNum = 69;BA.debugLine="Dim lbl As B4XView = Sender";
Debug.JustUpdateDeviceLine();
...
_lbl = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), parent.__c.runMethod(false,"Sender",__ref.getField(false, "ba")));Debug.locals.put("lbl", _lbl);Debug.locals.put("lbl", _lbl);
 BA.debugLineNum = 70;BA.debugLine="Dim list As CustomListView = lbl.Tag";
Debug.JustUpdateDeviceLine();
parent._list = (_lbl.runMethod(false,"getTag"));__ref.setField("_list",parent._list);
 BA.debugLineNum = 71;BA.debugLine="Dim pnl As B4XView = list.GetPanel(list.GetItemFr";
Debug.JustUpdateDeviceLine();
...
_pnl = __ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(false,"_getpanel",(Object)(__ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(true,"_getitemfromview",(Object)(_lbl)))).runMethod(false,"getParent");Debug.locals.put("pnl", _pnl);Debug.locals.put("pnl", _pnl);
 BA.debugLineNum = 72;BA.debugLine="pnl.GetView(0).SetColorAndBorder(xui.Color_Transp";
Debug.JustUpdateDeviceLine();
_pnl.runMethod(false,"GetView",(Object)(BA.numberCast(int.class, 0))).runVoidMethod ("SetColorAndBorder",(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Transparent")),(Object)(BA.numberCast(double.class, parent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 3))))),(Object)(BA.numberCast(int.class, ((int)0xff503acd))),(Object)(BA.numberCast(double.class, 0)));
 BA.debugLineNum = 73;BA.debugLine="Dim ListStartY As Int = EventData.Y + lbl.Top + p";
Debug.JustUpdateDeviceLine();
_liststarty = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_eventdata.runMethod(true,"getY"),_lbl.runMethod(true,"getTop"),_pnl.runMethod(true,"getTop")}, "++",2, 0));Debug.locals.put("ListStartY", _liststarty);Debug.locals.put("ListStartY", _liststarty);
 BA.debugLineNum = 74;BA.debugLine="pnl.BringToFront";
Debug.JustUpdateDeviceLine();
_pnl.runVoidMethod ("BringToFront");
 BA.debugLineNum = 75;BA.debugLine="Dim Top As Int = pnl.Top";
Debug.JustUpdateDeviceLine();
...
//C
this.state = 4;
 BA.debugLineNum = 77;BA.debugLine="Wait For (lbl) Drag_MouseDragged (EventData As M";
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("WaitFor","drag_mousedragged", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "jamtableviewclvdragger", "drag_mousepressed"), (_lbl.getObject()));
this.state = 11;
return;
case 11:
//C
...
;
 BA.debugLineNum = 78;BA.debugLine="If pnl.Top < list.sv.ScrollViewOffsetY Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
{ BA.debugLineNum = 80;BA.debugLine="Else If list.sv.ScrollViewOffsetY + list.sv.Heig";
Debug.JustUpdateDeviceLine();
...
//C
this.state = 9;
 BA.debugLineNum = 79;BA.debugLine="list.sv.ScrollViewOffsetY = Max(0, list.sv.Scro";
Debug.JustUpdateDeviceLine();
...
//C
this.state = 9;
 BA.debugLineNum = 81;BA.debugLine="list.sv.ScrollViewOffsetY = list.sv.ScrollViewO";
Debug.JustUpdateDeviceLine();
...
this.state = 1;
;
 BA.debugLineNum = 83;BA.debugLine="Dim ListY As Int = EventData.Y + lbl.Top + pnl.T";
Debug.JustUpdateDeviceLine();
_listy = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_eventdata.runMethod(true,"getY"),_lbl.runMethod(true,"getTop"),_pnl.runMethod(true,"getTop")}, "++",2, 0));Debug.locals.put("ListY", _listy);Debug.locals.put("ListY", _listy);
 BA.debugLineNum = 84;BA.debugLine="Dim delta As Int = ListY - ListStartY";
Debug.JustUpdateDeviceLine();
_delta = RemoteObject.solve(new RemoteObject[] {_listy,_liststarty}, "-",1, 1);Debug.locals.put("delta", _delta);Debug.locals.put("delta", _delta);
 BA.debugLineNum = 85;BA.debugLine="pnl.Top = Top + delta";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("Drag_MouseReleased (jamtableviewclvdragger) ","jamtableviewclvdragger",97,__ref.getField(false, "ba"),__ref,89);
if (RapidSub.canDelegate("drag_mousereleased")) { return __ref.runUserSub(false, "jamtableviewclvdragger","drag_mousereleased", __ref, _eventdata);}
RemoteObject _lbl = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
...
Debug.locals.put("EventData", _eventdata);
 BA.debugLineNum = 89;BA.debugLine="Private Sub Drag_MouseReleased (EventData As Mouse";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 90;BA.debugLine="Dim lbl As B4XView = Sender";
Debug.JustUpdateDeviceLine();
_lbl = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_lbl = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), jamtableviewclvdragger.__c.runMethod(false,"Sender",__ref.getField(false, "ba")));Debug.locals.put("lbl", _lbl);Debug.locals.put("lbl", _lbl);
 BA.debugLineNum = 91;BA.debugLine="Dim list As CustomListView = lbl.Tag";
Debug.JustUpdateDeviceLine();
jamtableviewclvdragger._list = (_lbl.runMethod(false,"getTag"));__ref.setField("_list",jamtableviewclvdragger._list);
 BA.debugLineNum = 92;BA.debugLine="Dim index As Int = list.GetItemFromView(lbl)";
Debug.JustUpdateDeviceLine();
_index = __ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(true,"_getitemfromview",(Object)(_lbl));Debug.locals.put("index", _index);Debug.locals.put("index", _index);
 BA.debugLineNum = 93;BA.debugLine="Dim pnl As B4XView = list.GetPanel(index).Parent";
Debug.JustUpdateDeviceLine();
_pnl = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_pnl = __ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(false,"_getpanel",(Object)(_index)).runMethod(false,"getParent");Debug.locals.put("pnl", _pnl);Debug.locals.put("pnl", _pnl);
 BA.debugLineNum = 94;BA.debugLine="Dim Offset As Int = pnl.Top + pnl.Height / 2";
Debug.JustUpdateDeviceLine();
_offset = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_pnl.runMethod(true,"getTop"),_pnl.runMethod(true,"getHeight"),RemoteObject.createImmutable(2)}, "+/",1, 0));Debug.locals.put("Offset", _offset);Debug.locals.put("Offset", _offset);
 BA.debugLineNum = 95;BA.debugLine="Dim NewIndex As Int = list.FindIndexFromOffset(Of";
Debug.JustUpdateDeviceLine();
_newindex = __ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(true,"_findindexfromoffset",(Object)(_offset));Debug.locals.put("NewIndex", _newindex);Debug.locals.put("NewIndex", _newindex);
 BA.debugLineNum = 96;BA.debugLine="Dim UnderlyingItem As CLVItem = list.GetRawListIt";
Debug.JustUpdateDeviceLine();
_underlyingitem = __ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(false,"_getrawlistitem",(Object)(_newindex));Debug.locals.put("UnderlyingItem", _underlyingitem);Debug.locals.put("UnderlyingItem", _underlyingitem);
 BA.debugLineNum = 97;BA.debugLine="If Offset - UnderlyingItem.Offset > UnderlyingIte";
Debug.JustUpdateDeviceLine();
...
_newindex = RemoteObject.solve(new RemoteObject[] {_newindex,RemoteObject.createImmutable(1)}, "+",1, 1);Debug.locals.put("NewIndex", _newindex);};
 BA.debugLineNum = 98;BA.debugLine="Dim ActualItem As B4XView = pnl.GetView(0)";
Debug.JustUpdateDeviceLine();
...
_actualitem = _pnl.runMethod(false,"GetView",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("ActualItem", _actualitem);Debug.locals.put("ActualItem", _actualitem);
 BA.debugLineNum = 99;BA.debugLine="ActualItem.SetColorAndBorder(pnl.Color, 0dip, xui";
Debug.JustUpdateDeviceLine();
_actualitem.runVoidMethod ("SetColorAndBorder",(Object)(_pnl.runMethod(true,"getColor")),(Object)(BA.numberCast(double.class, jamtableviewclvdragger.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 0))))),(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Black")),(Object)(BA.numberCast(double.class, 0)));
 BA.debugLineNum = 100;BA.debugLine="Dim RawItem As CLVItem = list.GetRawListItem(inde";
Debug.JustUpdateDeviceLine();
_rawitem = __ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(false,"_getrawlistitem",(Object)(_index));Debug.locals.put("RawItem", _rawitem);Debug.locals.put("RawItem", _rawitem);
 BA.debugLineNum = 101;BA.debugLine="list.RemoveAt(index)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_list" /*RemoteObject*/ ).runVoidMethod ("_removeat",(Object)(_index));
 BA.debugLineNum = 102;BA.debugLine="If NewIndex > index Then NewIndex = NewIndex - 1";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_newindex,BA.numberCast(double.class, _index))) { 
_newindex = RemoteObject.solve(new RemoteObject[] {_newindex,RemoteObject.createImmutable(1)}, "-",1, 1);Debug.locals.put("NewIndex", _newindex);};
 BA.debugLineNum = 103;BA.debugLine="NewIndex = Max(0, Min(list.Size, NewIndex))";
Debug.JustUpdateDeviceLine();
_newindex = BA.numberCast(int.class, jamtableviewclvdragger.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 0)),(Object)(jamtableviewclvdragger.__c.runMethod(true,"Min",(Object)(BA.numberCast(double.class, __ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(true,"_getsize"))),(Object)(BA.numberCast(double.class, _newindex))))));Debug.locals.put("NewIndex", _newindex);
 BA.debugLineNum = 104;BA.debugLine="list.InsertAt(NewIndex, ActualItem, RawItem.Value";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_list" /*RemoteObject*/ ).runVoidMethod ("_insertat",(Object)(_newindex),(Object)(_actualitem),(Object)(_rawitem.getField(false,"Value")));
 BA.debugLineNum = 105;BA.debugLine="list.GetRawListItem(NewIndex).TextItem = RawItem.";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_list" /*RemoteObject*/ ).runMethod(false,"_getrawlistitem",(Object)(_newindex)).setField ("TextItem",_rawitem.getField(true,"TextItem"));
 BA.debugLineNum = 107;BA.debugLine="Log(\"Drag_MouseReleased\")";
Debug.JustUpdateDeviceLine();
jamtableviewclvdragger.__c.runVoidMethod ("LogImpl","9210698258",RemoteObject.createImmutable("Drag_MouseReleased"),0);
 BA.debugLineNum = 108;BA.debugLine="CallSubDelayed(jamTableViewCamposBuilder,\"Recalcu";
Debug.JustUpdateDeviceLine();
jamtableviewclvdragger.__c.runVoidMethod ("CallSubDelayed",__ref.getField(false, "ba"),(Object)((jamtableviewclvdragger._jamtableviewcamposbuilder.getObject())),(Object)(RemoteObject.createImmutable("RecalcularIDOrdenColumnas")));
...
try {
		Debug.PushSubsStack("Initialize (jamtableviewclvdragger) ","jamtableviewclvdragger",97,__ref.getField(false, "ba"),__ref,9);
if (RapidSub.canDelegate("initialize")) { return __ref.runUserSub(false, "jamtableviewclvdragger","initialize", __ref, _ba, _clv);}
...
try {
		Debug.PushSubsStack("IsLastViewADragLabel (jamtableviewclvdragger) ","jamtableviewclvdragger",97,__ref.getField(false, "ba"),__ref,34);
if (RapidSub.canDelegate("islastviewadraglabel")) { return __ref.runUserSub(false, "jamtableviewclvdragger","islastviewadraglabel", __ref, _p);}
...
Debug.JustUpdateDeviceLine();
if (true) return jamtableviewclvdragger.__c.getField(true,"False");
...
try {
		Debug.PushSubsStack("RemoveDragButtons (jamtableviewclvdragger) ","jamtableviewclvdragger",97,__ref.getField(false, "ba"),__ref,24);
if (RapidSub.canDelegate("removedragbuttons")) { return __ref.runUserSub(false, "jamtableviewclvdragger","removedragbuttons", __ref);}
int _i = 0;
RemoteObject _p = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (b4j.docU.jamtableviewclvdragger.class, "_islastviewadraglabel" /*RemoteObject*/ ,(Object)(_p)).<Boolean>get().booleanValue()) { 
...
try {
		Debug.PushSubsStack("Resize (jamtableviewclvdragger) ","jamtableviewclvdragger",97,__ref.getField(false, "ba"),__ref,14);
if (RapidSub.canDelegate("resize")) { return __ref.runUserSub(false, "jamtableviewclvdragger","resize", __ref);}
int _i = 0;
RemoteObject _p = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
RemoteObject _v = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
...
Debug.JustUpdateDeviceLine();
_v.runMethod(true,"setLeft",RemoteObject.solve(new RemoteObject[] {_p.runMethod(true,"getWidth"),jamtableviewclvdragger.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 32)))}, "-",1, 0));
 };
 }
}Debug.locals.put("i", _i);
;
