...
public class jamtableclvclvdragger {
    public static RemoteObject myClass;
	public jamtableclvclvdragger() {
	}
    public static PCBA staticBA = new PCBA(null, jamtableclvclvdragger.class);

public static RemoteObject __c = RemoteObject.declareNull("anywheresoftware.b4a.keywords.Common");
public static RemoteObject _mcallback = RemoteObject.declareNull("Object");
public static RemoteObject _xui = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper.XUI");
public static RemoteObject _fx = RemoteObject.declareNull("anywheresoftware.b4j.objects.JFX");
public static RemoteObject _list = RemoteObject.declareNull("b4j.example.customlistview");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"CSSUtils",_ref.getField(false, "_cssutils"),"DateUtils",_ref.getField(false, "_dateutils"),"fx",_ref.getField(false, "_fx"),"list",_ref.getField(false, "_list"),"mCallback",_ref.getField(false, "_mcallback"),"PressedColor",_ref.getField(false, "_pressedcolor"),"xui",_ref.getField(false, "_xui")};
}
}