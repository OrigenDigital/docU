...
public class cevaluacionproveedoresproveedoresfijos {
    public static RemoteObject myClass;
	public cevaluacionproveedoresproveedoresfijos() {
	}
    public static PCBA staticBA = new PCBA(null, cevaluacionproveedoresproveedoresfijos.class);

public static RemoteObject __c = RemoteObject.declareNull("anywheresoftware.b4a.keywords.Common");
public static RemoteObject _fx = RemoteObject.declareNull("anywheresoftware.b4j.objects.JFX");
public static RemoteObject _jamtableviewproveedoresfijosevaluacionproveedores = RemoteObject.declareNull("b4j.docU.jamtableview");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"Background",_ref.getField(false, "_background"),"CSSUtils",_ref.getField(false, "_cssutils"),"DateUtils",_ref.getField(false, "_dateutils"),"Dialog",_ref.getField(false, "_dialog"),"frm",_ref.getField(false, "_frm"),"fx",_ref.getField(false, "_fx"),"jamLoadingIndicator1",_ref.getField(false, "_jamloadingindicator1"),"jamTableViewProveedoresFijosEvaluacionProveedores",_ref.getField(false, "_jamtableviewproveedoresfijosevaluacionproveedores"),"mCallBack",_ref.getField(false, "_mcallback"),"mParent",_ref.getField(false, "_mparent"),"mSQL",_ref.getField(false, "_msql"),"xui",_ref.getField(false, "_xui")};
}
}