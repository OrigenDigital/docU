...
try {
		Debug.PushSubsStack("FontStyle (xlconditionalformattingrule) ","xlconditionalformattingrule",105,__ref.getField(false, "ba"),__ref,22);
...
try {
		Debug.PushSubsStack("ForegroundColor (xlconditionalformattingrule) ","xlconditionalformattingrule",105,__ref.getField(false, "ba"),__ref,12);
...
try {
		Debug.PushSubsStack("Initialize (xlconditionalformattingrule) ","xlconditionalformattingrule",105,__ref.getField(false, "ba"),__ref,6);
