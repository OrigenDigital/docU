...
public class canalisistarifastarifasventausuario {
    public static RemoteObject myClass;
	public canalisistarifastarifasventausuario() {
	}
    public static PCBA staticBA = new PCBA(null, canalisistarifastarifasventausuario.class);
...
public static RemoteObject _mdatosprecioventausuarioseleccionado = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
