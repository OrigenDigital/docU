...
public static RemoteObject _longtexttemplate = RemoteObject.declareNull("b4j.docU.b4xlongtexttemplate");
...
public static RemoteObject _searchtemplate = RemoteObject.declareNull("b4j.docU.b4xsearchtemplate");
public static RemoteObject _template = RemoteObject.declareNull("Object");
public static RemoteObject _colortemplate = RemoteObject.declareNull("b4j.docU.b4xcolortemplate");
public static RemoteObject _b4xcombobox1 = RemoteObject.declareNull("b4j.docU.b4xcombobox");
