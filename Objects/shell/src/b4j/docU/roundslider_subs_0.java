...
try {
		Debug.PushSubsStack("Base_Resize (roundslider) ","roundslider",137,__ref.getField(false, "ba"),__ref,89);
...
__ref.runClassMethod (b4j.docU.roundslider.class, "_createthumb" /*RemoteObject*/ );};
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.roundslider.class, "_draw" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("CreateThumb (roundslider) ","roundslider",137,__ref.getField(false, "ba"),__ref,70);
...
try {
		Debug.PushSubsStack("DesignerCreateView (roundslider) ","roundslider",137,__ref.getField(false, "ba"),__ref,35);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.roundslider.class, "_base_resize" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth")),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight")));
...
try {
		Debug.PushSubsStack("Draw (roundslider) ","roundslider",137,__ref.getField(false, "ba"),__ref,98);
...
try {
		Debug.PushSubsStack("getValue (roundslider) ","roundslider",137,__ref.getField(false, "ba"),__ref,182);
...
try {
		Debug.PushSubsStack("Initialize (roundslider) ","roundslider",137,__ref.getField(false, "ba"),__ref,29);
...
try {
		Debug.PushSubsStack("pnl_MouseClicked (roundslider) ","roundslider",137,__ref.getField(false, "ba"),__ref,161);
...
try {
		Debug.PushSubsStack("pnl_MousePressed (roundslider) ","roundslider",137,__ref.getField(false, "ba"),__ref,157);
...
try {
		Debug.PushSubsStack("pnl_MouseReleased (roundslider) ","roundslider",137,__ref.getField(false, "ba"),__ref,165);
...
try {
		Debug.PushSubsStack("pnl_Touch (roundslider) ","roundslider",137,__ref.getField(false, "ba"),__ref,123);
...
try {
		Debug.PushSubsStack("SetCircleColor (roundslider) ","roundslider",137,__ref.getField(false, "ba"),__ref,64);
...
try {
		Debug.PushSubsStack("SetRange (roundslider) ","roundslider",137,__ref.getField(false, "ba"),__ref,176);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.roundslider.class, "_setvalue" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_mvalue" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("SetThumbColor (roundslider) ","roundslider",137,__ref.getField(false, "ba"),__ref,57);
...
try {
		Debug.PushSubsStack("setValue (roundslider) ","roundslider",137,__ref.getField(false, "ba"),__ref,170);
