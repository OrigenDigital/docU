...
try {
		Debug.PushSubsStack("Append (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,59);
if (RapidSub.canDelegate("append")) { return __ref.runUserSub(false, "worddocument","append", __ref, _bbtext);}
RemoteObject _doc = RemoteObject.declareNull("b4j.docU.worddocument._worddocelement");
...
Debug.JustUpdateDeviceLine();
_doc = __ref.runClassMethod (b4j.docU.worddocument.class, "_parse" /*RemoteObject*/ ,(Object)(_bbtext));Debug.locals.put("doc", _doc);Debug.locals.put("doc", _doc);
 BA.debugLineNum = 61;BA.debugLine="HandleElements(doc)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.worddocument.class, "_handleelements" /*RemoteObject*/ ,(Object)(_doc));
...
worddocument._mwu = RemoteObject.createNew ("b4j.docU.wordutils");__ref.setField("_mwu",worddocument._mwu);
 //BA.debugLineNum = 4;BA.debugLine="Private AllowedTags As B4XSet";
worddocument._allowedtags = RemoteObject.createNew ("b4j.docU.b4xset");__ref.setField("_allowedtags",worddocument._allowedtags);
...
try {
		Debug.PushSubsStack("ConfigureParagraph (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,383);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.runClassMethod (b4j.docU.worddocument.class, "_getboolean" /*RemoteObject*/ ,(Object)(BA.ObjectToString(_props.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("pagebreak"))),(Object)((worddocument.__c.getField(true,"False"))))))),worddocument.__c.getField(true,"True"))) { 
...
try {
		Debug.PushSubsStack("CreateTagNode (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,375);
if (RapidSub.canDelegate("createtagnode")) { return __ref.runUserSub(false, "worddocument","createtagnode", __ref, _tag);}
RemoteObject _n = RemoteObject.declareNull("b4j.docU.worddocument._wordtagnode");
...
Debug.JustUpdateDeviceLine();
_n = RemoteObject.createNew ("b4j.docU.worddocument._wordtagnode");Debug.locals.put("n", _n);
...
try {
		Debug.PushSubsStack("CreateTextNode (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,365);
if (RapidSub.canDelegate("createtextnode")) { return __ref.runUserSub(false, "worddocument","createtextnode", __ref, _text);}
RemoteObject _n = RemoteObject.declareNull("b4j.docU.worddocument._wordtextnode");
...
Debug.JustUpdateDeviceLine();
_n = RemoteObject.createNew ("b4j.docU.worddocument._wordtextnode");Debug.locals.put("n", _n);
...
try {
		Debug.PushSubsStack("CreateWordDocElement (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,487);
...
RemoteObject _t1 = RemoteObject.declareNull("b4j.docU.worddocument._worddocelement");
Debug.locals.put("Tag", _tag);
...
Debug.JustUpdateDeviceLine();
_t1 = RemoteObject.createNew ("b4j.docU.worddocument._worddocelement");Debug.locals.put("t1", _t1);
...
try {
		Debug.PushSubsStack("Error (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,355);
...
try {
		Debug.PushSubsStack("GetBoolean (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,394);
...
try {
		Debug.PushSubsStack("HandleElements (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,65);
if (RapidSub.canDelegate("handleelements")) { return __ref.runUserSub(false, "worddocument","handleelements", __ref, _parent);}
int _index = 0;
RemoteObject _child = RemoteObject.declareNull("b4j.docU.worddocument._worddocelement");
...
RemoteObject _node = RemoteObject.declareNull("b4j.docU.worddocument._wordtextnode");
...
Debug.JustUpdateDeviceLine();
worddocument.__c.runVoidMethod ("LogImpl","9216465412",RemoteObject.concat(RemoteObject.createImmutable("Tag: "),_child.getField(true,"Tag" /*RemoteObject*/ )),0);
 };
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.worddocument.class, "_configureparagraph" /*RemoteObject*/ ,(Object)(_par),(Object)(_child));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.worddocument.class, "_texttoruns" /*RemoteObject*/ ,(Object)(_par),(Object)(_node));
 }
}Debug.locals.put("node", _node);
;
 break; }
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.worddocument.class, "_handleelements" /*RemoteObject*/ ,(Object)(_child));
 break; }
case 2: {
...
Debug.JustUpdateDeviceLine();
_alignment = __ref.runClassMethod (b4j.docU.worddocument.class, "_toupper" /*RemoteObject*/ ,(Object)(BA.ObjectToString(_child.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((RemoteObject.createImmutable("alignment")))))));Debug.locals.put("alignment", _alignment);Debug.locals.put("alignment", _alignment);
...
_child.getField(false,"JElement" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setColor")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(__ref.runClassMethod (b4j.docU.worddocument.class, "_parsecolorstring" /*RemoteObject*/ ,(Object)(BA.ObjectToString(_child.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((RemoteObject.createImmutable("color"))))))))})));};
...
_child.getField(false,"JElement" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setVerticalAlignment")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(__ref.runClassMethod (b4j.docU.worddocument.class, "_toupper" /*RemoteObject*/ ,(Object)(BA.ObjectToString(_child.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((RemoteObject.createImmutable("verticalalignment"))))))))})));};
...
_child.getField(false,"JElement" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setWidth")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {__ref.runClassMethod (b4j.docU.worddocument.class, "_to20thspoint" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, _child.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((RemoteObject.createImmutable("width")))))),(Object)(worddocument.__c.getField(true,"True")))})));};
...
try {
		Debug.PushSubsStack("Initialize (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,18);
...
try {
		Debug.PushSubsStack("OrganizeElements (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,256);
...
RemoteObject _node = RemoteObject.declareNull("b4j.docU.worddocument._wordtextnode");
RemoteObject _currentelement = RemoteObject.declareNull("b4j.docU.worddocument._worddocelement");
RemoteObject _tag = RemoteObject.declareNull("b4j.docU.worddocument._wordtagnode");
RemoteObject _newelement = RemoteObject.declareNull("b4j.docU.worddocument._worddocelement");
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.worddocument.class, "_removeinvalidnodes" /*RemoteObject*/ ,(Object)(_nodes));
 BA.debugLineNum = 258;BA.debugLine="Dim doc As WordDocElement = CreateWordDocElement(";
Debug.JustUpdateDeviceLine();
_doc = __ref.runClassMethod (b4j.docU.worddocument.class, "_createworddocelement" /*RemoteObject*/ ,(Object)(BA.ObjectToString("doc")),(Object)(worddocument.__c.runMethod(false, "createMap", (Object)(new RemoteObject[] {}))));Debug.locals.put("doc", _doc);Debug.locals.put("doc", _doc);
...
Debug.JustUpdateDeviceLine();
_newelement = __ref.runClassMethod (b4j.docU.worddocument.class, "_createworddocelement" /*RemoteObject*/ ,(Object)(_tag.getField(true,"Tag" /*RemoteObject*/ )),(Object)(_tag.getField(false,"Extra" /*RemoteObject*/ )));Debug.locals.put("NewElement", _newelement);Debug.locals.put("NewElement", _newelement);
...
try {
		Debug.PushSubsStack("Parse (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,190);
...
RemoteObject _t = RemoteObject.declareNull("b4j.docU.worddocument._wordtagnode");
RemoteObject _n = RemoteObject.declareNull("b4j.docU.worddocument._wordtagnode");
Debug.locals.put("Text", _text);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_stack" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4j.docU.worddocument.class, "_createtagnode" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("noop"))))));
...
Debug.JustUpdateDeviceLine();
_parsedelements.runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4j.docU.worddocument.class, "_createtextnode" /*RemoteObject*/ ,(Object)(_text.runMethod(true,"substring",(Object)(_lastmatchend),(Object)(__ref.getField(true,"_start" /*RemoteObject*/ ))))))));
 };
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",__ref.runClassMethod (b4j.docU.worddocument.class, "_stackpeek" /*RemoteObject*/ ).getField(true,"Tag" /*RemoteObject*/ ),_tag)) { 
 BA.debugLineNum = 209;BA.debugLine="If StackPeek.CanHaveNestedTags = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.runClassMethod (b4j.docU.worddocument.class, "_stackpeek" /*RemoteObject*/ ).getField(true,"CanHaveNestedTags" /*RemoteObject*/ ),worddocument.__c.getField(true,"False"))) { 
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.worddocument.class, "_error" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Closing tag does not match: "),_tag)));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.worddocument.class, "_stackpop" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
_t = __ref.runClassMethod (b4j.docU.worddocument.class, "_parsetag" /*RemoteObject*/ ,(Object)(_tag));Debug.locals.put("t", _t);Debug.locals.put("t", _t);
 BA.debugLineNum = 233;BA.debugLine="If AllowedTags.Contains(t.Tag) = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_allowedtags" /*RemoteObject*/ ).runClassMethod (b4j.docU.b4xset.class, "_contains" /*RemoteObject*/ ,(Object)((_t.getField(true,"Tag" /*RemoteObject*/ )))),worddocument.__c.getField(true,"False"))) { 
 BA.debugLineNum = 234;BA.debugLine="Error(\"Invalid tag: \" & tag)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.worddocument.class, "_error" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Invalid tag: "),_tag)));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.worddocument.class, "_stackpush" /*RemoteObject*/ ,(Object)(_t));
...
Debug.JustUpdateDeviceLine();
_n = __ref.runClassMethod (b4j.docU.worddocument.class, "_stackpeek" /*RemoteObject*/ );Debug.locals.put("n", _n);Debug.locals.put("n", _n);
...
Debug.JustUpdateDeviceLine();
_parsedelements.runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4j.docU.worddocument.class, "_createtextnode" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable(""))))));
...
Debug.JustUpdateDeviceLine();
_parsedelements.runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4j.docU.worddocument.class, "_createtextnode" /*RemoteObject*/ ,(Object)(_text.runMethod(true,"substring",(Object)(_lastmatchend),(Object)(_text.runMethod(true,"length"))))))));
 };
 BA.debugLineNum = 253;BA.debugLine="Return OrganizeElements( ParsedElements)";
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4j.docU.worddocument.class, "_organizeelements" /*RemoteObject*/ ,(Object)(_parsedelements));
...
try {
		Debug.PushSubsStack("ParseColorString (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,467);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4j.docU.worddocument.class, "_error" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Invalid color value: "),_clr)));
...
try {
		Debug.PushSubsStack("ParseTag (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,303);
if (RapidSub.canDelegate("parsetag")) { return __ref.runUserSub(false, "worddocument","parsetag", __ref, _tag);}
RemoteObject _res = RemoteObject.declareNull("b4j.docU.worddocument._wordtagnode");
RemoteObject _i = RemoteObject.createImmutable(0);
...
if (true) return __ref.runClassMethod (b4j.docU.worddocument.class, "_createtagnode" /*RemoteObject*/ ,(Object)(_tag.runMethod(true,"toLowerCase")));};
 BA.debugLineNum = 308;BA.debugLine="Dim res As WordTagNode = CreateTagNode(\"\")";
Debug.JustUpdateDeviceLine();
_res = __ref.runClassMethod (b4j.docU.worddocument.class, "_createtagnode" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("")));Debug.locals.put("res", _res);Debug.locals.put("res", _res);
...
try {
		Debug.PushSubsStack("RemoveInvalidNodes (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,283);
...
try {
		Debug.PushSubsStack("SaveAs (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,162);
...
Debug.JustUpdateDeviceLine();
worddocument.__c.runVoidMethod ("LogImpl","9216662034",RemoteObject.concat(RemoteObject.createImmutable("Failed: "),_f),0);
 };
 }
}Debug.locals.put("i", _i);
;
...
public static RemoteObject  _setlandscapeorientation(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("SetLandscapeOrientation (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,498);
if (RapidSub.canDelegate("setlandscapeorientation")) { return __ref.runUserSub(false, "worddocument","setlandscapeorientation", __ref);}
 BA.debugLineNum = 498;BA.debugLine="Public Sub SetLandscapeOrientation";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 499;BA.debugLine="jme.RunMethod(\"SetLandscape\", Array(XWPFDocument)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_jme" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("SetLandscape")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(__ref.getField(false,"_xwpfdocument" /*RemoteObject*/ ).getObject())})));
 BA.debugLineNum = 500;BA.debugLine="jme.RunMethod(\"SetPageSize\", Array(XWPFDocument,";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_jme" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("SetPageSize")),(Object)(RemoteObject.createNewArray("Object",new int[] {3},new Object[] {(__ref.getField(false,"_xwpfdocument" /*RemoteObject*/ ).getObject()),RemoteObject.createImmutable((15840)),RemoteObject.createImmutable((12240))})));
...
public static RemoteObject  _setmargins(RemoteObject __ref,RemoteObject _left,RemoteObject _right,RemoteObject _top,RemoteObject _bottom,RemoteObject _header,RemoteObject _footer,RemoteObject _gutter) throws Exception{
try {
		Debug.PushSubsStack("SetMargins (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,504);
if (RapidSub.canDelegate("setmargins")) { return __ref.runUserSub(false, "worddocument","setmargins", __ref, _left, _right, _top, _bottom, _header, _footer, _gutter);}
...
Debug.locals.put("Footer", _footer);
Debug.locals.put("Gutter", _gutter);
 BA.debugLineNum = 504;BA.debugLine="Public Sub SetMargins(Left As Int, Right As Int, T";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 505;BA.debugLine="jme.RunMethod(\"SetMargins\", Array(XWPFDocument, L";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_jme" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("SetMargins")),(Object)(RemoteObject.createNewArray("Object",new int[] {8},new Object[] {(__ref.getField(false,"_xwpfdocument" /*RemoteObject*/ ).getObject()),(_left),(_right),(_top),(_bottom),(_footer),(_header),(_gutter)})));
...
try {
		Debug.PushSubsStack("StackPeek (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,351);
...
try {
		Debug.PushSubsStack("StackPop (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,343);
...
try {
		Debug.PushSubsStack("StackPush (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,347);
...
try {
		Debug.PushSubsStack("TextToRuns (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,398);
...
RemoteObject _lasttag = RemoteObject.declareNull("b4j.docU.worddocument._wordtagnode");
...
Debug.JustUpdateDeviceLine();
_run.runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setUnderlineColor")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(__ref.runClassMethod (b4j.docU.worddocument.class, "_parsecolorstring" /*RemoteObject*/ ,(Object)(BA.ObjectToString(_tag.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((RemoteObject.createImmutable("color"))))))))})));
 };
 };
...
Debug.JustUpdateDeviceLine();
_run.runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setColor")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(__ref.runClassMethod (b4j.docU.worddocument.class, "_parsecolorstring" /*RemoteObject*/ ,(Object)(BA.ObjectToString(_tag.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((RemoteObject.createImmutable("color"))))))))})));
 break; }
case 6: {
...
__ref.runClassMethod (b4j.docU.worddocument.class, "_error" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Invalid highlight color: "),_color)));};
...
try {
		Debug.PushSubsStack("To20thsPoint (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,148);
...
try {
		Debug.PushSubsStack("ToUpper (worddocument) ","worddocument",102,__ref.getField(false, "ba"),__ref,142);
