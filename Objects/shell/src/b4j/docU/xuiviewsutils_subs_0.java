...
try {
		Debug.PushSubsStack("AddStubToCLVIfNeeded (xuiviewsutils) ","xuiviewsutils",140,xuiviewsutils.ba,xuiviewsutils.mostCurrent,34);
if (RapidSub.canDelegate("addstubtoclvifneeded")) { return b4j.docU.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","addstubtoclvifneeded", _customlistview1, _color);}
...
try {
		Debug.PushSubsStack("CreateB4XImageView (xuiviewsutils) ","xuiviewsutils",140,xuiviewsutils.ba,xuiviewsutils.mostCurrent,85);
if (RapidSub.canDelegate("createb4ximageview")) { return b4j.docU.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","createb4ximageview");}
RemoteObject _iv = RemoteObject.declareNull("b4j.docU.b4ximageview");
...
Debug.JustUpdateDeviceLine();
_iv = RemoteObject.createNew ("b4j.docU.b4ximageview");Debug.locals.put("iv", _iv);
 BA.debugLineNum = 87;BA.debugLine="iv.Initialize(Null, \"\")";
Debug.JustUpdateDeviceLine();
_iv.runClassMethod (b4j.docU.b4ximageview.class, "_initialize" /*RemoteObject*/ ,xuiviewsutils.ba,(Object)(xuiviewsutils.__c.getField(false,"Null")),(Object)(RemoteObject.createImmutable("")));
...
try {
		Debug.PushSubsStack("CreateLabel (xuiviewsutils) ","xuiviewsutils",140,xuiviewsutils.ba,xuiviewsutils.mostCurrent,78);
if (RapidSub.canDelegate("createlabel")) { return b4j.docU.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","createlabel");}
...
try {
		Debug.PushSubsStack("Initialize (xuiviewsutils) ","xuiviewsutils",140,xuiviewsutils.ba,xuiviewsutils.mostCurrent,10);
if (RapidSub.canDelegate("initialize")) { return b4j.docU.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","initialize");}
...
try {
		Debug.PushSubsStack("PerformHapticFeedback (xuiviewsutils) ","xuiviewsutils",140,xuiviewsutils.ba,xuiviewsutils.mostCurrent,21);
if (RapidSub.canDelegate("performhapticfeedback")) { return b4j.docU.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","performhapticfeedback", _view);}
...
try {
		Debug.PushSubsStack("SetAlpha (xuiviewsutils) ","xuiviewsutils",140,xuiviewsutils.ba,xuiviewsutils.mostCurrent,95);
if (RapidSub.canDelegate("setalpha")) { return b4j.docU.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","setalpha", _view, _level);}
...
try {
		Debug.PushSubsStack("SetBitmapAndFill (xuiviewsutils) ","xuiviewsutils",140,xuiviewsutils.ba,xuiviewsutils.mostCurrent,65);
if (RapidSub.canDelegate("setbitmapandfill")) { return b4j.docU.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","setbitmapandfill", _imageview, _bmp);}
...
try {
		Debug.PushSubsStack("SetTextOrCSBuilderToLabel (xuiviewsutils) ","xuiviewsutils",140,xuiviewsutils.ba,xuiviewsutils.mostCurrent,50);
if (RapidSub.canDelegate("settextorcsbuildertolabel")) { return b4j.docU.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","settextorcsbuildertolabel", _xlbl, _text);}
