...
public class canalisisdisponiblesarticulotallaalmacenescomputables {
    public static RemoteObject myClass;
	public canalisisdisponiblesarticulotallaalmacenescomputables() {
	}
    public static PCBA staticBA = new PCBA(null, canalisisdisponiblesarticulotallaalmacenescomputables.class);
...
public static RemoteObject _imagencomentario = null;
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"btnSalir",_ref.getField(false, "_btnsalir"),"CSSUtils",_ref.getField(false, "_cssutils"),"DateUtils",_ref.getField(false, "_dateutils"),"Dialog",_ref.getField(false, "_dialog"),"frm",_ref.getField(false, "_frm"),"fx",_ref.getField(false, "_fx"),"imagencomentario",_ref.getField(false, "_imagencomentario"),"jamLoadingIndicator1",_ref.getField(false, "_jamloadingindicator1"),"jamTableView1",_ref.getField(false, "_jamtableview1"),"mSQL",_ref.getField(false, "_msql"),"PermisoModuloUsuario",_ref.getField(false, "_permisomodulousuario"),"xui",_ref.getField(false, "_xui")};
}
}