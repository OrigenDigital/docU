...
public class wildcardlisting {
    public static RemoteObject myClass;
	public wildcardlisting() {
	}
    public static PCBA staticBA = new PCBA(null, wildcardlisting.class);
...
public static RemoteObject _dirlisting = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
public static RemoteObject _filelisting = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"CallBack",_ref.getField(false, "_callback"),"CSSUtils",_ref.getField(false, "_cssutils"),"DateUtils",_ref.getField(false, "_dateutils"),"DirListing",_ref.getField(false, "_dirlisting"),"EventName",_ref.getField(false, "_eventname"),"FileListing",_ref.getField(false, "_filelisting")};
}
}