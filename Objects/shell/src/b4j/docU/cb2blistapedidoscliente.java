...
public class cb2blistapedidoscliente {
    public static RemoteObject myClass;
	public cb2blistapedidoscliente() {
	}
    public static PCBA staticBA = new PCBA(null, cb2blistapedidoscliente.class);
...
public static RemoteObject _tk = RemoteObject.createImmutable("");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"btnSalir",_ref.getField(false, "_btnsalir"),"CSSUtils",_ref.getField(false, "_cssutils"),"DateUtils",_ref.getField(false, "_dateutils"),"Dialog",_ref.getField(false, "_dialog"),"frm",_ref.getField(false, "_frm"),"fx",_ref.getField(false, "_fx"),"jamLoadingIndicator1",_ref.getField(false, "_jamloadingindicator1"),"jamTableView1",_ref.getField(false, "_jamtableview1"),"mSQL",_ref.getField(false, "_msql"),"PermisoUsuarioModulo",_ref.getField(false, "_permisousuariomodulo"),"tk",_ref.getField(false, "_tk"),"xui",_ref.getField(false, "_xui")};
}
}