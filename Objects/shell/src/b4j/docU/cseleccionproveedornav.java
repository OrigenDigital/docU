...
public class cseleccionproveedornav {
    public static RemoteObject myClass;
	public cseleccionproveedornav() {
	}
    public static PCBA staticBA = new PCBA(null, cseleccionproveedornav.class);
...
public static RemoteObject _mdatosproveedorseleccionado = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"Background",_ref.getField(false, "_background"),"btnSalir",_ref.getField(false, "_btnsalir"),"CSSUtils",_ref.getField(false, "_cssutils"),"DateUtils",_ref.getField(false, "_dateutils"),"Dialog",_ref.getField(false, "_dialog"),"frm",_ref.getField(false, "_frm"),"fx",_ref.getField(false, "_fx"),"jamLoadingIndicator1",_ref.getField(false, "_jamloadingindicator1"),"jamTableView1",_ref.getField(false, "_jamtableview1"),"mCallBack",_ref.getField(false, "_mcallback"),"mDatosProveedorSeleccionado",_ref.getField(false, "_mdatosproveedorseleccionado"),"mParent",_ref.getField(false, "_mparent"),"xui",_ref.getField(false, "_xui")};
}
}