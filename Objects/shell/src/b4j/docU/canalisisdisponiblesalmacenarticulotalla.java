...
public class canalisisdisponiblesalmacenarticulotalla {
    public static RemoteObject myClass;
	public canalisisdisponiblesalmacenarticulotalla() {
	}
    public static PCBA staticBA = new PCBA(null, canalisisdisponiblesalmacenarticulotalla.class);
