...
Public Sub Initialize(CallBack As Object,Parent As B4XView)
	...
	mDatosLineaSeleccionada.Put("PrecioDivisa",False)
	mDatosLineaSeleccionada.Put("Divisa",False)
	Show
End Sub
...
Sub Show
	...
	jamTableView1.AddMenuItemFontAwesomeToMenuInMenuBar("Añadir Precio Seleccionado a Lista Precios Venta Usuario","PrecioVentaUsuario",Chr(0xF0A4),jamTableView1.MenuBarLinea)
...
Sub SalirForm
	...
	frm.Close
	CallSubDelayed2(mCallBack,"cSeleccionArticuloNAV_Done",mDatosLineaSeleccionada)
End Sub
...
Sub SeleccionarArticulo(DatosCeldaSeleccionada As DatosCeldaSeleccionadaJamTableView)
	...
	mDatosLineaSeleccionada.Put("Articulo",mDataPK.Get("Articulo"))
	...
	mDatosLineaSeleccionada.Put("ArticuloBloqueado",ArticuloBloqueado)
