...
'	mSQL.ExecNonQuery(sCrearTabla)
	...
	mSQL.ExecNonQuery("drop table if exists tblB2BOrders")
	Dim sCrearTabla As String=$"CREATE TABLE If Not EXISTS [tblB2BOrders] ([item_id] INTEGER, [store_id] INTEGER default 0, [po_number] TEXT default ''
	,[original_price] INTEGER default 0
	, [free_shipping] INTEGER default 0, [discount_amount] REAL default 0, [tax_percent] REAL default 0
	, [price] REAL default 0, [product_id] INTEGER default 0, parent_id TEXT default '', [base_row_total] REAL, [sku] TEXT, [Talla] TEXT DEFAULT ''
	,  [base_original_price] REAL default 0
	, [name] TEXT
	, [order_id] INTEGER,  [created_at] TEXT, [qty_shipped] INTEGER, [qty_ordered] INTEGER
