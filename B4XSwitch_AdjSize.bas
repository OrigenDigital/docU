...
#DesignerProperty: Key: Size, DisplayName: Size, FieldType: String, List: XS|S|M|L|XL, DefaultValue: M
...
' ---------------------------------------------------------------
' This is the only added code, appart from the DesignerProperty
	Select Props.Get("Size")
		Case "XS": size = 0.50
		Case "S" : size = 0.75
		Case "M" : size = 1.00
		Case "L" : size = 1.25
